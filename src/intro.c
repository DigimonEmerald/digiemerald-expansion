...
static void Task_Scene3_LoadGekomon(u8 taskId)
{
    if (!gPaletteFade.active)
    {
        ...
        DecompressDataWithHeaderVram(gIntroGekomon_Gfx, (void *)VRAM);
        DecompressDataWithHeaderVram(gIntroGekomon_Tilemap, (void *)(BG_CHAR_ADDR(3)));
        DecompressDataWithHeaderVram(gIntroLegendBg_Gfx, (void *)(BG_CHAR_ADDR(1)));
        DecompressDataWithHeaderVram(gIntroGekomonBg_Tilemap, (void *)(BG_SCREEN_ADDR(28)));
...
{
    ResetSpriteData();
    DecompressDataWithHeaderVram(gIntroGatomon_x_Gfx, (void *)VRAM);
    DecompressDataWithHeaderVram(gIntroGatomon_x_Tilemap, (void *)(BG_CHAR_ADDR(3)));
    DecompressDataWithHeaderVram(gIntroGatomon_xBg_Tilemap, (void *)(BG_SCREEN_ADDR(28)));
...
{
    DecompressDataWithHeaderVram(gIntroGeogreymon_Tilemap, (void *)(BG_SCREEN_ADDR(28)));
    DecompressDataWithHeaderVram(gIntroGeogreymonClouds_Tilemap, (void *)(BG_CHAR_ADDR(3)));
    DecompressDataWithHeaderVram(gIntroGeogreymon_Gfx, (void *)(BG_CHAR_ADDR(1)));
    DecompressDataWithHeaderVram(gIntroGeogreymonClouds_Gfx, (void *)VRAM);
    SetGpuReg(REG_OFFSET_DISPCNT, DISPCNT_MODE_0
                                | DISPCNT_OBJ_1D_MAP
                                | DISPCNT_BG0_ON
                                | DISPCNT_BG2_ON
