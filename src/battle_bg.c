...
void DrawMainBattleBackground(void)
{
    ...
    else if (gBattleTypeFlags & BATTLE_TYPE_LEGENDARY)
    {
        ...
        case SPECIES_GEKOMON:
            ...
            LoadPalette(gBattleEnvironmentPalette_Gekomon, BG_PLTT_ID(2), 3 * PLTT_SIZE_4BPP);
            break;
        case SPECIES_GATOMON_X:
            ...
            LoadPalette(gBattleEnvironmentPalette_Gatomon_x, BG_PLTT_ID(2), 3 * PLTT_SIZE_4BPP);
            break;
        case SPECIES_GEOGREYMON:
            LZDecompressVram(gBattleEnvironmentTiles_Geogreymon, (void*)(BG_CHAR_ADDR(2)));
            LZDecompressVram(gBattleEnvironmentTilemap_Geogreymon, (void*)(BG_SCREEN_ADDR(26)));
            LoadPalette(gBattleEnvironmentPalette_Geogreymon, BG_PLTT_ID(2), 3 * PLTT_SIZE_4BPP);
            break;
        default:
...
void DrawBattleEntryBackground(void)
{
    ...
    else if (gBattleTypeFlags & BATTLE_TYPE_LEGENDARY)
    {
        ...
        case SPECIES_GATOMON_X:
            ...
            break;
        case SPECIES_GEOGREYMON:
            LZDecompressVram(gBattleEnvironmentAnimTiles_Geogreymon, (void*)(BG_CHAR_ADDR(1)));
            LZDecompressVram(gBattleEnvironmentAnimTilemap_Geogreymon, (void*)(BG_SCREEN_ADDR(28)));
            break;
        default:
