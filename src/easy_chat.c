...
static const u16 sBerryMasterWifePhrases[][2] = {
    ...
    [PHRASE_OVERWHELMING_GARURUMON_X - 1] = {EC_WORD_OVERWHELMING, EC_POKEMON(GARURUMON_X)},
    [PHRASE_COOL_GATOMON - 1]         = {EC_WORD_COOL, EC_POKEMON(GATOMON)},
...
// unless they are in this group. If they are in this group (just Gesomon), they must also have been seen.
