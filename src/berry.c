...
static u16 GetBerryPestSpecies(u8 berryId)
{
    ...
    switch(berry->color)
    {
        ...
        case BERRY_COLOR_BLUE:
            return P_FAMILY_BUCCHIEMON_GREEN_ILLUMISE ? SPECIES_BUCCHIEMON_GREEN : SPECIES_NONE;
            break;
        case BERRY_COLOR_PURPLE:
            return P_FAMILY_BUCCHIEMON_GREEN_ILLUMISE ? SPECIES_ILLUMISE : SPECIES_NONE;
            break;
