...
const struct Berry gBerries[] =
{
    ...
    [ITEM_PAMTRE_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .description1 = COMPOUND_STRING("Drifts on the sea from sofalcomonhere."),
...
static u16 GetBerryPestSpecies(u8 berryId)
{
    ...
    switch(berry->color)
    {
        case BERRY_COLOR_RED:
            return P_FAMILY_GIZUMON ? SPECIES_GIZUMON : SPECIES_NONE;
            break;
        case BERRY_COLOR_BLUE:
            return P_FAMILY_BUCCHIEMON_GREEN_BULKMON ? SPECIES_BUCCHIEMON_GREEN : SPECIES_NONE;
            break;
        case BERRY_COLOR_PURPLE:
            return P_FAMILY_BUCCHIEMON_GREEN_BULKMON ? SPECIES_BULKMON : SPECIES_NONE;
            break;
        case BERRY_COLOR_GREEN:
            return P_FAMILY_MEKANORIMON ? SPECIES_MEKANORIMON : SPECIES_NONE;
            break;
