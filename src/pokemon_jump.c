...
static const u32 sBommon_Gfx[] = INCBIN_U32("graphics/pokemon_jump/bommon.4bpp.smol");
static const u32 sBommon_Tilemap[] = INCBIN_U32("graphics/pokemon_jump/bommon.bin.smolTM");
