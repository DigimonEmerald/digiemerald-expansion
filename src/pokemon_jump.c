...
static const struct PokemonJumpMons sPokeJumpMons[] =
{
    ...
    { .species = SPECIES_CHOROMON_ALOLAN,                    .jumpType = JUMP_TYPE_FAST, },
    { .species = SPECIES_MOKUMON,                          .jumpType = JUMP_TYPE_FAST, },
    { .species = SPECIES_MOKUMON_ALOLAN,                   .jumpType = JUMP_TYPE_FAST, },
    ...
    { .species = SPECIES_PETITMON_PH_D,                      .jumpType = JUMP_TYPE_NORMAL, },
    { .species = SPECIES_PETITMON_LIBRE,                     .jumpType = JUMP_TYPE_NORMAL, },
    { .species = SPECIES_PETITMON_ORIGINAL_CAP,              .jumpType = JUMP_TYPE_NORMAL, },
    { .species = SPECIES_PETITMON_HOENN_CAP,                 .jumpType = JUMP_TYPE_NORMAL, },
    { .species = SPECIES_PETITMON_SINNOH_CAP,                .jumpType = JUMP_TYPE_NORMAL, },
    { .species = SPECIES_PETITMON_UNOVA_CAP,                 .jumpType = JUMP_TYPE_NORMAL, },
    { .species = SPECIES_PETITMON_KALOS_CAP,                 .jumpType = JUMP_TYPE_NORMAL, },
    { .species = SPECIES_PETITMON_ALOLA_CAP,                 .jumpType = JUMP_TYPE_NORMAL, },
    { .species = SPECIES_PETITMON_PARTNER_CAP,               .jumpType = JUMP_TYPE_NORMAL, },
    { .species = SPECIES_PETITMON_WORLD_CAP,                 .jumpType = JUMP_TYPE_NORMAL, },
    { .species = SPECIES_PETITMON_PARTNER,                   .jumpType = JUMP_TYPE_NORMAL, },
    { .species = SPECIES_POPOMON,                         .jumpType = JUMP_TYPE_NORMAL, },
    { .species = SPECIES_POPOMON_ALOLAN,                  .jumpType = JUMP_TYPE_SLOW, },
    ...
    { .species = SPECIES_RELEMON_ALOLAN,                     .jumpType = JUMP_TYPE_NORMAL, },
    ...
    { .species = SPECIES_CALUMON_ALOLAN,                     .jumpType = JUMP_TYPE_NORMAL, },
    { .species = SPECIES_CALUMON_GALARIAN,                   .jumpType = JUMP_TYPE_NORMAL, },
    ...
    { .species = SPECIES_CRABMON_X_PARTNER,                     .jumpType = JUMP_TYPE_NORMAL, },
    ...
    { .species = SPECIES_KUDAMON_PALDEAN,                    .jumpType = JUMP_TYPE_SLOW, },
    ...
    { .species = SPECIES_TOYAGUMON_GALARIAN,                .jumpType = JUMP_TYPE_NORMAL, },
    { .species = SPECIES_TSUKAIMON,                           .jumpType = JUMP_TYPE_NORMAL, },
    { .species = SPECIES_TSUKAIMON_GALARIAN,                  .jumpType = JUMP_TYPE_NORMAL, },
