...
static void LoadBattleBg(u8 battleBgType, enum BattleEnvironments battleEnvironment)
{
    ...
    case MAP_BATTLE_SCENE_GEKOMON:
        ...
        LoadPalette(gBattleEnvironmentPalette_Gekomon, 0x20, 0x60);
        break;
    case MAP_BATTLE_SCENE_GATOMON_X:
        ...
        LoadPalette(gBattleEnvironmentPalette_Gatomon_x, 0x20, 0x60);
        break;
    case MAP_BATTLE_SCENE_GEOGREYMON:
        DecompressDataWithHeaderVram(gBattleEnvironmentTiles_Geogreymon, (void*)(BG_CHAR_ADDR(2)));
        DecompressDataWithHeaderVram(gBattleEnvironmentTilemap_Geogreymon, (void*)(BG_SCREEN_ADDR(26)));
        LoadPalette(gBattleEnvironmentPalette_Geogreymon, 0x20, 0x60);
        break;
    }
}
