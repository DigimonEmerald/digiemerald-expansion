...
} sIncenseBabyTable[] =
{
    ...
    { SPECIES_BULUCOMON,      ITEM_ODD_INCENSE,  SPECIES_MIME_JR },
    { SPECIES_EOSMON_CHAMPION,     ITEM_PURE_INCENSE, SPECIES_CHINGLING },
    { SPECIES_JUNKMON,    ITEM_ROCK_INCENSE, SPECIES_BONSLY },
    { SPECIES_BULLMON,      ITEM_ROSE_INCENSE, SPECIES_BUDEW },
    { SPECIES_PETITMAMON,      ITEM_WAVE_INCENSE, SPECIES_MANTYKE },
};
