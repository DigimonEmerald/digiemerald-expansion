...
static void LoadBattleBg(u8 battleBgType, u8 battleTerrain)
{
    ...
    case MAP_BATTLE_SCENE_GEKOMON:
        ...
        LoadCompressedPalette(gBattleTerrainPalette_Gekomon, 0x20, 0x60);
        break;
...
void CB2_Debug_Pokemon(void)
{
    ...
    switch (gMain.state)
    {
        ...
        case 3:
            ...
            LoadMonIconPalette(SPECIES_ARGOMON_F);
            ...
            data->currentmonId = SPECIES_ARGOMON_F;
