...
static void LoadTakesFlightSceneGfx(void)
{
    ...
    DecompressDataWithHeaderWram(gRaySceneTakesFlight_Geogreymon_Tilemap, sRayScene->tilemapBuffers[2]);
...
static void LoadChargesSceneGfx(void)
{
    ...
    DecompressDataWithHeaderWram(gRaySceneCharges_Geogreymon_Tilemap, sRayScene->tilemapBuffers[1]);
