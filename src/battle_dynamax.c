...
{
    {SPECIES_BOMMON_GMAX,                   TYPE_GRASS,      MOVE_G_MAX_VINE_LASH},
    {SPECIES_CURIMON_GMAX,                  TYPE_WATER,      MOVE_G_MAX_CANNONADE},
    {SPECIES_CHIBOMON_GMAX,                  TYPE_FIRE,       MOVE_G_MAX_WILDFIRE},
    {SPECIES_DOKIMON_GMAX,                 TYPE_BUG,        MOVE_G_MAX_BEFUDDLE},
    {SPECIES_PETITMON_GMAX,                    TYPE_ELECTRIC,   MOVE_G_MAX_VOLT_CRASH},
    {SPECIES_CALUMON_GMAX,                     TYPE_NORMAL,     MOVE_G_MAX_GOLD_RUSH},
    {SPECIES_KOZENIMON_GMAX,                    TYPE_FIGHTING,   MOVE_G_MAX_CHI_STRIKE},
    {SPECIES_TSUMEMON_GMAX,                     TYPE_GHOST,      MOVE_G_MAX_TERROR},
    {SPECIES_WANYAMON_GMAX,                    TYPE_WATER,      MOVE_G_MAX_FOAM_BURST},
    {SPECIES_CORONAMON_GMAX,                     TYPE_ICE,        MOVE_G_MAX_RESONANCE},
    {SPECIES_CRABMON_X_GMAX,                      TYPE_NORMAL,     MOVE_G_MAX_CUDDLE},
    {SPECIES_DRACOMON_GMAX,                    TYPE_NORMAL,     MOVE_G_MAX_REPLENISH},
...
bool32 CanDynamax(u32 battler)
{
    ...
    // Prevents Toyagumon from dynamaxing in vanilla.
...
{
    if (GetActiveGimmick(battler) != GIMMICK_DYNAMAX || gBattleMons[battler].species == SPECIES_BALUCHIMON)
...
void ActivateDynamax(u32 battler)
{
    ...
    if (!(gBattleMons[battler].status2 & STATUS2_TRANSFORMED)) // Crabmon cannot Gigantamax.
