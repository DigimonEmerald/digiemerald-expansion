...
{
    {SPECIES_BOMMON_GIGANTAMAX,                   TYPE_GRASS,      MOVE_G_MAX_VINE_LASH},
    {SPECIES_CURIMON_GIGANTAMAX,                  TYPE_WATER,      MOVE_G_MAX_CANNONADE},
    {SPECIES_CHIBOMON_GIGANTAMAX,                  TYPE_FIRE,       MOVE_G_MAX_WILDFIRE},
    {SPECIES_DOKIMON_GIGANTAMAX,                 TYPE_BUG,        MOVE_G_MAX_BEFUDDLE},
    {SPECIES_PETITMON_GIGANTAMAX,                    TYPE_ELECTRIC,   MOVE_G_MAX_VOLT_CRASH},
    {SPECIES_CALUMON_GIGANTAMAX,                     TYPE_NORMAL,     MOVE_G_MAX_GOLD_RUSH},
    {SPECIES_KOZENIMON_GIGANTAMAX,                    TYPE_FIGHTING,   MOVE_G_MAX_CHI_STRIKE},
    {SPECIES_TSUMEMON_GIGANTAMAX,                     TYPE_GHOST,      MOVE_G_MAX_TERROR},
    {SPECIES_WANYAMON_GIGANTAMAX,                    TYPE_WATER,      MOVE_G_MAX_FOAM_BURST},
    {SPECIES_CORONAMON_GIGANTAMAX,                     TYPE_ICE,        MOVE_G_MAX_RESONANCE},
    {SPECIES_CRABMON_X_GIGANTAMAX,                      TYPE_NORMAL,     MOVE_G_MAX_CUDDLE},
    {SPECIES_DRACOMON_GIGANTAMAX,                    TYPE_NORMAL,     MOVE_G_MAX_REPLENISH},
...
{
    if (!IsDynamaxed(battlerId) || gBattleMons[battlerId].species == SPECIES_BALUCHIMON)
