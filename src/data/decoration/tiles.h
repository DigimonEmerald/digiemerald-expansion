...
const u16 DecorGfx_SUNARIZAMON_DOLL[] = {
    OBJ_EVENT_GFX_SUNARIZAMON_DOLL
};
...
const u16 DecorGfx_DEXDORUGAMON_DOLL[] = {
    OBJ_EVENT_GFX_DEXDORUGAMON_DOLL
};

const u16 DecorGfx_DONSHOUTMON_DOLL[] = {
    OBJ_EVENT_GFX_DONSHOUTMON_DOLL
};

const u16 DecorGfx_BIOSTEGOMON_DOLL[] = {
    OBJ_EVENT_GFX_BIOSTEGOMON_DOLL
};
...
const u16 DecorGfx_DARKLIZARDMON_DOLL[] = {
    OBJ_EVENT_GFX_DARKLIZARDMON_DOLL
};
...
const u16 DecorGfx_GARGOYLEMON_DOLL[] = {
    OBJ_EVENT_GFX_BIG_GARGOYLEMON_DOLL
};
