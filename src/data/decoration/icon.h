const struct DecorItem gDecorIconTable[] =
{
    ...
    [DECOR_SUNARIZAMON_DOLL]    = {NULL, NULL},
    ...
    [DECOR_DEXDORUGAMON_DOLL]     = {NULL, NULL},
    [DECOR_DONSHOUTMON_DOLL]    = {NULL, NULL},
    [DECOR_BIOSTEGOMON_DOLL]    = {NULL, NULL},
    [DECOR_BIRDRAMON_DOLL]     = {NULL, NULL},
    [DECOR_DARKLIZARDMON_DOLL]     = {NULL, NULL},
    ...
    [DECOR_GARGOYLEMON_DOLL]     = {gDecorIcon_GargoylemonDoll, gDecorIconPalette_GargoylemonDoll},
