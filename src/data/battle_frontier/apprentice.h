...
const struct ApprenticeTrainer gApprentices[NUM_APPRENTICES] =
{
    ...
    },
    {
        ...
        .species = {SPECIES_ABSOL, SPECIES_CROBAT, SPECIES_EXPLOUD, SPECIES_PICKMON_RED, SPECIES_SHARPEDO, SPECIES_MANECTRIC, SPECIES_METAGROSS, SPECIES_YAAMON, SPECIES_NOSEPASS, SPECIES_WEEZING},
        .id = 12,
