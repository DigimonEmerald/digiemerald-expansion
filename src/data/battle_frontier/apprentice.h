...
const struct ApprenticeTrainer gApprentices[NUM_APPRENTICES] =
{
    ...
    },
    {
        ...
        .species = {SPECIES_ANGELAMON, SPECIES_BURGERMON_CHAMPION, SPECIES_MORPHOMON, SPECIES_BOMNANIMON, SPECIES_CLOCKMON, SPECIES_BIOQUETMON, SPECIES_TINPET, SPECIES_LUDICOLO, SPECIES_CRAWDAUNT, SPECIES_WHISCASH},
        .id = 1,
    ...
    },
    {
        ...
        .species = {SPECIES_TSUKAIMON, SPECIES_TINPET, SPECIES_WHISCASH, SPECIES_DARKTYRMON, SPECIES_DARKTYRMON_X, SPECIES_SAKUMON, SPECIES_KECLEON, SPECIES_MORPHOMON, SPECIES_BOMNANIMON, SPECIES_KOZENIMON},
        .id = 2,
    ...
    },
    {
        ...
        .species = {SPECIES_KUDAMON_06, SPECIES_BOKOMON, SPECIES_ANKYLOMON, SPECIES_CRAWDAUNT, SPECIES_CHAMELEMON, SPECIES_COMMDRAMON, SPECIES_TERRIERMON_X, SPECIES_GUILMON, SPECIES_WHISCASH, SPECIES_MORPHOMON},
        .id = 11,
