...
const struct ApprenticeTrainer gApprentices[NUM_APPRENTICES] =
{
    ...
    },
    {
        ...
        .species = {SPECIES_TSUBUMON, SPECIES_LINOONE, SPECIES_KINGDRA, SPECIES_DELCATTY, SPECIES_PICHIMON, SPECIES_PABUMON, SPECIES_BOKOMON, SPECIES_MEDICHAM, SPECIES_SHIFTRY, SPECIES_BEAUTIFLY},
        .id = 4,
    ...
    },
    {
        ...
        .species = {SPECIES_BLKGABUMON, SPECIES_BOKOMON, SPECIES_DEMMERAMON, SPECIES_MISSIMON, SPECIES_PAWNMON_WHITE, SPECIES_GOREBYSS, SPECIES_GLALIE, SPECIES_WAILORD, SPECIES_SHARPEDO, SPECIES_KINGDRA},
        .id = 10,
