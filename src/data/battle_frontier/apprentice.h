...
const struct ApprenticeTrainer gApprentices[NUM_APPRENTICES] =
{
    ...
    },
    {
        ...
        .species = {SPECIES_SAKUMON, SPECIES_KAPURIMON, SPECIES_SYAKOMON, SPECIES_SALAMENCE, SPECIES_DEMMERAMON, SPECIES_MAWILE, SPECIES_ARMADILMON, SPECIES_GUILMON, SPECIES_ARCADIAMON_CHAMPION, SPECIES_MILOTIC},
        .id = 7,
