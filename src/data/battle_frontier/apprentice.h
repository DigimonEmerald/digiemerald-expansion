...
{
    {
        ...
        .species = {SPECIES_VORVOMON, SPECIES_ZENIMON, SPECIES_ILLUMISE, SPECIES_ALLOMON, SPECIES_BRELOOM, SPECIES_NINJASK, SPECIES_SHEDINJA, SPECIES_TYUTYUMON, SPECIES_MUCHOMON, SPECIES_VOLBEAT},
        .id = 0,
    ...
    },
    {
        ...
        .species = {SPECIES_SYAKOMON, SPECIES_ARCADIAMON_IT, SPECIES_IMPMON_X, SPECIES_ROSELIA, SPECIES_PATAMON, SPECIES_FLYGON, SPECIES_BRELOOM, SPECIES_MILOTIC, SPECIES_ALTARIA, SPECIES_CRADILY},
        .id = 8,
