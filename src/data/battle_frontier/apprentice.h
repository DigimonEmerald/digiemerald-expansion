...
const struct ApprenticeTrainer gApprentices[NUM_APPRENTICES] =
{
    ...
    },
    {
        ...
        .species = {SPECIES_ABSOL, SPECIES_CROBAT, SPECIES_EXPLOUD, SPECIES_PICKMON_RED, SPECIES_SHARPEDO, SPECIES_MANECTRIC, SPECIES_METAGROSS, SPECIES_YAAMON, SPECIES_NOSEPASS, SPECIES_ARMADILMON},
        .id = 12,
    ...
    },
    {
        ...
        .species = {SPECIES_SCEPTILE, SPECIES_POYOMON, SPECIES_FLYGON, SPECIES_CLAYDOL, SPECIES_ARMALDO, SPECIES_CROBAT, SPECIES_CRADILY, SPECIES_SOLROCK, SPECIES_LUNATONE, SPECIES_MOTIMON},
        .id = 14,
