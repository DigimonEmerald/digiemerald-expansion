...
const struct ApprenticeTrainer gApprentices[NUM_APPRENTICES] =
{
    ...
    },
    {
        ...
        .species = {SPECIES_BOKOMON, SPECIES_PUROROMON, SPECIES_BLGROWLMON, SPECIES_PICKMON_RED, SPECIES_KOZENIMON, SPECIES_ARMALDO, SPECIES_MUCHOMON, SPECIES_BIOTHUNMON, SPECIES_TRAILMON_BATTLE_ARMAMENT, SPECIES_TINPET},
        .id = 5,
    ...
    },
    {
        ...
        .species = {SPECIES_SYAKOMON, SPECIES_POYOMON, SPECIES_DAMEMON_FUSION, SPECIES_DIATRYMON, SPECIES_ARMALDO, SPECIES_GOTSUMON, SPECIES_DINOHYUMON, SPECIES_DELTAMON, SPECIES_DECKDRAMON, SPECIES_MOTIMON},
        .id = 14,
