...
const struct ApprenticeTrainer gApprentices[NUM_APPRENTICES] =
{
    ...
    },
    {
        ...
        .species = {SPECIES_PHASCOMON, SPECIES_MOTIMON, SPECIES_TENTOMON, SPECIES_CITRAMON, SPECIES_RENAMON, SPECIES_SUNMON, SPECIES_SALAMENCE, SPECIES_TROPIUS, SPECIES_SOLROCK, SPECIES_BAKOMON},
        .id = 9,
    ...
    },
    {
        ...
        .species = {SPECIES_SYAKOMON, SPECIES_POYOMON, SPECIES_DAMEMON_FUSION, SPECIES_CLAYDOL, SPECIES_ARMALDO, SPECIES_GOTSUMON, SPECIES_CRADILY, SPECIES_SOLROCK, SPECIES_DECKDRAMON, SPECIES_MOTIMON},
        .id = 14,
