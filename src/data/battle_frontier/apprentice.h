...
const struct ApprenticeTrainer gApprentices[NUM_APPRENTICES] =
{
    ...
    },
    {
        ...
        .species = {SPECIES_TSUKAIMON, SPECIES_TINPET, SPECIES_WHISCASH, SPECIES_ZANGOOSE, SPECIES_SEVIPER, SPECIES_SAKUMON, SPECIES_KECLEON, SPECIES_MORPHOMON, SPECIES_BOMNANIMON, SPECIES_KOZENIMON},
        .id = 2,
    ...
    },
    {
        ...
        .species = {SPECIES_TENTOMON, SPECIES_MOTIMON, SPECIES_KOZENIMON, SPECIES_BAKOMON, SPECIES_BIOQUETMON, SPECIES_BLGROWLMON, SPECIES_BLIMPMON, SPECIES_ZANGOOSE, SPECIES_AXEMON, SPECIES_BABOONMON},
        .id = 13,
