...
const struct ApprenticeTrainer gApprentices[NUM_APPRENTICES] =
{
    ...
    },
    {
        ...
        .species = {SPECIES_ABSOL, SPECIES_TINPET, SPECIES_KAPURIMON, SPECIES_DORULUMON, SPECIES_SAKUMON, SPECIES_DIATRYMON, SPECIES_SUNMON, SPECIES_SALAMENCE, SPECIES_WALREIN, SPECIES_DUSCLOPS},
        .id = 15,
