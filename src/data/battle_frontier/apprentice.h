...
const struct ApprenticeTrainer gApprentices[NUM_APPRENTICES] =
{
    ...
    },
    {
        ...
        .species = {SPECIES_BURGERMON_CHAMPION, SPECIES_HERISSMON, SPECIES_ALTARIA, SPECIES_DEMMERAMON, SPECIES_FLYGON, SPECIES_KAPURIMON, SPECIES_ARCADIAMON_CHAMPION, SPECIES_WAILORD, SPECIES_GRUMPIG, SPECIES_TINPET},
        .id = 3,
    ...
    },
    {
        ...
        .species = {SPECIES_BLKGABUMON, SPECIES_BOKOMON, SPECIES_DEMMERAMON, SPECIES_MISSIMON, SPECIES_PAWNMON_WHITE, SPECIES_GOREBYSS, SPECIES_GLALIE, SPECIES_WAILORD, SPECIES_CENTARUMON, SPECIES_PSYCHEMON},
        .id = 10,
    ...
    },
    {
        ...
        .species = {SPECIES_KUDAMON_06, SPECIES_BOKOMON, SPECIES_ANKYLOMON, SPECIES_CRAWDAUNT, SPECIES_WAILORD, SPECIES_COMMDRAMON, SPECIES_TERRIERMON_X, SPECIES_GUILMON, SPECIES_WHISCASH, SPECIES_MORPHOMON},
        .id = 11,
