...
const struct ApprenticeTrainer gApprentices[NUM_APPRENTICES] =
{
    ...
    },
    {
        ...
        .species = {SPECIES_SCEPTILE, SPECIES_ARCADIAMON_IT, SPECIES_BELLOSSOM, SPECIES_ROSELIA, SPECIES_CORSOLA, SPECIES_FLYGON, SPECIES_BRELOOM, SPECIES_MILOTIC, SPECIES_ALTARIA, SPECIES_CRADILY},
        .id = 8,
    ...
    },
    {
        ...
        .species = {SPECIES_QUAGSIRE, SPECIES_BOKOMON, SPECIES_PELIPPER, SPECIES_CRAWDAUNT, SPECIES_WAILORD, SPECIES_COMMDRAMON, SPECIES_SWAMPERT, SPECIES_GUILMON, SPECIES_WHISCASH, SPECIES_SHUCKLE},
        .id = 11,
