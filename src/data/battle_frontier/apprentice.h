...
const struct ApprenticeTrainer gApprentices[NUM_APPRENTICES] =
{
    ...
    },
    {
        ...
        .species = {SPECIES_TENTOMON, SPECIES_MOTIMON, SPECIES_KOZENIMON, SPECIES_BAKOMON, SPECIES_BIOQUETZALMON, SPECIES_BLACKGROWLMON, SPECIES_BLIMPMON, SPECIES_DARKTYRANNOMON, SPECIES_AXEMON, SPECIES_BABOONGAMON},
        .id = 13,
