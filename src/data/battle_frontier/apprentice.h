...
const struct ApprenticeTrainer gApprentices[NUM_APPRENTICES] =
{
    ...
    },
    {
        ...
        .species = {SPECIES_TSUBUMON, SPECIES_TSUKAIMON, SPECIES_PSYCHEMON, SPECIES_BLGAOGAMON, SPECIES_PICHIMON, SPECIES_PABUMON, SPECIES_BOKOMON, SPECIES_MEDICHAM, SPECIES_ALLOMON, SPECIES_VORVOMON},
        .id = 4,
    ...
    },
    {
        ...
        .species = {SPECIES_BOKOMON, SPECIES_PUROROMON, SPECIES_PICKMON_RED, SPECIES_MEDICHAM, SPECIES_TINPET, SPECIES_GLALIE, SPECIES_MOTIMON, SPECIES_YAAMON, SPECIES_ANKYLOMON, SPECIES_SHARPEDO},
        .id = 6,
    ...
    },
    {
        ...
        .species = {SPECIES_TENTOMON, SPECIES_MOTIMON, SPECIES_KOZENIMON, SPECIES_BAKOMON, SPECIES_BIOQUETMON, SPECIES_BLGROWLMON, SPECIES_MEDICHAM, SPECIES_ZANGOOSE, SPECIES_AXEMON, SPECIES_BABOONMON},
        .id = 13,
