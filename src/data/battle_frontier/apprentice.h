...
const struct ApprenticeTrainer gApprentices[NUM_APPRENTICES] =
{
    ...
    },
    {
        ...
        .species = {SPECIES_BOKOMON, SPECIES_PUROROMON, SPECIES_PICKMON_RED, SPECIES_BLIMPMON, SPECIES_TINPET, SPECIES_GLALIE, SPECIES_MOTIMON, SPECIES_YAAMON, SPECIES_ANKYLOMON, SPECIES_CENTARUMON},
        .id = 6,
    ...
    },
    {
        ...
        .species = {SPECIES_BLKGABUMON, SPECIES_BOKOMON, SPECIES_DEMMERAMON, SPECIES_MISSIMON, SPECIES_PAWNMON_WHITE, SPECIES_GOREBYSS, SPECIES_GLALIE, SPECIES_CHAMELEMON, SPECIES_CENTARUMON, SPECIES_PSYCHEMON},
        .id = 10,
