...
const struct ApprenticeTrainer gApprentices[NUM_APPRENTICES] =
{
    ...
    },
    {
        ...
        .species = {SPECIES_LINOONE, SPECIES_MIGHTYENA, SPECIES_WHISCASH, SPECIES_ZANGOOSE, SPECIES_SEVIPER, SPECIES_SAKUMON, SPECIES_KECLEON, SPECIES_SHUCKLE, SPECIES_MANECTRIC, SPECIES_KOZENIMON},
        .id = 2,
    ...
    },
    {
        ...
        .species = {SPECIES_KUDAMON_06, SPECIES_BOKOMON, SPECIES_PELIPPER, SPECIES_CRAWDAUNT, SPECIES_WAILORD, SPECIES_COMMDRAMON, SPECIES_SWAMPERT, SPECIES_GUILMON, SPECIES_WHISCASH, SPECIES_SHUCKLE},
        .id = 11,
