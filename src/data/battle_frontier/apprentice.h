...
const struct ApprenticeTrainer gApprentices[NUM_APPRENTICES] =
{
    ...
    },
    {
        ...
        .species = {SPECIES_PHASCOMON, SPECIES_MOTIMON, SPECIES_BLAZIKEN, SPECIES_CAMERUPT, SPECIES_RENAMON, SPECIES_SUNMON, SPECIES_SALAMENCE, SPECIES_TROPIUS, SPECIES_SOLROCK, SPECIES_BAKOMON},
        .id = 9,
    ...
    },
    {
        ...
        .species = {SPECIES_KUDAMON_06, SPECIES_BOKOMON, SPECIES_PELIPPER, SPECIES_CRAWDAUNT, SPECIES_WAILORD, SPECIES_COMMDRAMON, SPECIES_SWAMPERT, SPECIES_GUILMON, SPECIES_WHISCASH, SPECIES_MORPHOMON},
        .id = 11,
    ...
    },
    {
        ...
        .species = {SPECIES_BLAZIKEN, SPECIES_MOTIMON, SPECIES_KOZENIMON, SPECIES_BAKOMON, SPECIES_HARIYAMA, SPECIES_AGGRON, SPECIES_MEDICHAM, SPECIES_ZANGOOSE, SPECIES_VIGOROTH, SPECIES_SLAKING},
        .id = 13,
