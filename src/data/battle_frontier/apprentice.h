...
{
    {
        ...
        .species = {SPECIES_BEAUTIFLY, SPECIES_DUSTOX, SPECIES_ILLUMISE, SPECIES_SHIFTRY, SPECIES_BRELOOM, SPECIES_NINJASK, SPECIES_SHEDINJA, SPECIES_TYUTYUMON, SPECIES_HERACROSS, SPECIES_VOLBEAT},
        .id = 0,
    ...
    },
    {
        ...
        .species = {SPECIES_BOKOMON, SPECIES_PUROROMON, SPECIES_AGGRON, SPECIES_PICKMON_RED, SPECIES_KOZENIMON, SPECIES_ARMALDO, SPECIES_HERACROSS, SPECIES_NOSEPASS, SPECIES_EXPLOUD, SPECIES_MIGHTYENA},
        .id = 5,
    ...
    },
    {
        ...
        .species = {SPECIES_SCEPTILE, SPECIES_ARCADIAMON_IT, SPECIES_IMPMON_X, SPECIES_ROSELIA, SPECIES_CORSOLA, SPECIES_FLYGON, SPECIES_BRELOOM, SPECIES_MILOTIC, SPECIES_ALTARIA, SPECIES_CRADILY},
        .id = 8,
    ...
    },
    {
        ...
        .species = {SPECIES_BLKGABUMON, SPECIES_BOKOMON, SPECIES_DEMMERAMON, SPECIES_MISSIMON, SPECIES_OCTILLERY, SPECIES_GOREBYSS, SPECIES_GLALIE, SPECIES_WAILORD, SPECIES_SHARPEDO, SPECIES_KINGDRA},
        .id = 10,
