...
const struct ApprenticeTrainer gApprentices[NUM_APPRENTICES] =
{
    ...
    },
    {
        ...
        .species = {SPECIES_ABSOL, SPECIES_TINPET, SPECIES_KAPURIMON, SPECIES_BANETTE, SPECIES_SAKUMON, SPECIES_DIATRYMON, SPECIES_SUNMON, SPECIES_SALAMENCE, SPECIES_WALREIN, SPECIES_DUSCLOPS},
        .id = 15,
