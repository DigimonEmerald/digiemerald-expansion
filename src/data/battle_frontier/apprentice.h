...
const struct ApprenticeTrainer gApprentices[NUM_APPRENTICES] =
{
    ...
    },
    {
        ...
        .species = {SPECIES_SAKUMON, SPECIES_KAPURIMON, SPECIES_SYAKOMON, SPECIES_SALAMENCE, SPECIES_DEMMERAMON, SPECIES_BLGARURMON, SPECIES_ARMADILMON, SPECIES_GUILMON, SPECIES_ARCADIAMON_CHAMPION, SPECIES_MILOTIC},
        .id = 7,
    ...
    },
    {
        ...
        .species = {SPECIES_SYAKOMON, SPECIES_ARCADIAMON_IT, SPECIES_IMPMON_X, SPECIES_BULLMON, SPECIES_PATAMON, SPECIES_DAMEMON_FUSION, SPECIES_ATAMADEMON, SPECIES_MILOTIC, SPECIES_DARMAILMON, SPECIES_DINOHYUMON},
        .id = 8,
