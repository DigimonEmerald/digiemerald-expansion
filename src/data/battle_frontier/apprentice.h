...
{
    {
        ...
        .species = {SPECIES_VORVOMON, SPECIES_ZENIMON, SPECIES_ILLUMISE, SPECIES_ALLOMON, SPECIES_ATAMADEMON, SPECIES_BALISTAMON, SPECIES_BALUCHIMON, SPECIES_TYUTYUMON, SPECIES_MUCHOMON, SPECIES_VOLBEAT},
        .id = 0,
