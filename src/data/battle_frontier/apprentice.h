...
const struct ApprenticeTrainer gApprentices[NUM_APPRENTICES] =
{
    ...
    },
    {
        ...
        .species = {SPECIES_BOKOMON, SPECIES_PUROROMON, SPECIES_AGGRON, SPECIES_PICKMON_RED, SPECIES_KOZENIMON, SPECIES_ARMALDO, SPECIES_MUCHOMON, SPECIES_BIOTHUNMON, SPECIES_TRAILMON_BATTLE_ARMAMENT, SPECIES_TINPET},
        .id = 5,
    ...
    },
    {
        ...
        .species = {SPECIES_TENTOMON, SPECIES_MOTIMON, SPECIES_KOZENIMON, SPECIES_BAKOMON, SPECIES_BIOQUETMON, SPECIES_AGGRON, SPECIES_MEDICHAM, SPECIES_ZANGOOSE, SPECIES_AXEMON, SPECIES_BABOONMON},
        .id = 13,
