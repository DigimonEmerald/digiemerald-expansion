...
const struct ApprenticeTrainer gApprentices[NUM_APPRENTICES] =
{
    ...
    },
    {
        ...
        .species = {SPECIES_BLKGABUMON, SPECIES_BOKOMON, SPECIES_DEMMERAMON, SPECIES_MISSIMON, SPECIES_PAWNMON_WHITE, SPECIES_GOREBYSS, SPECIES_EYESMON, SPECIES_CHAMELEMON, SPECIES_CENTARUMON, SPECIES_PSYCHEMON},
        .id = 10,
    ...
    },
    {
        ...
        .species = {SPECIES_EXERMON, SPECIES_TINPET, SPECIES_KAPURIMON, SPECIES_DORULUMON, SPECIES_SAKUMON, SPECIES_DIATRYMON, SPECIES_SUNMON, SPECIES_SALAMENCE, SPECIES_WALREIN, SPECIES_EBIDRAMON},
        .id = 15,
