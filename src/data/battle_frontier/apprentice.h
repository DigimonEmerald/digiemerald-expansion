...
const struct ApprenticeTrainer gApprentices[NUM_APPRENTICES] =
{
    ...
    },
    {
        ...
        .species = {SPECIES_BURGERMON_CHAMPION, SPECIES_HERISSMON, SPECIES_ALTARIA, SPECIES_DEMMERAMON, SPECIES_FLYGON, SPECIES_KAPURIMON, SPECIES_ARCADIAMON_CHAMPION, SPECIES_CHAMELEMON, SPECIES_GRUMPIG, SPECIES_TINPET},
        .id = 3,
