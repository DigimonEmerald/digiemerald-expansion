...
const struct ApprenticeTrainer gApprentices[NUM_APPRENTICES] =
{
    ...
    },
    {
        ...
        .species = {SPECIES_SAKUMON, SPECIES_KAPURIMON, SPECIES_SCEPTILE, SPECIES_SALAMENCE, SPECIES_DEMMERAMON, SPECIES_MAWILE, SPECIES_ARMADILMON, SPECIES_GUILMON, SPECIES_GARDEVOIR, SPECIES_MILOTIC},
        .id = 7,
    ...
    },
    {
        ...
        .species = {SPECIES_SCEPTILE, SPECIES_ARCADIAMON_IT, SPECIES_IMPMON_X, SPECIES_ROSELIA, SPECIES_PATAMON, SPECIES_FLYGON, SPECIES_BRELOOM, SPECIES_MILOTIC, SPECIES_ALTARIA, SPECIES_CRADILY},
        .id = 8,
    ...
    },
    {
        ...
        .species = {SPECIES_SCEPTILE, SPECIES_POYOMON, SPECIES_FLYGON, SPECIES_CLAYDOL, SPECIES_ARMALDO, SPECIES_GOTSUMON, SPECIES_CRADILY, SPECIES_SOLROCK, SPECIES_LUNATONE, SPECIES_MOTIMON},
        .id = 14,
