...
const struct ApprenticeTrainer gApprentices[NUM_APPRENTICES] =
{
    ...
    },
    {
        ...
        .species = {SPECIES_SWELLOW, SPECIES_SWALOT, SPECIES_MORPHOMON, SPECIES_MANECTRIC, SPECIES_TORKOAL, SPECIES_HARIYAMA, SPECIES_TINPET, SPECIES_LUDICOLO, SPECIES_CRAWDAUNT, SPECIES_WHISCASH},
        .id = 1,
    ...
    },
    {
        ...
        .species = {SPECIES_TSUBUMON, SPECIES_TSUKAIMON, SPECIES_PSYCHEMON, SPECIES_DELCATTY, SPECIES_PICHIMON, SPECIES_PABUMON, SPECIES_BOKOMON, SPECIES_MEDICHAM, SPECIES_SHIFTRY, SPECIES_BEAUTIFLY},
        .id = 4,
