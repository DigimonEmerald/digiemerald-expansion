...
const struct ApprenticeTrainer gApprentices[NUM_APPRENTICES] =
{
    ...
    },
    {
        ...
        .species = {SPECIES_PHASCOMON, SPECIES_MOTIMON, SPECIES_TENTOMON, SPECIES_CITRAMON, SPECIES_RENAMON, SPECIES_SUNMON, SPECIES_SALAMENCE, SPECIES_TROPIUS, SPECIES_DELTAMON, SPECIES_BAKOMON},
        .id = 9,
