...
const struct ApprenticeTrainer gApprentices[NUM_APPRENTICES] =
{
    ...
    },
    {
        ...
        .species = {SPECIES_TSUKAIMON, SPECIES_TINPET, SPECIES_DEPUTYMON, SPECIES_DARKTYRMON, SPECIES_DARKTYRMON_X, SPECIES_SAKUMON, SPECIES_KECLEON, SPECIES_MORPHOMON, SPECIES_BOMNANIMON, SPECIES_KOZENIMON},
        .id = 2,
