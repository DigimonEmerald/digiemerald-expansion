...
const struct ApprenticeTrainer gApprentices[NUM_APPRENTICES] =
{
    ...
    },
    {
        ...
        .species = {SPECIES_ABSOL, SPECIES_GOTSUMON, SPECIES_TRAILMON_BATTLE_ARMAMENT, SPECIES_PICKMON_RED, SPECIES_CENTARUMON, SPECIES_BOMNANIMON, SPECIES_METAGROSS, SPECIES_YAAMON, SPECIES_BIOTHUNMON, SPECIES_ARMADILMON},
        .id = 12,
    ...
    },
    {
        ...
        .species = {SPECIES_ABSOL, SPECIES_TINPET, SPECIES_KAPURIMON, SPECIES_DORULUMON, SPECIES_SAKUMON, SPECIES_DIATRYMON, SPECIES_SUNMON, SPECIES_SALAMENCE, SPECIES_WALREIN, SPECIES_EBIDRAMON},
        .id = 15,
