...
const struct ApprenticeTrainer gApprentices[NUM_APPRENTICES] =
{
    ...
    },
    {
        ...
        .species = {SPECIES_LINOONE, SPECIES_TINPET, SPECIES_WHISCASH, SPECIES_ZANGOOSE, SPECIES_SEVIPER, SPECIES_SAKUMON, SPECIES_KECLEON, SPECIES_MORPHOMON, SPECIES_MANECTRIC, SPECIES_KOZENIMON},
        .id = 2,
