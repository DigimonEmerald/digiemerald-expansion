...
const struct ApprenticeTrainer gApprentices[NUM_APPRENTICES] =
{
    ...
    },
    {
        ...
        .species = {SPECIES_STARMIE, SPECIES_PUROROMON, SPECIES_PICKMON_RED, SPECIES_MEDICHAM, SPECIES_MIGHTYENA, SPECIES_GLALIE, SPECIES_MOTIMON, SPECIES_ELECTRODE, SPECIES_PELIPPER, SPECIES_SHARPEDO},
        .id = 6,
    ...
    },
    {
        ...
        .species = {SPECIES_SAKUMON, SPECIES_KAPURIMON, SPECIES_SCEPTILE, SPECIES_SALAMENCE, SPECIES_DEMMERAMON, SPECIES_MAWILE, SPECIES_WEEZING, SPECIES_LANTURN, SPECIES_GARDEVOIR, SPECIES_MILOTIC},
        .id = 7,
    ...
    },
    {
        ...
        .species = {SPECIES_SKARMORY, SPECIES_MOTIMON, SPECIES_BLAZIKEN, SPECIES_CAMERUPT, SPECIES_DONPHAN, SPECIES_SUNMON, SPECIES_SALAMENCE, SPECIES_TROPIUS, SPECIES_SOLROCK, SPECIES_RHYDON},
        .id = 9,
    ...
    },
    {
        ...
        .species = {SPECIES_ABSOL, SPECIES_CROBAT, SPECIES_EXPLOUD, SPECIES_PICKMON_RED, SPECIES_SHARPEDO, SPECIES_MANECTRIC, SPECIES_METAGROSS, SPECIES_ELECTRODE, SPECIES_NOSEPASS, SPECIES_WEEZING},
        .id = 12,
    ...
    },
    {
        ...
        .species = {SPECIES_BLAZIKEN, SPECIES_MOTIMON, SPECIES_KOZENIMON, SPECIES_RHYDON, SPECIES_HARIYAMA, SPECIES_AGGRON, SPECIES_MEDICHAM, SPECIES_ZANGOOSE, SPECIES_VIGOROTH, SPECIES_SLAKING},
        .id = 13,
