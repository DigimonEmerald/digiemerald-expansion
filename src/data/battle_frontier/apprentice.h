...
const struct ApprenticeTrainer gApprentices[NUM_APPRENTICES] =
{
    ...
    },
    {
        ...
        .species = {SPECIES_SWALOT, SPECIES_HERISSMON, SPECIES_ALTARIA, SPECIES_DEMMERAMON, SPECIES_FLYGON, SPECIES_KAPURIMON, SPECIES_GARDEVOIR, SPECIES_WAILORD, SPECIES_GRUMPIG, SPECIES_TINPET},
        .id = 3,
