...
const struct ApprenticeTrainer gApprentices[NUM_APPRENTICES] =
{
    ...
    },
    {
        ...
        .species = {SPECIES_TSUBUMON, SPECIES_LINOONE, SPECIES_KINGDRA, SPECIES_DELCATTY, SPECIES_PICHIMON, SPECIES_PABUMON, SPECIES_STARMIE, SPECIES_MEDICHAM, SPECIES_SHIFTRY, SPECIES_BEAUTIFLY},
        .id = 4,
    ...
    },
    {
        ...
        .species = {SPECIES_STARMIE, SPECIES_PUROROMON, SPECIES_AGGRON, SPECIES_PICKMON_RED, SPECIES_KOZENIMON, SPECIES_ARMALDO, SPECIES_HERACROSS, SPECIES_NOSEPASS, SPECIES_EXPLOUD, SPECIES_MIGHTYENA},
        .id = 5,
    ...
    },
    {
        ...
        .species = {SPECIES_STARMIE, SPECIES_PUROROMON, SPECIES_PICKMON_RED, SPECIES_MEDICHAM, SPECIES_MIGHTYENA, SPECIES_GLALIE, SPECIES_MOTIMON, SPECIES_YAAMON, SPECIES_PELIPPER, SPECIES_SHARPEDO},
        .id = 6,
    ...
    },
    {
        ...
        .species = {SPECIES_BLKGABUMON, SPECIES_STARMIE, SPECIES_DEMMERAMON, SPECIES_MISSIMON, SPECIES_OCTILLERY, SPECIES_GOREBYSS, SPECIES_GLALIE, SPECIES_WAILORD, SPECIES_SHARPEDO, SPECIES_KINGDRA},
        .id = 10,
