...
const struct ApprenticeTrainer gApprentices[NUM_APPRENTICES] =
{
    ...
    },
    {
        ...
        .species = {SPECIES_BOKOMON, SPECIES_PUROROMON, SPECIES_PICKMON_RED, SPECIES_MEDICHAM, SPECIES_TINPET, SPECIES_GLALIE, SPECIES_MOTIMON, SPECIES_YAAMON, SPECIES_PELIPPER, SPECIES_SHARPEDO},
        .id = 6,
