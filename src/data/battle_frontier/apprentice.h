...
{
    {
        ...
        .species = {SPECIES_VORVOMON, SPECIES_DUSTOX, SPECIES_ILLUMISE, SPECIES_SHIFTRY, SPECIES_BRELOOM, SPECIES_NINJASK, SPECIES_SHEDINJA, SPECIES_TYUTYUMON, SPECIES_MUCHOMON, SPECIES_VOLBEAT},
        .id = 0,
