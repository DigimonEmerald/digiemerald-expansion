...
const struct ApprenticeTrainer gApprentices[NUM_APPRENTICES] =
{
    ...
    },
    {
        ...
        .species = {SPECIES_SAKUMON, SPECIES_KAPURIMON, SPECIES_SYAKOMON, SPECIES_FROGMON, SPECIES_DEMIMERAMON, SPECIES_BLACKGARURUMON, SPECIES_ARMADILLOMON, SPECIES_GUILMON, SPECIES_ARCADIAMON_CHAMPION, SPECIES_DOKUGUMON},
        .id = 7,
