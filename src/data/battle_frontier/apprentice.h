...
{
    {
        ...
        .species = {SPECIES_VORVOMON, SPECIES_ZENIMON, SPECIES_ILLUMISE, SPECIES_SHIFTRY, SPECIES_BRELOOM, SPECIES_NINJASK, SPECIES_SHEDINJA, SPECIES_TYUTYUMON, SPECIES_MUCHOMON, SPECIES_VOLBEAT},
        .id = 0,
    ...
    },
    {
        ...
        .species = {SPECIES_TSUBUMON, SPECIES_TSUKAIMON, SPECIES_PSYCHEMON, SPECIES_DELCATTY, SPECIES_PICHIMON, SPECIES_PABUMON, SPECIES_BOKOMON, SPECIES_MEDICHAM, SPECIES_SHIFTRY, SPECIES_VORVOMON},
        .id = 4,
