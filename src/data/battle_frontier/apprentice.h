...
const struct ApprenticeTrainer gApprentices[NUM_APPRENTICES] =
{
    ...
    },
    {
        ...
        .species = {SPECIES_BOKOMON, SPECIES_PUROROMON, SPECIES_AGGRON, SPECIES_PICKMON_RED, SPECIES_KOZENIMON, SPECIES_ARMALDO, SPECIES_MUCHOMON, SPECIES_NOSEPASS, SPECIES_TRAILMON_BATTLE_ARMAMENT, SPECIES_TINPET},
        .id = 5,
    ...
    },
    {
        ...
        .species = {SPECIES_ABSOL, SPECIES_GOTSUMON, SPECIES_TRAILMON_BATTLE_ARMAMENT, SPECIES_PICKMON_RED, SPECIES_SHARPEDO, SPECIES_MANECTRIC, SPECIES_METAGROSS, SPECIES_YAAMON, SPECIES_NOSEPASS, SPECIES_ARMADILMON},
        .id = 12,
