...
{
    {
        ...
        .species = {SPECIES_VORVOMON, SPECIES_ZENIMON, SPECIES_ILLUMISE, SPECIES_ALLOMON, SPECIES_ATAMADEMON, SPECIES_NINJASK, SPECIES_SHEDINJA, SPECIES_TYUTYUMON, SPECIES_MUCHOMON, SPECIES_VOLBEAT},
        .id = 0,
    ...
    },
    {
        ...
        .species = {SPECIES_TENTOMON, SPECIES_MOTIMON, SPECIES_KOZENIMON, SPECIES_BAKOMON, SPECIES_HARIYAMA, SPECIES_AGGRON, SPECIES_MEDICHAM, SPECIES_ZANGOOSE, SPECIES_VIGOROTH, SPECIES_SLAKING},
        .id = 13,
