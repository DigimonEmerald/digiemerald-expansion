...
const struct ApprenticeTrainer gApprentices[NUM_APPRENTICES] =
{
    ...
    },
    {
        ...
        .species = {SPECIES_TSUBUMON, SPECIES_TSUKAIMON, SPECIES_PSYCHEMON, SPECIES_DELCATTY, SPECIES_PICHIMON, SPECIES_PABUMON, SPECIES_BOKOMON, SPECIES_MEDICHAM, SPECIES_ALLOMON, SPECIES_VORVOMON},
        .id = 4,
