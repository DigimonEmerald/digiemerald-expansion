...
const struct ApprenticeTrainer gApprentices[NUM_APPRENTICES] =
{
    ...
    },
    {
        ...
        .species = {SPECIES_ANGELAMON, SPECIES_BURGERMON_CHAMPION, SPECIES_MORPHOMON, SPECIES_BOMNANIMON, SPECIES_CLOCKMON, SPECIES_BIOQUETMON, SPECIES_TINPET, SPECIES_AGUNIMON, SPECIES_DEVIMON, SPECIES_DEPUTYMON},
        .id = 1,
    ...
    },
    {
        ...
        .species = {SPECIES_EXERMON, SPECIES_GOTSUMON, SPECIES_TRAILMON_BATTLE_ARMAMENT, SPECIES_PICKMON_RED, SPECIES_CENTARUMON, SPECIES_BOMNANIMON, SPECIES_GAOGAMON, SPECIES_YAAMON, SPECIES_BIOTHUNMON, SPECIES_ARMADILMON},
        .id = 12,
