...
const struct ApprenticeTrainer gApprentices[NUM_APPRENTICES] =
{
    ...
    },
    {
        ...
        .species = {SPECIES_SAKUMON, SPECIES_KAPURIMON, SPECIES_SYAKOMON, SPECIES_FROGMON, SPECIES_DEMMERAMON, SPECIES_BLGARURMON, SPECIES_ARMADILMON, SPECIES_GUILMON, SPECIES_ARCADIAMON_CHAMPION, SPECIES_DOKUGUMON},
        .id = 7,
    ...
    },
    {
        ...
        .species = {SPECIES_PHASCOMON, SPECIES_MOTIMON, SPECIES_TENTOMON, SPECIES_CITRAMON, SPECIES_RENAMON, SPECIES_SUNMON, SPECIES_FROGMON, SPECIES_ELEPHANMON, SPECIES_DELTAMON, SPECIES_BAKOMON},
        .id = 9,
