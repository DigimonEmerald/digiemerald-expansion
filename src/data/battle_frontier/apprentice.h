...
const struct ApprenticeTrainer gApprentices[NUM_APPRENTICES] =
{
    ...
    },
    {
        ...
        .species = {SPECIES_ANGELAMON, SPECIES_BURGERMON_CHAMPION, SPECIES_MORPHOMON, SPECIES_BOMNANIMON, SPECIES_TORKOAL, SPECIES_BIOQUETMON, SPECIES_TINPET, SPECIES_LUDICOLO, SPECIES_CRAWDAUNT, SPECIES_WHISCASH},
        .id = 1,
    ...
    },
    {
        ...
        .species = {SPECIES_PHASCOMON, SPECIES_MOTIMON, SPECIES_TENTOMON, SPECIES_CAMERUPT, SPECIES_RENAMON, SPECIES_SUNMON, SPECIES_SALAMENCE, SPECIES_TROPIUS, SPECIES_SOLROCK, SPECIES_BAKOMON},
        .id = 9,
