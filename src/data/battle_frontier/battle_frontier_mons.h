const struct FacilityMon gBattleFrontierMons[NUM_FRONTIER_MONS] =
{
    ...
    [FRONTIER_MON_PAWNMON_BLACK] = {
        .species = SPECIES_PAWNMON_BLACK,
    ...
    [FRONTIER_MON_CHOUMON] = {
        .species = SPECIES_CHOUMON,
    ...
    [FRONTIER_MON_FLARIZAMON_1] = {
        .species = SPECIES_FLARIZAMON,
