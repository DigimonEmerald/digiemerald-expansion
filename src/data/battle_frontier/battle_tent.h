...
const u16 gSlateportBattleTentTrainerMons_Jolie[] =
{
    ...
    SLATEPORT_TENT_MON_BETELGAMMAMON,
    SLATEPORT_TENT_MON_DEPTHMON,
    SLATEPORT_TENT_MON_DELTAMON,
    SLATEPORT_TENT_MON_DONSHOUTMON_2,
    SLATEPORT_TENT_MON_ARRESTERDRAMON_1,
    SLATEPORT_TENT_MON_ARRESTERDRAMON_2,
    SLATEPORT_TENT_MON_ATAMADEKACHIMON,
    -1
};
...
const u16 gSlateportBattleTentTrainerMons_Malachi[] =
{
    ...
    SLATEPORT_TENT_MON_DEXDORUGAMON,
    SLATEPORT_TENT_MON_DARCMON_2,
    SLATEPORT_TENT_MON_CHRYSALIMON_1,
    SLATEPORT_TENT_MON_DEADLYAXEMON,
    SLATEPORT_TENT_MON_DELTAMON,
    SLATEPORT_TENT_MON_ARRESTERDRAMON_1,
    SLATEPORT_TENT_MON_CHRYSALIMON_2,
...
const u16 gSlateportBattleTentTrainerMons_Kelsie[] =
{
    ...
    SLATEPORT_TENT_MON_BETELGAMMAMON,
    SLATEPORT_TENT_MON_DEPTHMON,
    SLATEPORT_TENT_MON_DONSHOUTMON_1,
...
const u16 gSlateportBattleTentTrainerMons_Davon[] =
{
    ...
    SLATEPORT_TENT_MON_CLEARAGUMON,
    SLATEPORT_TENT_MON_DONSHOUTMON_2,
    SLATEPORT_TENT_MON_ARRESTERDRAMON_2,
...
const u16 gSlateportBattleTentTrainerMons_Helena[] =
{
    SLATEPORT_TENT_MON_TINPET_1,
    SLATEPORT_TENT_MON_TINPET_2,
    SLATEPORT_TENT_MON_BLACKAGUMON_X,
    SLATEPORT_TENT_MON_MINOMON,
    SLATEPORT_TENT_MON_DEADLYAXEMON,
    SLATEPORT_TENT_MON_DARKTYRANNOMON_X_1,
    SLATEPORT_TENT_MON_DELTAMON,
    SLATEPORT_TENT_MON_JAZAMON_2,
    SLATEPORT_TENT_MON_DARKTYRANNOMON_X_2,
...
const u16 gSlateportBattleTentTrainerMons_Davion[] =
{
    SLATEPORT_TENT_MON_DEXDORUGAMON,
    SLATEPORT_TENT_MON_XIAOMON,
    SLATEPORT_TENT_MON_BLACKGATOMON_1,
    SLATEPORT_TENT_MON_BLACKGATOMON_2,
...
const u16 gSlateportBattleTentTrainerMons_Irvin[] =
{
    ...
    SLATEPORT_TENT_MON_BALLISTAMON_1,
    SLATEPORT_TENT_MON_BALLISTAMON_2,
    SLATEPORT_TENT_MON_BLACKGATOMON_1,
    SLATEPORT_TENT_MON_BLACKGATOMON_2,
    SLATEPORT_TENT_MON_COREDRAMON_BLUE,
    SLATEPORT_TENT_MON_BAOHUCKMON,
...
const u16 gSlateportBattleTentTrainerMons_Kyler[] =
{
    ...
    SLATEPORT_TENT_MON_BOOGIEMON_1,
    SLATEPORT_TENT_MON_BOOGIEMON_2,
    SLATEPORT_TENT_MON_DARKLIZARDMON,
    -1
};
...
const struct BattleFrontierTrainer gSlateportBattleTentTrainers[NUM_BATTLE_TENT_TRAINERS] =
{
    ...
    [SLATEPORT_TENT_TRAINER_MAGGIE] = {
        ...
        .speechBefore = {EC_POKEMON(RELEMON), EC_POKEMON(HERISSMON), EC_POKEMON_NATIONAL(LABRAMON), EC_WORD_ELLIPSIS, EC_WORD_UM, EC_WORD_ELLIPSIS},
        .speechWin = {EC_POKEMON(BIOTHUNDERBIRDMON), EC_WORD_ELLIPSIS, EC_WORD_UM, EC_POKEMON(DARKTYRANNOMON_X), EC_WORD_EXCL, -1},
        .speechLose = {EC_POKEMON(BIOTHUNDERBIRDMON), EC_WORD_ELLIPSIS, EC_WORD_UM, EC_POKEMON_NATIONAL(DRACOMON), EC_WORD_ELLIPSIS, EC_WORD_UH_OH},
...
{
    VERDANTURF_TENT_MON_ARRESTERDRAMON,
    VERDANTURF_TENT_MON_BURGERMON_CHAMPION,
    VERDANTURF_TENT_MON_DEXDORUGAMON,
...
{
    VERDANTURF_TENT_MON_CLEARAGUMON,
    VERDANTURF_TENT_MON_DEPTHMON,
    VERDANTURF_TENT_MON_BLACKAGUMON_X_1,
    VERDANTURF_TENT_MON_ZUBAMON,
...
const u16 gVerdanturfBattleTentTrainerMons_Markus[] =
{
    ...
    VERDANTURF_TENT_MON_DEPTHMON,
    VERDANTURF_TENT_MON_ZUBAMON,
    VERDANTURF_TENT_MON_BLACKAGUMON_X_2,
...
const u16 gVerdanturfBattleTentTrainerMons_Caitlyn[] =
{
    ...
    VERDANTURF_TENT_MON_DONSHOUTMON,
...
const u16 gVerdanturfBattleTentTrainerMons_Desiree[] =
{
    ...
    VERDANTURF_TENT_MON_DONSHOUTMON,
    VERDANTURF_TENT_MON_DARKTYRANNOMON_X,
    VERDANTURF_TENT_MON_PHASCOMON,
...
{
    VERDANTURF_TENT_MON_BLACKGATOMON_1,
    VERDANTURF_TENT_MON_DONSHOUTMON,
    VERDANTURF_TENT_MON_BLACKGATOMON_2,
    VERDANTURF_TENT_MON_COREDRAMON_GREEN,
...
{
    VERDANTURF_TENT_MON_BALLISTAMON,
    VERDANTURF_TENT_MON_COREDRAMON_GREEN,
    VERDANTURF_TENT_MON_ZENIMON,
    VERDANTURF_TENT_MON_MINOMON,
    VERDANTURF_TENT_MON_BLACKGATOMON_2,
...
const u16 gVerdanturfBattleTentTrainerMons_Darnell[] =
{
    ...
    VERDANTURF_TENT_MON_BAROMON,
    VERDANTURF_TENT_MON_COREDRAMON_GREEN,
    VERDANTURF_TENT_MON_DEADLYAXEMON,
    VERDANTURF_TENT_MON_BAOHUCKMON,
    -1
};
...
const u16 gVerdanturfBattleTentTrainerMons_Addison[] =
{
    VERDANTURF_TENT_MON_TINKERMON,
    VERDANTURF_TENT_MON_TOYAGUMON,
    VERDANTURF_TENT_MON_DARKLIZARDMON,
    VERDANTURF_TENT_MON_KAKKINMON,
    VERDANTURF_TENT_MON_CLEARAGUMON,
    -1
};
...
const u16 gVerdanturfBattleTentTrainerMons_Tyson[] =
{
    ...
    VERDANTURF_TENT_MON_BETELGAMMAMON,
    VERDANTURF_TENT_MON_PHASCOMON,
    VERDANTURF_TENT_MON_MOONMON,
    VERDANTURF_TENT_MON_DARKLIZARDMON,
    VERDANTURF_TENT_MON_DEADLYAXEMON,
...
const u16 gVerdanturfBattleTentTrainerMons_Laila[] =
{
    VERDANTURF_TENT_MON_KOKOMON,
    VERDANTURF_TENT_MON_BETELGAMMAMON,
    VERDANTURF_TENT_MON_CHRYSALIMON_2,
    VERDANTURF_TENT_MON_BLACKAGUMON_X_2,
    VERDANTURF_TENT_MON_BULKMON,
    VERDANTURF_TENT_MON_BAOHUCKMON,
    -1
...
const u16 gVerdanturfBattleTentTrainerMons_Waren[] =
{
    VERDANTURF_TENT_MON_TINKERMON,
    VERDANTURF_TENT_MON_BLACKGATOMON_1,
    VERDANTURF_TENT_MON_CHRYSALIMON_1,
    VERDANTURF_TENT_MON_BURGERMON_CHAMPION,
    VERDANTURF_TENT_MON_ANGELAMON,
    -1
};
...
const u16 gFallarborBattleTentTrainerMons_Amber[] =
{
    ...
    FALLARBOR_TENT_MON_ARRESTERDRAMON,
...
const u16 gFallarborBattleTentTrainerMons_Javier[] =
{
    ...
    FALLARBOR_TENT_MON_DEXDORUGAMON,
...
const u16 gFallarborBattleTentTrainerMons_Treve[] =
{
    ...
    FALLARBOR_TENT_MON_DEPTHMON,
    FALLARBOR_TENT_MON_JAZAMON,
    FALLARBOR_TENT_MON_BLACKAGUMON_X_1,
    -1
};
...
{
    FALLARBOR_TENT_MON_CHRYSALIMON,
...
{
    FALLARBOR_TENT_MON_BLACKGATOMON_1,
    FALLARBOR_TENT_MON_BLACKGATOMON_2,
...
const u16 gFallarborBattleTentTrainerMons_Alanzo[] =
{
    ...
    FALLARBOR_TENT_MON_BALLISTAMON_1,
    FALLARBOR_TENT_MON_BALLISTAMON_2,
    -1
};
...
{
    FALLARBOR_TENT_MON_DONSHOUTMON,
    FALLARBOR_TENT_MON_BAOHUCKMON,
    FALLARBOR_TENT_MON_DARKLIZARDMON,
    FALLARBOR_TENT_MON_DEXDORUGAMON,
    FALLARBOR_TENT_MON_ARRESTERDRAMON,
    -1
};
...
{
    FALLARBOR_TENT_MON_DONSHOUTMON,
    FALLARBOR_TENT_MON_BETELGAMMAMON,
    FALLARBOR_TENT_MON_BALLISTAMON_1,
    FALLARBOR_TENT_MON_XIAOMON,
    FALLARBOR_TENT_MON_TSUKAIMON_2,
    FALLARBOR_TENT_MON_AKATORIMON,
