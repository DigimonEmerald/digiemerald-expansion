...
const struct MoveInfo gMovesInfo[MOVES_COUNT_ALL] =
{
    ...
    [MOVE_BLESSING] =
    {
        ...
        .priority = 0,
        .category = DAMAGE_CATEGORY_STATUS,
        .argument = { .nonVolatileStatus = MOVE_EFFECT_CONVERTED },
        .zMove = { .effect = Z_EFFECT_ATK_UP_1 },
        .magicCoatAffected = TRUE,
        .contestEffect = CONTEST_EFFECT_BADLY_STARTLE_FRONT_MON,
        .contestCategory = CONTEST_CATEGORY_BEAUTY,
    ...
    [MOVE_GIGA_SCISSOR] =
    {
        .name = COMPOUND_STRING("Giga Scissor"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BLUE_BLASTER] =
    {
        .name = COMPOUND_STRING("Blue Blaster"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_GAO_RUSH] =
    {
        .name = COMPOUND_STRING("Gao Rush"),
        .description = COMPOUND_STRING(
            "The user throws high-speed\n"
            "punches hitting 2-5 times."),
        .effect = EFFECT_MULTI_HIT,
        .power = 17,
        .type = TYPE_FIGHTING,
        .accuracy = 100,
    ...
    [MOVE_CORONA_FLAME] =
    {
        .name = COMPOUND_STRING("Corona Flame"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BUBBLE_SPIT] =
    {
        .name = COMPOUND_STRING("Bubble Spit"),
        .description = COMPOUND_STRING(
            "The user spews out frothy hard\n"
            "bubbles for self-defense"),
        .effect = EFFECT_HIT,
        .power = 40,
        .type = TYPE_NORMAL,
        .accuracy = 100,
    ...
    [MOVE_SAINT_HEAL] =
    {
        .name = COMPOUND_STRING("Saint Heal"),
        .description = COMPOUND_STRING(
            "Restores self and allies\n"
            "through a field of holy power."),
        .effect = EFFECT_JUNGLE_HEALING,
        .power = 0,
        .type = TYPE_LIGHT,
        .accuracy = 0,
    ...
    [MOVE_GATLING] =
    {
        .name = COMPOUND_STRING("Gatling"),
        .description = COMPOUND_STRING(
            "A barrage of bullets shoot\n"
            "randomly at any foes."),
        .effect = EFFECT_HIT,
        .power = 65,
        .type = TYPE_STEEL,
        .accuracy = 90,
    ...
    [MOVE_BOLT_BREAK] =
    {
        .name = COMPOUND_STRING("Bolt Break"),
        .description = COMPOUND_STRING(
            "Forces out all the power of\n"
            "a digicore fainting the user"),
        .effect = EFFECT_EXPLOSION,
        .power = 200,
        .type = TYPE_ELECTRIC,
        .accuracy = 100,
    ...
    [MOVE_GENESIS_SUPERNOVA] =
    {
        ...
        .description = COMPOUND_STRING(
            "Falcomon attacks with full force.\n"
