...
const u32 gSlotMachineMenu_Gfx[] = INCBIN_U32("graphics/slot_machine/menu.4bpp.smol");
...
const u16 gSlotMachineReelTimePetitmon_Pal[] = INCBIN_U16("graphics/slot_machine/reel_time_petitmon.gbapal");
...
const u32 gSlotMachineDigitalDisplay_Gfx[] = INCBIN_U32("graphics/slot_machine/digital_display.4bpp.smol");
