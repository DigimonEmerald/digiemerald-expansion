...
const u32 gIntroDamemon_fusion_Gfx[] = INCBIN_U32("graphics/intro/scene_2/damemon_fusion.4bpp.lz");
...
const u32 gIntroGekomon_Gfx[] = INCBIN_U32("graphics/intro/scene_3/gekomon.8bpp.lz");
const u32 gIntroGekomon_Tilemap[] = INCBIN_U32("graphics/intro/scene_3/gekomon.bin.lz");
...
const u32 gIntroLegendBg_Gfx[] = INCBIN_U32("graphics/intro/scene_3/legend_bg.4bpp.lz"); // gekomon/gatomon_x bg
const u32 gIntroGekomonBg_Tilemap[] = INCBIN_U32("graphics/intro/scene_3/gekomon_bg.bin.lz");
...
const u32 gIntroDamemon_fusionSilhouette_Gfx[] = INCBIN_U32("graphics/intro/scene_1/damemon_fusion.4bpp.lz");
