...
const u32 gRaySceneTakesFlight_Geogreymon_Gfx[]     = INCBIN_U32("graphics/rayquaza_scene/scene_2/geogreymon.8bpp.lz");
const u32 gRaySceneTakesFlight_Geogreymon_Pal[]     = INCBIN_U32("graphics/rayquaza_scene/scene_2/geogreymon.gbapal.lz");
const u32 gRaySceneTakesFlight_Geogreymon_Tilemap[] = INCBIN_U32("graphics/rayquaza_scene/scene_2/geogreymon.bin.lz");
const u32 gRaySceneTakesFlight_Bg_Gfx[]           = INCBIN_U32("graphics/rayquaza_scene/scene_2/bg.4bpp.lz"); // uses pal 2 of gRaySceneTakesFlight_Geogreymon_Pal
const u32 gRaySceneTakesFlight_Bg_Tilemap[]       = INCBIN_U32("graphics/rayquaza_scene/scene_2/bg.bin.lz");

// Scene 3 (RAY_ANIM_DESCENDS)
const u32 gRaySceneDescends_Geogreymon_Gfx[]     = INCBIN_U32("graphics/rayquaza_scene/scene_3/geogreymon.4bpp.lz");
...
const u32 gRaySceneDescends_GeogreymonTail_Gfx[] = INCBIN_U32("graphics/rayquaza_scene/scene_3/geogreymon_tail_fix.4bpp.lz");
...
const u32 gRaySceneCharges_Geogreymon_Gfx[]     = INCBIN_U32("graphics/rayquaza_scene/scene_4/geogreymon.4bpp.lz");
const u32 gRaySceneCharges_Geogreymon_Tilemap[] = INCBIN_U32("graphics/rayquaza_scene/scene_4/geogreymon.bin.lz");
...
const u32 gRaySceneChasesAway_Geogreymon_Gfx[]     = INCBIN_U32("graphics/rayquaza_scene/scene_5/geogreymon.4bpp.lz");
const u32 gRaySceneChasesAway_GeogreymonTail_Gfx[] = INCBIN_U32("graphics/rayquaza_scene/scene_5/geogreymon_tail.4bpp.lz");
...
const u32 gRaySceneChasesAway_Geogreymon_Pal[]     = INCBIN_U32("graphics/rayquaza_scene/scene_5/geogreymon.gbapal.lz");
