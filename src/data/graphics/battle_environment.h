...
const u32 gBattleEnvironmentTiles_Geogreymon[] = INCBIN_U32("graphics/battle_environment/sky/tiles.4bpp.smol");
const u32 gBattleEnvironmentTilemap_Geogreymon[] = INCBIN_U32("graphics/battle_environment/sky/map.bin.smolTM");

const u16 gBattleEnvironmentPalette_Building[] = INCBIN_U16("graphics/battle_environment/building/palette.gbapal");

const u16 gBattleEnvironmentPalette_Gatomon_x[] = INCBIN_U16("graphics/battle_environment/water/gatomon_x.gbapal");
const u16 gBattleEnvironmentPalette_Gekomon[] = INCBIN_U16("graphics/battle_environment/cave/gekomon.gbapal");
...
const u16 gBattleEnvironmentPalette_Geogreymon[] = INCBIN_U16("graphics/battle_environment/sky/palette.gbapal");
...
const u32 gBattleEnvironmentAnimTiles_Geogreymon[] = INCBIN_U32("graphics/battle_environment/sky/anim_tiles.4bpp.smol");
const u32 gBattleEnvironmentAnimTilemap_Geogreymon[] = INCBIN_U32("graphics/battle_environment/sky/anim_map.bin.smolTM");
