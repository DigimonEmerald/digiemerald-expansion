...
const u32 gDecorIconPalette_CoronamonDoll[] = INCBIN_U32("graphics/decorations/coronamon_doll.gbapal.lz");

const u32 gDecorIcon_BommonDoll[] = INCBIN_U32("graphics/decorations/bommon_doll.4bpp.lz");
const u32 gDecorIconPalette_BommonDoll[] = INCBIN_U32("graphics/decorations/bommon_doll.gbapal.lz");

const u32 gDecorIcon_ChibomonDoll[] = INCBIN_U32("graphics/decorations/chibomon_doll.4bpp.lz");
const u32 gDecorIconPalette_ChibomonDoll[] = INCBIN_U32("graphics/decorations/chibomon_doll.gbapal.lz");

const u32 gDecorIcon_CurimonDoll[] = INCBIN_U32("graphics/decorations/curimon_doll.4bpp.lz");
const u32 gDecorIconPalette_CurimonDoll[] = INCBIN_U32("graphics/decorations/curimon_doll.gbapal.lz");

const u32 gDecorIcon_ChamblemonDoll[] = INCBIN_U32("graphics/decorations/chamblemon_doll.4bpp.lz");
const u32 gDecorIconPalette_ChamblemonDoll[] = INCBIN_U32("graphics/decorations/chamblemon_doll.gbapal.lz");

const u32 gDecorIcon_GargoylmonDoll[] = INCBIN_U32("graphics/decorations/gargoylmon_doll.4bpp.lz");
const u32 gDecorIconPalette_GargoylmonDoll[] = INCBIN_U32("graphics/decorations/gargoylmon_doll.gbapal.lz");
