...
const u16 gMetatiles_SnowMap[] = INCBIN_U16("data/tilesets/primary/snow_map/metatiles.bin");
const u16 gMetatileAttributes_SnowMap[] = INCBIN_U16("data/tilesets/primary/snow_map/metatile_attributes.bin");
