...
const u16 gEasyChatWordsByLetter_A[] = {
    ...
    EC_WORD_AFTER,
    EC_WORD_AGE,
    EC_POKEMON(BLGROWLMON),
    EC_MOVE(AGILITY),
    EC_WORD_AGREE,
    EC_WORD_AHAHA,
    EC_WORD_AIM,
    EC_POKEMON_NATIONAL(KOKABUIMON),
    EC_MOVE(AIR_CUTTER),
    EC_WORD_AIR_LOCK,
    EC_WORD_AIYEEH,
    DOUBLE_SPECIES_NAME
...
const u16 gEasyChatWordsByLetter_E[] = {
    ...
    EC_WORD_ENJOYS,
    EC_WORD_ENOUGH,
    EC_POKEMON_NATIONAL(YUKIAGUMON_06),
...
const u16 gEasyChatWordsByLetter_F[] = {
    ...
    EC_POKEMON_NATIONAL(DEMIDEVMON),
    EC_MOVE2(FLASH),
    EC_WORD_FLASH_FIRE,
    EC_WORD_FLATTEN,
    EC_MOVE(FLATTER),
...
const u16 gEasyChatWordsByLetter_G[] = {
    ...
    EC_WORD_GOLD,
    DOUBLE_SPECIES_NAME
    EC_POKEMON(BLKAGUMON_X),
    EC_POKEMON_NATIONAL(BLKAGUMON_X),
    DOUBLE_SPECIES_NAME
    EC_POKEMON(DEMMERAMON),
    EC_POKEMON_NATIONAL(DEMMERAMON),
    DOUBLE_SPECIES_NAME
    EC_POKEMON(MOTIMON),
    EC_POKEMON_NATIONAL(MOTIMON),
    EC_WORD_GOOD,
    EC_WORD_GOOD_BYE,
    EC_POKEMON(FLAWIZAMON),
    EC_WORD_GOT,
    EC_WORD_GOTCHA,
    EC_WORD_GOURMET,
    EC_WORD_GRAAAH,
    ...
    EC_WORD_GWAHAHAHA,
    DOUBLE_SPECIES_NAME
    EC_POKEMON(COMMDRAMON),
    EC_POKEMON_NATIONAL(COMMDRAMON),
};
...
const u16 gEasyChatWordsByLetter_H[] = {
    ...
    EC_WORD_HARD,
    EC_MOVE(HARDEN),
    EC_POKEMON(BIOQUETMON),
    EC_WORD_HAS,
    EC_WORD_HASSLE,
    EC_POKEMON_NATIONAL(TORBALLMON),
    EC_WORD_HAVE,
    EC_WORD_HAVEN_T,
    EC_MOVE(HAZE),
    EC_WORD_HE,
...
const u16 gEasyChatWordsByLetter_J[] = {
    ...
    EC_WORD_JUDGE,
    EC_MOVE2(JUMP_KICK),
    EC_POKEMON_NATIONAL(KODOKGUMON),
    EC_WORD_JUST,
    EC_POKEMON_NATIONAL(SAMUAGUMON),
};

const u16 gEasyChatWordsByLetter_K[] = {
    EC_POKEMON_NATIONAL(DOTAGUMON),
    EC_POKEMON_NATIONAL(DOTFALCMON),
    DOUBLE_SPECIES_NAME
...
const u16 gEasyChatWordsByLetter_M[] = {
    ...
    EC_WORD_MAGAZINE,
    EC_POKEMON_NATIONAL(BLKTOYAMON),
    DOUBLE_SPECIES_NAME
    ...
    DOUBLE_SPECIES_NAME
    EC_POKEMON(HAZYAGUMON),
    EC_POKEMON_NATIONAL(HAZYAGUMON),
    EC_WORD_MAGMA_ARMOR,
    ...
    EC_WORD_MAKE,
    EC_WORD_MAKING,
    EC_POKEMON(BETGAMAMON),
    EC_WORD_MAN,
    EC_POKEMON(BOMNANIMON),
...
const u16 gEasyChatWordsByLetter_O[] = {
    EC_WORD_OBLIVIOUS,
    EC_MOVE(OCTAZOOKA),
    EC_POKEMON_NATIONAL(PAWNMON_WHITE),
    DOUBLE_SPECIES_NAME
    EC_POKEMON(ZERIMON),
...
const u16 gEasyChatWordsByLetter_P[] = {
    ...
    DOUBLE_SPECIES_NAME
    EC_POKEMON(TYUTYUMON),
    EC_POKEMON_NATIONAL(TYUTYUMON),
    EC_WORD_PKRS,
    EC_WORD_PLACE,
    EC_WORD_PLANS,
    EC_WORD_PLAY,
    ...
    EC_MOVE(PSYWAVE),
    EC_POKEMON_NATIONAL(SOUNBRDMON),
    EC_WORD_PURE_POWER,
    EC_MOVE(PURSUIT),
    EC_WORD_PUSHOVER,
};
...
const u16 gEasyChatWordsByLetter_R[] = {
    ...
    EC_POKEMON_NATIONAL(YUKIAGUMON),
    EC_MOVE(RAIN_DANCE),
    EC_WORD_RAIN_DISH,
    EC_POKEMON(APEMON),
    EC_WORD_RANK,
    ...
    EC_WORD_REFRESHING,
    EC_WORD_REFUSE,
    EC_POKEMON(GARGOYLMON),
    EC_POKEMON(GARGOMON),
    EC_POKEMON(GARURUMON),
    EC_WORD_REJECT,
    EC_WORD_RELEASE,
    EC_POKEMON(FLARIZAMON),
    EC_POKEMON_NATIONAL(PAWNMON_BLACK),
    EC_WORD_RENTAL,
    EC_MOVE2(REST),
    EC_WORD_RESUSCITATE,
    EC_MOVE(RETURN),
...
const u16 gEasyChatWordsByLetter_S[] = {
    ...
    DOUBLE_SPECIES_NAME
    EC_POKEMON(BLKAGUMON),
    EC_POKEMON_NATIONAL(BLKAGUMON),
    DOUBLE_SPECIES_NAME
    EC_POKEMON(BLKGABUMON),
    EC_POKEMON_NATIONAL(BLKGABUMON),
    EC_POKEMON(FANGMON),
    EC_WORD_SEARCH,
    EC_WORD_SECRET,
    EC_WORD_SECRET_BASE,
    ...
    EC_WORD_START,
    DOUBLE_SPECIES_NAME
    EC_POKEMON(BLKGUILMON),
    EC_POKEMON_NATIONAL(BLKGUILMON),
    EC_WORD_STATIC,
    EC_WORD_STAY_AT_HOME,
    EC_WORD_STEEL,
    EC_MOVE2(STEEL_WING),
    EC_POKEMON_NATIONAL(KODEKACMON),
    EC_WORD_STENCH,
    EC_WORD_STICKY_HOLD,
    EC_MOVE2(STOCKPILE),
    EC_MOVE2(STOMP),
...
const u16 gEasyChatWordsByLetter_T[] = {
    ...
    EC_WORD_TRAVEL,
    EC_WORD_TREASURE,
    EC_POKEMON(SUNARZAMON),
    EC_WORD_TRENDY,
    EC_MOVE2(TRI_ATTACK),
    EC_MOVE2(TRICK),
    EC_WORD_TRIES,
    EC_MOVE2(TRIPLE_KICK),
    EC_POKEMON(ELEPHANMON),
    EC_WORD_TRUANT,
    EC_WORD_TRULY,
    EC_WORD_TRUMP_CARD,
    EC_WORD_TRUST,
...
const u16 gEasyChatWordsByLetter_W[] = {
    ...
    DOUBLE_SPECIES_NAME
    EC_POKEMON(ARMADILMON),
    EC_POKEMON_NATIONAL(ARMADILMON),
    EC_WORD_WEIRD,
    EC_WORD_WELCOME,
    EC_WORD_WELL,
    EC_WORD_WELL_THEN,
