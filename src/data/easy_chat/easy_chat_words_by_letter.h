...
const u16 gEasyChatWordsByLetter_A[] = {
    ...
    EC_MOVE2(AERIAL_ACE),
    EC_MOVE(AEROBLAST),
    EC_POKEMON_NATIONAL(DRACMON),
    EC_WORD_AFTER,
    EC_WORD_AGE,
    EC_POKEMON(BLACKGROWLMON),
    EC_MOVE(AGILITY),
    EC_WORD_AGREE,
    EC_WORD_AHAHA,
    EC_WORD_AIM,
    EC_POKEMON_NATIONAL(KOKABUTERIMON),
    EC_MOVE(AIR_CUTTER),
    EC_WORD_AIR_LOCK,
    EC_WORD_AIYEEH,
    DOUBLE_SPECIES_NAME
    EC_POKEMON(KAPURIMON),
    EC_POKEMON_NATIONAL(KAPURIMON),
    EC_WORD_ALL,
    EC_WORD_ALL_RIGHT,
    EC_WORD_ALLOW,
    EC_WORD_ALLOWANCE,
    ...
    EC_WORD_ALSO,
    EC_WORD_ALT_COLOR,
    EC_POKEMON(DARKMAILDRAMON),
    EC_WORD_ALTHOUGH,
    EC_WORD_ALWAYS,
    EC_WORD_AM,
    EC_MOVE2(AMNESIA),
    EC_POKEMON_NATIONAL(IMPMON),
    EC_WORD_AMUSING,
    EC_WORD_AN,
    ...
    EC_WORD_APPRECIATE,
    EC_WORD_APPROVED,
    EC_POKEMON_NATIONAL(PAOMON),
    EC_POKEMON_NATIONAL(GIGIMON),
    EC_WORD_ARE,
    EC_WORD_AREN_T,
    EC_WORD_ARENA_TRAP,
    EC_POKEMON_NATIONAL(GOMAMON_X),
    EC_MOVE2(ARM_THRUST),
    EC_POKEMON(DOBERMON_X),
    EC_MOVE(AROMATHERAPY),
    EC_POKEMON(BLACKGATOMON),
    EC_WORD_AROUND,
    EC_WORD_ARRGH,
    EC_POKEMON_NATIONAL(DRACOMON_X),
    EC_WORD_AS,
    EC_WORD_AS_IF,
    EC_WORD_AS_MUCH_AS,
    EC_MOVE2(ASSIST),
...
const u16 gEasyChatWordsByLetter_B[] = {
    ...
    DOUBLE_SPECIES_NAME
    EC_POKEMON(IMPMON_X),
    EC_POKEMON_NATIONAL(IMPMON_X),
    EC_POKEMON_NATIONAL(KYAROMON),
    EC_MOVE2(BELLY_DRUM),
    EC_WORD_BELONGS_TO,
    EC_WORD_BELOW,
    EC_WORD_BERRY,
    ...
    EC_MOVE(BITE),
    EC_MOVE2(BLAST_BURN),
    EC_POKEMON_NATIONAL(CURIMON),
    EC_WORD_BLAZE,
    EC_MOVE2(BLAZE_KICK),
    EC_POKEMON(TENTOMON),
    EC_WORD_BLEND,
    EC_POKEMON_NATIONAL(SHOUTMON),
    EC_MOVE2(BLIZZARD),
    EC_MOVE2(BLOCK),
    EC_WORD_BOARD,
    EC_MOVE2(BODY_SLAM),
    ...
    EC_WORD_BRAG,
    EC_WORD_BREAK,
    EC_POKEMON(ATAMADEKACHIMON),
    EC_MOVE(BRICK_BREAK),
    EC_WORD_BROTHER,
    EC_MOVE(BUBBLE),
    EC_MOVE2(BUBBLE_BEAM),
    EC_WORD_BUG,
    EC_POKEMON_NATIONAL(ARGOMON_F),
    EC_MOVE2(BULK_UP),
    EC_MOVE2(BULLET_SEED),
    EC_WORD_BUSY,
    EC_WORD_BUT,
    EC_POKEMON_NATIONAL(DOKIMON),
    EC_WORD_BYE_BYE,
};

const u16 gEasyChatWordsByLetter_C[] = {
    EC_POKEMON(DARCMON),
    EC_POKEMON(TRAILMON_DARK),
    EC_MOVE2(CALM_MIND),
    EC_WORD_CAME,
    EC_WORD_CAMERA,
    EC_POKEMON(CITRAMON),
    ...
    EC_WORD_CARE,
    EC_WORD_CARES,
    EC_POKEMON(BUTTERFLYMON),
    EC_POKEMON(WORMMON),
    EC_WORD_CASE,
    EC_POKEMON(DOLPHMON),
    EC_POKEMON_NATIONAL(DATIRIMON),
    EC_WORD_CAUSE,
    EC_POKEMON_NATIONAL(STRABIMON),
    EC_WORD_CENTER,
    EC_WORD_CHALLENGE,
    EC_WORD_CHANGE,
    EC_WORD_CHANNEL,
    EC_POKEMON_NATIONAL(BEARMON),
    EC_MOVE(CHARGE),
    EC_POKEMON_NATIONAL(CHIBOMON),
    EC_MOVE(CHARM),
    EC_POKEMON_NATIONAL(BOTAMON),
    EC_POKEMON_NATIONAL(CHIBICKMON),
    EC_WORD_CHAT,
    EC_POKEMON_NATIONAL(FALCOMON_06),
    EC_WORD_CHILD_S_PLAY,
    EC_WORD_CHILDREN,
    EC_POKEMON(EOSMON_CHAMPION),
    DOUBLE_SPECIES_NAME
    EC_POKEMON(GOTSUMON_X),
    EC_POKEMON_NATIONAL(GOTSUMON_X),
    EC_WORD_CHLOROPHYLL,
    EC_WORD_CHOICE,
    EC_WORD_CHOOSE,
    EC_WORD_CHORES,
    ...
    EC_POKEMON(FIRAMON),
    EC_WORD_CLASS,
    EC_POKEMON(DIATRYMON),
    EC_WORD_CLEAR_BODY,
    EC_POKEMON_NATIONAL(PYONMON),
    EC_POKEMON_NATIONAL(PUYOMON),
    EC_POKEMON_NATIONAL(GUMDRAMON),
    EC_WORD_CLOSE,
    EC_WORD_CLOUD_NINE,
    EC_POKEMON_NATIONAL(TOKOMON),
    EC_WORD_COLD,
    EC_WORD_COLLECT,
    EC_WORD_COLLECTION,
    EC_WORD_COLOR,
    ...
    EC_MOVE2(COVET),
    EC_MOVE(CRABHAMMER),
    EC_POKEMON(DINOHYUMON),
    EC_POKEMON(DEVIMON),
    EC_WORD_CRIES,
    DOUBLE_SPECIES_NAME
    EC_POKEMON(GOTSUMON),
    EC_POKEMON_NATIONAL(GOTSUMON),
    EC_POKEMON_NATIONAL(GAOMON),
    EC_MOVE(CROSS_CHOP),
    EC_MOVE(CRUNCH),
    EC_WORD_CRUSH,
    EC_MOVE2(CRUSH_CLAW),
    EC_WORD_CRY,
    EC_POKEMON_NATIONAL(AGUMON_06),
    EC_WORD_CURRENT,
    EC_MOVE2(CURSE),
    EC_MOVE(CUT),
    EC_WORD_CUTE,
...
const u16 gEasyChatWordsByLetter_D[] = {
    ...
    EC_POKEMON(BLACKGAOGAMON),
    EC_POKEMON_NATIONAL(PENGUINMON),
    EC_POKEMON(GESOMON),
    EC_WORD_DEPT_STORE,
    EC_WORD_DESIGN,
    EC_WORD_DESTINY,
    ...
    EC_WORD_DISLIKE,
    EC_WORD_DISLIKES,
    EC_POKEMON_NATIONAL(CRABMON),
    EC_MOVE2(DIVE),
    EC_MOVE2(DIZZY_PUNCH),
    EC_WORD_DO,
    EC_WORD_DOCILE,
    DOUBLE_SPECIES_NAME
    EC_POKEMON(PUROROMON),
    EC_POKEMON_NATIONAL(PUROROMON),
    DOUBLE_SPECIES_NAME
    EC_POKEMON(POROMON),
    EC_POKEMON_NATIONAL(POROMON),
    EC_WORD_DOES,
    EC_WORD_DOESN_T,
    EC_WORD_DON_T,
    EC_WORD_DONE,
    ...
    EC_POKEMON_NATIONAL(ELECMON_VIOLET),
    EC_MOVE2(DRAGON_BREATH),
    EC_POKEMON_NATIONAL(ESPIMON),
    EC_POKEMON_NATIONAL(ELECMON),
    EC_WORD_DREAM,
    ...
    EC_WORD_DROOLING,
    EC_WORD_DROUGHT,
    EC_POKEMON_NATIONAL(TUMBLEMON),
    EC_WORD_DUDE,
    EC_POKEMON_NATIONAL(BUKAMON),
    EC_POKEMON_NATIONAL(LUXMON),
    EC_POKEMON(EBIDRAMON),
    EC_POKEMON(DRIMOGEMON),
    EC_POKEMON(ZENIMON),
...
const u16 gEasyChatWordsByLetter_E[] = {
    ...
    EC_WORD_EATS,
    EC_WORD_EEK,
    EC_POKEMON_NATIONAL(CRABMON_X),
    EC_WORD_EFFECT_SPORE,
    EC_WORD_EGG,
    EC_MOVE2(EGG_BOMB),
    EC_WORD_EH_QUES,
    EC_WORD_EHEHE,
    EC_POKEMON_NATIONAL(PAFUMON),
    EC_POKEMON_NATIONAL(CANDLEMON),
    EC_WORD_ELECTRIC,
    EC_POKEMON(BOARMON),
    DOUBLE_SPECIES_NAME
    EC_POKEMON(YAAMON),
    EC_POKEMON_NATIONAL(YAAMON),
    EC_POKEMON_NATIONAL(SANTAAGUMON),
    EC_WORD_ELSE,
    EC_MOVE2(EMBER),
    EC_WORD_EMERALD,
    EC_MOVE(ENCORE),
    ...
    EC_WORD_ENJOYS,
    EC_WORD_ENOUGH,
    EC_POKEMON_NATIONAL(SNOWAGUMON_06),
    EC_WORD_ENTERTAINING,
    EC_MOVE2(ERUPTION),
    EC_WORD_ESCAPE,
    EC_POKEMON_NATIONAL(KUNEMON),
    EC_WORD_EVEN_SO,
    EC_WORD_EVENT,
    EC_WORD_EVENTS,
    EC_WORD_EVER,
    ...
    EC_WORD_EXCUSE,
    EC_WORD_EXCUSE_ME,
    EC_POKEMON_NATIONAL(YOKOMON),
    EC_POKEMON_NATIONAL(AGUMON),
    EC_WORD_EXISTS,
    EC_WORD_EXPENSIVE,
    EC_MOVE2(EXPLOSION),
    EC_POKEMON(TRAILMON_BATTLE_ARMAMENT),
...
const u16 gEasyChatWordsByLetter_F[] = {
    ...
    EC_WORD_FISHING,
    EC_MOVE(FISSURE),
    EC_POKEMON_NATIONAL(IGNITEMON),
    EC_MOVE(FLAIL),
    EC_WORD_FLAME,
    EC_WORD_FLAME_BODY,
    EC_MOVE(FLAME_WHEEL),
    EC_MOVE(FLAMETHROWER),
    EC_POKEMON_NATIONAL(DEMIDEVIMON),
    EC_MOVE2(FLASH),
    EC_WORD_FLASH_FIRE,
    EC_WORD_FLATTEN,
    EC_MOVE(FLATTER),
...
const u16 gEasyChatWordsByLetter_G[] = {
    ...
    EC_POKEMON(EYESMON),
    EC_MOVE2(GLARE),
    EC_POKEMON_NATIONAL(METABEE),
    DOUBLE_SPECIES_NAME
    EC_POKEMON(ZURUMON),
    EC_POKEMON_NATIONAL(ZURUMON),
    EC_WORD_GO,
    EC_WORD_GO_AHEAD,
    EC_WORD_GO_EASY,
    EC_WORD_GO_HOME,
    ...
    DOUBLE_SPECIES_NAME
    EC_POKEMON(YURAMON),
    EC_POKEMON_NATIONAL(YURAMON),
    EC_WORD_GOLD,
    DOUBLE_SPECIES_NAME
    EC_POKEMON(BLACKAGUMON_X),
    EC_POKEMON_NATIONAL(BLACKAGUMON_X),
    DOUBLE_SPECIES_NAME
    EC_POKEMON(DEMIMERAMON),
    EC_POKEMON_NATIONAL(DEMIMERAMON),
    DOUBLE_SPECIES_NAME
    EC_POKEMON(MOTIMON),
    EC_POKEMON_NATIONAL(MOTIMON),
    EC_WORD_GOOD,
    EC_WORD_GOOD_BYE,
    EC_POKEMON(FLAMEWIZARDMON),
    EC_WORD_GOT,
    EC_WORD_GOTCHA,
    EC_WORD_GOURMET,
    EC_WORD_GRAAAH,
    EC_POKEMON_NATIONAL(MONITAMON),
    EC_WORD_GRANDFATHER,
    EC_WORD_GRANDMOTHER,
    EC_WORD_GRASS,
    ...
    DOUBLE_SPECIES_NAME
    EC_POKEMON(MOONMON),
    EC_POKEMON_NATIONAL(MOONMON),
    EC_WORD_GREAT,
    EC_WORD_GREEN,
    DOUBLE_SPECIES_NAME
    EC_POKEMON(SAKUTTOMON),
    EC_POKEMON_NATIONAL(SAKUTTOMON),
    EC_POKEMON(GEKOMON),
    EC_WORD_GROUND,
    EC_WORD_GROUP,
    EC_POKEMON(SWIMMON),
    EC_MOVE2(GROWL),
    EC_POKEMON_NATIONAL(FRIMON),
    EC_MOVE(GROWTH),
    EC_MOVE(GRUDGE),
    EC_POKEMON(COELAMON),
    EC_WORD_GUARD,
    ...
    EC_WORD_GWAHAHAHA,
    DOUBLE_SPECIES_NAME
    EC_POKEMON(COMMANDRAMON),
    EC_POKEMON_NATIONAL(COMMANDRAMON),
};
...
const u16 gEasyChatWordsByLetter_H[] = {
    ...
    EC_WORD_HARD,
    EC_MOVE(HARDEN),
    EC_POKEMON(BIOQUETZALMON),
    EC_WORD_HAS,
    EC_WORD_HASSLE,
    EC_POKEMON_NATIONAL(TORIKARABALLMON),
    EC_WORD_HAVE,
    EC_WORD_HAVEN_T,
    EC_MOVE(HAZE),
    EC_WORD_HE,
    ...
    EC_WORD_HIS,
    EC_WORD_HIT,
    EC_POKEMON_NATIONAL(ANGORAMON),
    EC_POKEMON_NATIONAL(AGUMON_X),
    ...
    EC_WORD_HOPELESS,
    EC_POKEMON_NATIONAL(KERAMON),
    EC_MOVE2(HORN_ATTACK),
    EC_MOVE2(HORN_DRILL),
    DOUBLE_SPECIES_NAME
    EC_POKEMON(BIYOMON),
    EC_POKEMON_NATIONAL(BIYOMON),
    EC_WORD_HOT,
    EC_POKEMON_NATIONAL(POMUMON),
    EC_POKEMON_NATIONAL(PILLOMON),
    EC_WORD_HOW,
    EC_WORD_HOW_DO,
    EC_WORD_HOWEVER,
    EC_MOVE2(HOWL),
...
const u16 gEasyChatWordsByLetter_J[] = {
    DOUBLE_SPECIES_NAME
    EC_POKEMON(SANDMON),
    EC_POKEMON_NATIONAL(SANDMON),
    EC_POKEMON(GEREMON),
    EC_WORD_JOKING,
    EC_POKEMON_NATIONAL(DAMEMON),
    EC_WORD_JOY,
    EC_WORD_JUDGE,
    EC_MOVE2(JUMP_KICK),
    EC_POKEMON_NATIONAL(KODOKUGUMON),
    EC_WORD_JUST,
    EC_POKEMON_NATIONAL(BUSHIAGUMON),
};

const u16 gEasyChatWordsByLetter_K[] = {
    EC_POKEMON_NATIONAL(DOTAGUMON),
    EC_POKEMON_NATIONAL(DOTFALCOMON),
    DOUBLE_SPECIES_NAME
    EC_POKEMON(KAKKINMON),
    EC_POKEMON_NATIONAL(KAKKINMON),
    EC_POKEMON_NATIONAL(JYARIMON),
    EC_POKEMON_NATIONAL(BETAMON_X),
    EC_MOVE(KARATE_CHOP),
    EC_POKEMON(DONSHOUTMON),
    EC_WORD_KEEN_EYE,
    EC_WORD_KID,
    EC_WORD_KIDDING,
    EC_WORD_KIND,
    ...
    EC_MOVE(KINESIS),
    DOUBLE_SPECIES_NAME
    EC_POKEMON(PSYCHEMON),
    EC_POKEMON_NATIONAL(PSYCHEMON),
    EC_POKEMON_NATIONAL(WANYAMON),
    EC_POKEMON(AQUILAMON),
    EC_MOVE2(KNOCK_OFF),
    EC_WORD_KNOCKOUT,
    EC_WORD_KNOW,
    EC_WORD_KNOWS,
    DOUBLE_SPECIES_NAME
    EC_POKEMON(ARGOMON_ROOKIE),
...
const u16 gEasyChatWordsByLetter_L[] = {
    ...
    EC_WORD_LACKS,
    EC_WORD_LADY,
    EC_POKEMON(BLACKGATOMON_UVER),
    EC_WORD_LALALA,
    DOUBLE_SPECIES_NAME
    EC_POKEMON(GUILMON),
    EC_POKEMON_NATIONAL(GUILMON),
    EC_POKEMON_NATIONAL(CORONAMON),
    EC_POKEMON_NATIONAL(SOLARMON),
    EC_WORD_LAST,
    EC_WORD_LATE,
    EC_WORD_LATER,
    EC_POKEMON(GARURUMON_X),
    EC_POKEMON(GATOMON),
    EC_WORD_LAVISH,
    EC_WORD_LAY,
    EC_WORD_LEADER,
    ...
    EC_MOVE2(LEAF_BLADE),
    EC_WORD_LEARN,
    EC_POKEMON_NATIONAL(GOBLIMON),
    EC_POKEMON_NATIONAL(GIZUMON),
    EC_MOVE(LEECH_LIFE),
    EC_MOVE2(LEECH_SEED),
    EC_MOVE2(LEER),
    EC_WORD_LEFT,
    ...
    EC_WORD_LEVITATE,
    EC_MOVE(LICK),
    EC_POKEMON_NATIONAL(ARCADIAMON_ROOKIE),
    EC_WORD_LIE,
    EC_WORD_LIFE,
    ...
    EC_WORD_LUKEWARM,
    EC_POKEMON(DECKERDRAMON),
    EC_MOVE2(LUSTER_PURGE),
    EC_POKEMON(FLYBEEMON),
};

const u16 gEasyChatWordsByLetter_M[] = {
    EC_MOVE2(MACH_PUNCH),
    DOUBLE_SPECIES_NAME
    EC_POKEMON(KOZENIMON),
    EC_POKEMON_NATIONAL(KOZENIMON),
    EC_WORD_MACHINE,
    DOUBLE_SPECIES_NAME
    EC_POKEMON(KOROMON),
    EC_POKEMON_NATIONAL(KOROMON),
    DOUBLE_SPECIES_NAME
    EC_POKEMON(KOKOMON),
    EC_POKEMON_NATIONAL(KOKOMON),
    EC_WORD_MAGAZINE,
    EC_POKEMON_NATIONAL(SHADOWTOYAGUMON),
    DOUBLE_SPECIES_NAME
    EC_POKEMON(OTAMAMON_X),
    EC_POKEMON_NATIONAL(OTAMAMON_X),
    EC_MOVE2(MAGIC_COAT),
    EC_MOVE2(MAGICAL_LEAF),
    DOUBLE_SPECIES_NAME
    EC_POKEMON(CLEARAGUMON),
    EC_POKEMON_NATIONAL(CLEARAGUMON),
    EC_WORD_MAGMA_ARMOR,
    EC_POKEMON_NATIONAL(CHIKURIMON),
    DOUBLE_SPECIES_NAME
    EC_POKEMON(PICKMON_WHITE),
    EC_POKEMON_NATIONAL(PICKMON_WHITE),
    EC_WORD_MAGNET_PULL,
    DOUBLE_SPECIES_NAME
    EC_POKEMON(PICKMON_RED),
    EC_POKEMON_NATIONAL(PICKMON_RED),
    EC_MOVE2(MAGNITUDE),
    EC_WORD_MAIL,
    EC_WORD_MAKE,
    EC_WORD_MAKING,
    EC_POKEMON(BETELGAMMAMON),
    EC_WORD_MAN,
    EC_POKEMON(BOMBERNANIMON),
    EC_POKEMON_NATIONAL(DEMIVEEMON),
    EC_POKEMON_NATIONAL(PETITMAMON),
    EC_POKEMON_NATIONAL(HYOKOMON),
    DOUBLE_SPECIES_NAME
    EC_POKEMON(JAZAMON),
    EC_POKEMON_NATIONAL(JAZAMON),
    EC_POKEMON_NATIONAL(AGUMON_EXPERT),
    EC_POKEMON(TERRIERMON_ASSISTANT),
    EC_WORD_MARVEL_SCALE,
    EC_POKEMON(ARGOMON_CHAMPION),
    EC_WORD_MASTER,
    EC_WORD_MATCH,
    EC_WORD_MATCH_UP,
    EC_POKEMON(GARURUMON_BLACK),
    EC_WORD_MAYBE,
    EC_WORD_MC,
    EC_WORD_ME,
    EC_WORD_MEAN,
    ...
    EC_MOVE(METAL_SOUND),
    EC_POKEMON(GANEMON),
    EC_POKEMON_NATIONAL(DODOMON),
    EC_MOVE(METEOR_MASH),
    EC_MOVE2(METRONOME),
    EC_POKEMON_NATIONAL(FALCOMON),
    EC_POKEMON_NATIONAL(AGUMON_FAKE_EXPERT),
    EC_POKEMON(TINPET),
    EC_MOVE2(MILK_DRINK),
    EC_POKEMON(DOKUGUMON),
    EC_POKEMON_NATIONAL(SHAMANMON),
    EC_MOVE2(MIMIC),
    EC_MOVE(MIND_READER),
    EC_MOVE2(MINIMIZE),
    EC_POKEMON(BUCCHIEMON_RED),
    EC_WORD_MINUS,
    ...
    EC_POKEMON(TERRIERMON),
    EC_WORD_MUFUFU,
    DOUBLE_SPECIES_NAME
    EC_POKEMON(SUNMON),
    EC_POKEMON_NATIONAL(SUNMON),
    EC_POKEMON_NATIONAL(LALAMON),
    EC_WORD_MUSIC,
    EC_WORD_MUST_BE,
    EC_WORD_MY,
    EC_WORD_MYSELF,
...
const u16 gEasyChatWordsByLetter_N[] = {
    ...
    EC_WORD_NEXT,
    EC_WORD_NICE,
    EC_POKEMON_NATIONAL(PUWAMON),
    EC_POKEMON_NATIONAL(PURURUMON),
    EC_POKEMON_NATIONAL(PUNIMON),
    EC_POKEMON_NATIONAL(PUSUMON),
    EC_POKEMON_NATIONAL(PUPUMON),
    EC_POKEMON_NATIONAL(PUTTIMON),
    EC_WORD_NIGHT,
    ...
    DOUBLE_SPECIES_NAME
    EC_POKEMON(SAKUMON),
    EC_POKEMON_NATIONAL(SAKUMON),
    EC_POKEMON(BALLISTAMON),
    EC_WORD_NITWIT,
    EC_WORD_NO,
    EC_WORD_NO_MATCH,
    EC_WORD_NO_1,
    EC_POKEMON_NATIONAL(GIZAMON),
    EC_WORD_NOISY,
    EC_WORD_NON_STOP,
    EC_WORD_NONE,
    EC_WORD_NOPE,
    EC_WORD_NORMAL,
    EC_POKEMON(BIOTHUNDERBIRDMON),
    EC_WORD_NOT,
    EC_WORD_NOT_VERY,
    EC_WORD_NOTHING,
    EC_WORD_NOW,
    EC_POKEMON(CHRYSALIMON),
...
const u16 gEasyChatWordsByLetter_O[] = {
    EC_WORD_OBLIVIOUS,
    EC_MOVE(OCTAZOOKA),
    EC_POKEMON_NATIONAL(PAWNCHESSMON_WHITE),
    DOUBLE_SPECIES_NAME
    EC_POKEMON(ZERIMON),
    EC_POKEMON_NATIONAL(ZERIMON),
    EC_MOVE(ODOR_SLEUTH),
    EC_WORD_OF,
    EC_WORD_OFF,
    EC_WORD_OFFENSIVE,
    ...
    EC_WORD_OLD,
    EC_WORD_OLDEN,
    EC_POKEMON_NATIONAL(DONDOKOMON),
    EC_POKEMON_NATIONAL(DORUMON),
    EC_WORD_ON,
    EC_WORD_ONCE,
    EC_POKEMON_NATIONAL(TSUNOMON),
    EC_WORD_ONLY,
    EC_WORD_OOPS,
    EC_WORD_OPPONENT,
    EC_WORD_OPPOSITE,
...
const u16 gEasyChatWordsByLetter_P[] = {
    ...
    EC_WORD_PC,
    EC_MOVE2(PECK),
    EC_POKEMON(ANKYLOMON),
    EC_WORD_PERFECT,
    EC_WORD_PERFECTION,
    EC_MOVE2(PERISH_SONG),
    EC_POKEMON_NATIONAL(CHAPMON),
    EC_WORD_PERSON,
    EC_MOVE2(PETAL_DANCE),
    DOUBLE_SPECIES_NAME
    EC_POKEMON(PULSEMON),
    EC_POKEMON_NATIONAL(PULSEMON),
    EC_WORD_PHONE,
    DOUBLE_SPECIES_NAME
    EC_POKEMON(GUILMON_X),
    EC_POKEMON_NATIONAL(GUILMON_X),
    EC_WORD_PICKUP,
    EC_POKEMON_NATIONAL(LEAFMON),
    EC_POKEMON_NATIONAL(KURAMON),
    EC_POKEMON_NATIONAL(KETOMON),
    DOUBLE_SPECIES_NAME
    EC_POKEMON(PETITMON),
    EC_POKEMON_NATIONAL(PETITMON),
    EC_POKEMON_NATIONAL(PALMON_X),
    EC_MOVE2(PIN_MISSILE),
    EC_POKEMON_NATIONAL(LUDOMON),
    DOUBLE_SPECIES_NAME
    EC_POKEMON(CHUUCHUUMON),
    EC_POKEMON_NATIONAL(CHUUCHUUMON),
    EC_WORD_PKRS,
    EC_WORD_PLACE,
    EC_WORD_PLANS,
    EC_WORD_PLAY,
    ...
    EC_WORD_POKEMON,
    EC_WORD_POKENAV,
    EC_POKEMON_NATIONAL(KAMEMON),
    EC_POKEMON_NATIONAL(GUMMYMON),
    EC_POKEMON_NATIONAL(GURIMON),
    EC_POKEMON_NATIONAL(HIYARIMON),
    EC_POKEMON_NATIONAL(NEGAMON),
    EC_POKEMON(TINKERMON),
    EC_WORD_POPULAR,
    EC_POKEMON_NATIONAL(DOKUNEMON),
    EC_POKEMON_NATIONAL(RENAMON_X),
    EC_MOVE2(POUND),
    EC_MOVE(POWDER_SNOW),
    EC_WORD_POWER,
    EC_WORD_PRAISE,
    ...
    DOUBLE_SPECIES_NAME
    EC_POKEMON(CHICCHIMON),
    EC_POKEMON_NATIONAL(CHICCHIMON),
    EC_MOVE(PSYWAVE),
    EC_POKEMON_NATIONAL(SOUNDBIRDMON),
    EC_WORD_PURE_POWER,
    EC_MOVE(PURSUIT),
    EC_WORD_PUSHOVER,
};
...
const u16 gEasyChatWordsByLetter_R[] = {
    ...
    DOUBLE_SPECIES_NAME
    EC_POKEMON(PICHIMON),
    EC_POKEMON_NATIONAL(PICHIMON),
    EC_POKEMON_NATIONAL(SNOWAGUMON),
    EC_MOVE(RAIN_DANCE),
    EC_WORD_RAIN_DISH,
    EC_POKEMON(APEMON),
    EC_WORD_RANK,
    EC_MOVE(RAPID_SPIN),
    EC_POKEMON_NATIONAL(NYAROMON),
    EC_WORD_RARE,
    EC_WORD_RATHER,
    EC_POKEMON_NATIONAL(MOKUMON),
    EC_POKEMON_NATIONAL(METALKOROMON),
    EC_POKEMON(GEOGREYMON),
    EC_MOVE2(RAZOR_LEAF),
    EC_MOVE(RAZOR_WIND),
    EC_WORD_READY,
    EC_WORD_REALLY,
    ...
    EC_WORD_REFRESHING,
    EC_WORD_REFUSE,
    EC_POKEMON(GARGOYLEMON),
    EC_POKEMON(GARGOMON),
    EC_POKEMON(GARURUMON),
    EC_WORD_REJECT,
    EC_WORD_RELEASE,
    EC_POKEMON(FLARERIZAMON),
    EC_POKEMON_NATIONAL(PAWNCHESSMON_BLACK),
    EC_WORD_RENTAL,
    EC_MOVE2(REST),
    EC_WORD_RESUSCITATE,
    EC_MOVE(RETURN),
    ...
    DOUBLE_SPECIES_NAME
    EC_POKEMON(BAKOMON),
    EC_POKEMON_NATIONAL(BAKOMON),
    DOUBLE_SPECIES_NAME
    EC_POKEMON(ARURAUMON),
    EC_POKEMON_NATIONAL(ARURAUMON),
    EC_WORD_RIBBON,
    EC_WORD_RICKETY,
    EC_WORD_RIGHT,
    EC_WORD_RIPPED,
...
const u16 gEasyChatWordsByLetter_S[] = {
    ...
    DOUBLE_SPECIES_NAME
    EC_POKEMON(POPOMON),
    EC_POKEMON_NATIONAL(POPOMON),
    DOUBLE_SPECIES_NAME
    EC_POKEMON(POYOMON),
    EC_POKEMON_NATIONAL(POYOMON),
    EC_MOVE(SANDSTORM),
    EC_WORD_SAPPHIRE,
    EC_WORD_SATISFIED,
    EC_WORD_SATURDAY,
    ...
    EC_POKEMON(SYAKOMON),
    EC_WORD_SCHOOL,
    EC_POKEMON_NATIONAL(MONODRAMON),
    EC_MOVE2(SCRATCH),
    EC_MOVE(SCREECH),
    EC_POKEMON_NATIONAL(BURGERMON),
    DOUBLE_SPECIES_NAME
    EC_POKEMON(BLACKAGUMON),
    EC_POKEMON_NATIONAL(BLACKAGUMON),
    DOUBLE_SPECIES_NAME
    EC_POKEMON(BLACKGABUMON),
    EC_POKEMON_NATIONAL(BLACKGABUMON),
    EC_POKEMON(FANGMON),
    EC_WORD_SEARCH,
    EC_WORD_SECRET,
    EC_WORD_SECRET_BASE,
    ...
    EC_WORD_SEE,
    EC_WORD_SEE_YA,
    EC_POKEMON(AIRDRAMON),
    EC_WORD_SEEK,
    EC_POKEMON_NATIONAL(PUSURIMON),
    EC_WORD_SEEMS,
    EC_WORD_SEES,
    EC_MOVE2(SEISMIC_TOSS),
    EC_MOVE(SELF_DESTRUCT),
    EC_WORD_SENSE,
    EC_POKEMON_NATIONAL(GAZIMON),
    EC_WORD_SERENE_GRACE,
    EC_WORD_SERIOUS,
    EC_WORD_SERIOUSLY,
    EC_WORD_SERVICE,
    EC_POKEMON(DARKTYRANNOMON_X),
    EC_MOVE(SHADOW_BALL),
    ...
    EC_WORD_SHAKY,
    EC_WORD_SHALLOW,
    EC_POKEMON(CENTARUMON),
    EC_MOVE(SHARPEN),
    EC_WORD_SHE,
    EC_WORD_SHE_IS,
    EC_WORD_SHE_WAS,
    EC_WORD_SHED_SKIN,
    EC_POKEMON(BALUCHIMON),
    EC_MOVE(SHEER_COLD),
    EC_POKEMON(FRIGIMON),
    EC_WORD_SHELL_ARMOR,
    EC_POKEMON_NATIONAL(TANEMON),
    EC_WORD_SHIELD_DUST,
    EC_POKEMON(ALLOMON),
    EC_WORD_SHINE,
    EC_MOVE2(SHOCK_WAVE),
    ...
    EC_WORD_SHOW,
    EC_WORD_SHREDDED,
    EC_POKEMON(ARRESTERDRAMON),
    EC_POKEMON_NATIONAL(MORPHOMON),
    EC_POKEMON(DORUGAMON),
    EC_WORD_SIBLINGS,
    EC_WORD_SIGH,
    EC_MOVE(SIGNAL_BEAM),
    EC_POKEMON(VEMMON),
    ...
    EC_WORD_SISTER,
    DOUBLE_SPECIES_NAME
    EC_POKEMON(PHASCOMON),
    EC_POKEMON_NATIONAL(PHASCOMON),
    EC_MOVE(SKETCH),
    EC_WORD_SKILL,
    EC_MOVE(SKILL_SWAP),
    EC_WORD_SKILLED,
    EC_POKEMON_NATIONAL(KERAMON_X),
    EC_POKEMON(BIRDRAMON),
    EC_MOVE2(SKULL_BASH),
    EC_MOVE(SKY_ATTACK),
    EC_MOVE(SKY_UPPERCUT),
    EC_MOVE2(SLACK_OFF),
    EC_POKEMON(BABOONGAMON),
    EC_POKEMON(AURUMON),
    EC_MOVE2(SLAM),
    EC_MOVE(SLASH),
    EC_WORD_SLEEP,
    ...
    EC_WORD_SLIDE,
    EC_WORD_SLIMY,
    EC_POKEMON_NATIONAL(PICKMON_SILVER),
    EC_POKEMON_NATIONAL(LIOLLMON),
    EC_POKEMON_NATIONAL(PAGUMON),
    EC_MOVE2(SLUDGE),
    EC_MOVE2(SLUDGE_BOMB),
    DOUBLE_SPECIES_NAME
    EC_POKEMON(OTAMAMON_RED),
    EC_POKEMON_NATIONAL(OTAMAMON_RED),
    EC_WORD_SMACK,
    EC_WORD_SMALL,
    EC_WORD_SMART,
    EC_WORD_SMARTNESS,
    EC_POKEMON_NATIONAL(RYUDAMON),
    EC_WORD_SMELL,
    EC_WORD_SMELL_YA,
    ...
    EC_MOVE(SMOG),
    EC_MOVE(SMOKESCREEN),
    EC_POKEMON_NATIONAL(SANGOMON),
    EC_WORD_SMOOTH,
    EC_MOVE2(SNATCH),
    EC_POKEMON_NATIONAL(MUSHROOMON),
    EC_MOVE(SNORE),
    EC_POKEMON_NATIONAL(DRACOMON),
    EC_WORD_SNORT,
    EC_POKEMON(EXVEEMON_VIRUS),
    EC_POKEMON_NATIONAL(MODOKIBETAMON),
    EC_WORD_SO,
    ...
    EC_WORD_SP_ABILITY,
    EC_MOVE(SPARK),
    EC_POKEMON_NATIONAL(NYOKIMON),
    EC_WORD_SPECTATOR,
    EC_WORD_SPEED_BOOST,
    EC_POKEMON(EYESMON_SCATTERMODE),
    EC_MOVE(SPIDER_WEB),
    EC_MOVE2(SPIKE_CANNON),
    EC_MOVE2(SPIKES),
    EC_POKEMON_NATIONAL(GOMAMON),
    EC_POKEMON(COREDRAMON_BLUE),
    EC_WORD_SPIRALING,
    EC_WORD_SPIRIT,
    EC_MOVE2(SPIT_UP),
    EC_MOVE(SPITE),
    EC_MOVE2(SPLASH),
    EC_POKEMON(CLOCKMON_FUSION),
    EC_MOVE(SPORE),
    EC_WORD_SPORTS,
    EC_WORD_SPRING,
    EC_POKEMON_NATIONAL(CONOMON),
    EC_WORD_STAGE,
    EC_POKEMON_NATIONAL(ROKUSHO),
    DOUBLE_SPECIES_NAME
    EC_POKEMON(BOKOMON),
    EC_POKEMON_NATIONAL(BOKOMON),
    EC_WORD_START,
    DOUBLE_SPECIES_NAME
    EC_POKEMON(BLACKGUILMON),
    EC_POKEMON_NATIONAL(BLACKGUILMON),
    EC_WORD_STATIC,
    EC_WORD_STAY_AT_HOME,
    EC_WORD_STEEL,
    EC_MOVE2(STEEL_WING),
    EC_POKEMON_NATIONAL(MINIDEKACHIMON),
    EC_WORD_STENCH,
    EC_WORD_STICKY_HOLD,
    EC_MOVE2(STOCKPILE),
    EC_MOVE2(STOMP),
    ...
    EC_POKEMON_NATIONAL(JUNKMON),
    EC_POKEMON_NATIONAL(SNOWGOBLIMON),
    EC_WORD_SUMMER,
    EC_WORD_SUNDAY,
    EC_POKEMON_NATIONAL(KOKUWAMON_X),
    EC_POKEMON_NATIONAL(KOKUWAMON),
    EC_MOVE2(SUNNY_DAY),
    EC_WORD_SUPER,
    EC_MOVE(SUPER_FANG),
    EC_MOVE2(SUPERPOWER),
    ...
    EC_WORD_SURPRISE,
    EC_WORD_SURRENDER,
    EC_POKEMON(ARCHELOMON),
    EC_POKEMON(DARKLIZARDMON),
    EC_MOVE(SWAGGER),
    EC_MOVE2(SWALLOW),
    EC_POKEMON(BURGERMON_CHAMPION),
    EC_POKEMON(TERRIERMON_X),
    EC_WORD_SWARM,
    EC_MOVE2(SWEET_KISS),
    EC_MOVE(SWEET_SCENT),
    EC_WORD_SWEETS,
    EC_POKEMON(ANGELAMON),
    EC_MOVE(SWIFT),
    EC_WORD_SWIFT_SWIM,
    EC_POKEMON_NATIONAL(PALMON),
...
const u16 gEasyChatWordsByLetter_T[] = {
    ...
    EC_WORD_TASTY,
    EC_MOVE2(TAUNT),
    EC_POKEMON_NATIONAL(CHUUMON),
    EC_WORD_TCH,
    EC_WORD_TEACH,
    EC_WORD_TEACHER,
    EC_WORD_TEACHES,
    EC_POKEMON_NATIONAL(NEEMON),
    EC_MOVE2(TEETER_DANCE),
    EC_MOVE2(TELEPORT),
    EC_WORD_TELEVISION,
    DOUBLE_SPECIES_NAME
    EC_POKEMON(MINOMON),
    EC_POKEMON_NATIONAL(MINOMON),
    DOUBLE_SPECIES_NAME
    EC_POKEMON(MISSIMON),
    EC_POKEMON_NATIONAL(MISSIMON),
    EC_WORD_TERRIBLE,
    EC_WORD_TEST,
    EC_WORD_THAN,
    EC_WORD_THANK_YOU,
    ...
    EC_WORD_TO_WHOM,
    EC_WORD_TODAY,
    EC_POKEMON_NATIONAL(HAGURUMON),
    EC_WORD_TOGETHER,
    EC_POKEMON_NATIONAL(HAGURUMON_X),
    EC_WORD_TOMORROW,
    EC_WORD_TOO,
    EC_WORD_TOO_LATE,
    EC_WORD_TOO_STRONG,
    EC_WORD_TOO_WEAK,
    EC_WORD_TOP,
    EC_POKEMON(SYAKOMON_X),
    EC_POKEMON(CLOCKMON),
    EC_MOVE(TORMENT),
    EC_WORD_TORRENT,
    EC_WORD_TOTALLY,
    EC_POKEMON_NATIONAL(GAMMAMON),
    EC_WORD_TOUGH,
    EC_WORD_TOUGHNESS,
    EC_WORD_TOURNAMENT,
    EC_WORD_TOWER,
    ...
    EC_WORD_TRAINS,
    EC_MOVE2(TRANSFORM),
    EC_POKEMON(COREDRAMON_GREEN),
    EC_WORD_TRAVEL,
    EC_WORD_TREASURE,
    EC_POKEMON(SUNARIZAMON),
    EC_WORD_TRENDY,
    EC_MOVE2(TRI_ATTACK),
    EC_MOVE2(TRICK),
    EC_WORD_TRIES,
    EC_MOVE2(TRIPLE_KICK),
    EC_POKEMON(ELEPHANTMON),
    EC_WORD_TRUANT,
    EC_WORD_TRULY,
    EC_WORD_TRUMP_CARD,
    EC_WORD_TRUST,
...
const u16 gEasyChatWordsByLetter_V[] = {
    EC_WORD_VACATION,
    EC_POKEMON_NATIONAL(CUTEMON),
    EC_POKEMON_NATIONAL(BOSAMON),
    EC_POKEMON_NATIONAL(BIBIMON),
    EC_POKEMON_NATIONAL(BOMMON),
    EC_WORD_VERSION,
    EC_WORD_VERSUS,
    EC_WORD_VERY,
    EC_POKEMON(CYCLONEMON),
    EC_MOVE2(VISE_GRIP),
    EC_WORD_VICTORY,
    EC_POKEMON_NATIONAL(KYUPIMON),
    EC_WORD_VIEWING,
    EC_POKEMON(DEADLYAXEMON),
    DOUBLE_SPECIES_NAME
    EC_POKEMON(ARCADIAMON_IT),
    EC_POKEMON_NATIONAL(ARCADIAMON_IT),
    EC_MOVE2(VINE_WHIP),
...
const u16 gEasyChatWordsByLetter_W[] = {
    ...
    EC_WORD_WANT,
    EC_WORD_WANTS,
    EC_POKEMON_NATIONAL(COTSUCOMON),
    EC_WORD_WAS,
    EC_WORD_WASN_T,
    EC_WORD_WATER,
    ...
    EC_WORD_WEDNESDAY,
    EC_POKEMON_NATIONAL(FUFUMON),
    EC_WORD_WEEK,
    EC_POKEMON_NATIONAL(KYOKYOMON),
    DOUBLE_SPECIES_NAME
    EC_POKEMON(ARMADILLOMON),
    EC_POKEMON_NATIONAL(ARMADILLOMON),
    EC_WORD_WEIRD,
    EC_WORD_WELCOME,
    EC_WORD_WELL,
    EC_WORD_WELL_THEN,
    ...
    EC_MOVE(WHIRLPOOL),
    EC_MOVE2(WHIRLWIND),
    EC_POKEMON(DEPUTYMON),
    EC_POKEMON(BAOHUCKMON),
    EC_WORD_WHITE_SMOKE,
    EC_WORD_WHO,
    EC_WORD_WHO_IS,
    EC_WORD_WHO_WAS,
    ...
    DOUBLE_SPECIES_NAME
    EC_POKEMON(LOPMONX),
    EC_POKEMON_NATIONAL(LOPMONX),
    EC_WORD_WOMAN,
    EC_WORD_WON,
    EC_WORD_WON_T,
    EC_WORD_WONDER,
    EC_WORD_WONDER_GUARD,
    EC_POKEMON_NATIONAL(KUDAMON),
    EC_WORD_WORD,
    EC_WORD_WORK,
    EC_WORD_WORKING,
    EC_WORD_WORKS,
...
const u16 gEasyChatWordsByLetter_Z[] = {
    EC_POKEMON(DARKTYRANNOMON),
    EC_MOVE2(ZAP_CANNON),
    EC_POKEMON_NATIONAL(EBIBURGAMON),
    EC_POKEMON(TOYAGUMON),
    DOUBLE_SPECIES_NAME
    EC_POKEMON(SNOWBOTAMON),
    EC_POKEMON_NATIONAL(SNOWBOTAMON),
};
