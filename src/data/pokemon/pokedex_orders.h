...
const u16 gPokedexOrder_Weight[] =
{
    ...
    NATIONAL_DEX_FANBEEMON,
    // 35.3 lbs / 16.0 kg
    //NATIONAL_DEX_ARMADILMON_GALARIAN,
    NATIONAL_DEX_PENGUINMON,
    NATIONAL_DEX_D_MERAMON_CMON_DIGIMON,
    NATIONAL_DEX_MARINEANGEMON,
    NATIONAL_DEX_DARTRIX,
    ...
    NATIONAL_DEX_TOEDSCRUEL,
    // 128.3 lbs / 58.2 kg
    //NATIONAL_DEX_EBIBURGMON_GALARIAN,
    //NATIONAL_DEX_VADEMON,
    NATIONAL_DEX_MR_RIME,
    // 129.0 lbs / 58.5 kg
    NATIONAL_DEX_KIMERAMON,
    // 130.1 lbs / 59.0 kg
    //NATIONAL_DEX_TYUTYUMON_MEGA,
    NATIONAL_DEX_DRACMON,
    // 130.3 lbs / 59.1 kg
    NATIONAL_DEX_TINKATUFF,
    // 131.4 lbs / 59.6 kg
