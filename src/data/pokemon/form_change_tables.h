...
static const struct Fusion sDigimonFusionTable[] = {
    ...
    // {0, ITEM_DNA_SPLICERS,   SPECIES_AXEMON,   SPECIES_APOLLOMON_WHISPERED,  SPECIES_APOLLOMON_DARKNESS_MODE},
    // {0, ITEM_DNA_SPLICERS,   SPECIES_AXEMON,   SPECIES_TUWARMON,  SPECIES_DEADLYTUWARMON},
    // {0, ITEM_DNA_SPLICERS,   SPECIES_AXEMON,   SPECIES_SKULLKNIGHTMON,  SPECIES_SKULLKNIGHTMON_CAVALIER_MODE},
