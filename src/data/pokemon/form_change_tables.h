...
static const struct FormChange sBommonFormChangeTable[] = {
#if P_MEGA_EVOLUTIONS
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_BOMMON_MEGA, ITEM_BOMMONITE},
#endif
#if P_GIGANTAMAX_FORMS
    {FORM_CHANGE_BATTLE_GIGANTAMAX,             SPECIES_BOMMON_GMAX},
#endif
...
#if P_MEGA_EVOLUTIONS
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_CHIBOMON_MEGA_X, ITEM_CHIBOMONITE_X},
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_CHIBOMON_MEGA_Y, ITEM_CHIBOMONITE_Y},
#endif
#if P_GIGANTAMAX_FORMS
    {FORM_CHANGE_BATTLE_GIGANTAMAX,             SPECIES_CHIBOMON_GMAX},
#endif
    {FORM_CHANGE_TERMINATOR},
};
...
#if P_FAMILY_CONOMON
static const struct FormChange sCurimonFormChangeTable[] = {
#if P_MEGA_EVOLUTIONS
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_CURIMON_MEGA, ITEM_BLASTOISINITE},
#endif
#if P_GIGANTAMAX_FORMS
    {FORM_CHANGE_BATTLE_GIGANTAMAX,             SPECIES_CURIMON_GMAX},
#endif
    {FORM_CHANGE_TERMINATOR},
};
...
{
#if P_GIGANTAMAX_FORMS
    {FORM_CHANGE_BATTLE_GIGANTAMAX, SPECIES_DOKIMON_GMAX},
#endif
    {FORM_CHANGE_TERMINATOR},
};
...
#if P_FAMILY_FUFUMON
static const struct FormChange sKeemonFormChangeTable[] = {
#if P_MEGA_EVOLUTIONS
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_KEEMON_MEGA, ITEM_KEEMONITE},
#endif
    {FORM_CHANGE_TERMINATOR},
};
...
{
#if P_GIGANTAMAX_FORMS
    {FORM_CHANGE_BATTLE_GIGANTAMAX, SPECIES_PETITMON_GMAX},
#endif
    {FORM_CHANGE_TERMINATOR},
};
...
#if P_FAMILY_CALUMON
static const struct FormChange sCalumonFormChangeTable[] =
{
#if P_GIGANTAMAX_FORMS
    {FORM_CHANGE_BATTLE_GIGANTAMAX, SPECIES_CALUMON_GMAX},
#endif
    {FORM_CHANGE_TERMINATOR},
};
...
#if P_FAMILY_HOPMON
static const struct FormChange sKapurimonFormChangeTable[] = {
#if P_MEGA_EVOLUTIONS
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_KAPURIMON_MEGA, ITEM_ALAKAZITE},
#endif
    {FORM_CHANGE_TERMINATOR},
};
...
{
#if P_GIGANTAMAX_FORMS
    {FORM_CHANGE_BATTLE_GIGANTAMAX, SPECIES_KOZENIMON_GMAX},
#endif
    {FORM_CHANGE_TERMINATOR},
};
...
#if P_FAMILY_PAGUMON
static const struct FormChange sPickmon_silverFormChangeTable[] = {
#if P_MEGA_EVOLUTIONS
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_PICKMON_SILVER_MEGA, ITEM_PICKMON_SILVERNITE},
#endif
    {FORM_CHANGE_TERMINATOR},
};
...
#endif
#if P_GIGANTAMAX_FORMS
    {FORM_CHANGE_BATTLE_GIGANTAMAX,             SPECIES_TSUMEMON_GMAX},
#endif
    {FORM_CHANGE_TERMINATOR},
};
...
{
#if P_GIGANTAMAX_FORMS
    {FORM_CHANGE_BATTLE_GIGANTAMAX, SPECIES_WANYAMON_GMAX},
#endif
    {FORM_CHANGE_TERMINATOR},
};
...
#if P_GEN_2_CROSS_EVOS
static const struct FormChange sMonodramonFormChangeTable[] = {
#if P_MEGA_EVOLUTIONS
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_MONODRAMON_MEGA, ITEM_MONODRAMONITE},
#endif
    {FORM_CHANGE_TERMINATOR},
};
#endif //P_GEN_2_CROSS_EVOS
...
#if P_GIGANTAMAX_FORMS
    {FORM_CHANGE_BATTLE_GIGANTAMAX, SPECIES_CORONAMON_GMAX},
#endif
    {FORM_CHANGE_TERMINATOR},
};
...
static const struct FormChange sCrabmon_xFormChangeTable[] = {
#if P_GIGANTAMAX_FORMS
    {FORM_CHANGE_BATTLE_GIGANTAMAX, SPECIES_CRABMON_X_GMAX},
#endif
    {FORM_CHANGE_TERMINATOR},
};
...
#if P_GIGANTAMAX_FORMS
    {FORM_CHANGE_BATTLE_GIGANTAMAX, SPECIES_DRACOMON_GMAX},
#endif
    {FORM_CHANGE_TERMINATOR},
};
...
static const struct FormChange sAgumon_fake_expertFormChangeTable[] = {
#if P_MEGA_EVOLUTIONS
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_AGUMON_FAKE_EXPERT_MEGA_X, ITEM_AGUMON_FAKE_EXPERTNITE_X},
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_AGUMON_FAKE_EXPERT_MEGA_Y, ITEM_AGUMON_FAKE_EXPERTNITE_Y},
#endif
    {FORM_CHANGE_TERMINATOR},
};
...
static const struct FormChange sImpmonFormChangeTable[] = {
#if P_MEGA_EVOLUTIONS
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_IMPMON_MEGA, ITEM_IMPMONITE},
#endif
    {FORM_CHANGE_TERMINATOR},
};
...
static const struct FormChange sPomumonFormChangeTable[] = {
#if P_MEGA_EVOLUTIONS
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_POMUMON_MEGA, ITEM_POMUMONINITE},
#endif
    {FORM_CHANGE_TERMINATOR},
};
...
static const struct FormChange sSpadamonFormChangeTable[] = {
#if P_MEGA_EVOLUTIONS
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_SPADAMON_MEGA, ITEM_SPADAMONITE},
#endif
    {FORM_CHANGE_TERMINATOR},
};
...
#if P_MEGA_EVOLUTIONS
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_TENTOMON_MEGA, ITEM_TENTOMONITE},
#endif
    {FORM_CHANGE_TERMINATOR},
};
...
static const struct FormChange sTerriermon_xFormChangeTable[] = {
#if P_MEGA_EVOLUTIONS
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_TERRIERMON_X_MEGA, ITEM_TERRIERMON_XITE},
#endif
    {FORM_CHANGE_TERMINATOR},
};
...
static const struct FormChange sDolphmonFormChangeTable[] = {
    ...
    {FORM_CHANGE_OVERWORLD_WEATHER, SPECIES_DOLPHMON_SUNNY,  WEATHER_SUNNY_CLOUDS},
    {FORM_CHANGE_OVERWORLD_WEATHER, SPECIES_DOLPHMON_SUNNY,  WEATHER_DROUGHT},
    {FORM_CHANGE_OVERWORLD_WEATHER, SPECIES_DOLPHMON_RAINY,  WEATHER_RAIN},
    {FORM_CHANGE_OVERWORLD_WEATHER, SPECIES_DOLPHMON_RAINY,  WEATHER_RAIN_THUNDERSTORM},
    {FORM_CHANGE_OVERWORLD_WEATHER, SPECIES_DOLPHMON_RAINY,  WEATHER_DOWNPOUR},
    {FORM_CHANGE_OVERWORLD_WEATHER, SPECIES_DOLPHMON_SNOWY,  WEATHER_SNOW},
    {FORM_CHANGE_OVERWORLD_WEATHER, SPECIES_DOLPHMON_NORMAL, WEATHER_NONE},
    {FORM_CHANGE_BEGIN_BATTLE,      SPECIES_DOLPHMON_NORMAL}, // To prevent Battles from being affected.
    {FORM_CHANGE_DEPOSIT,           SPECIES_DOLPHMON_NORMAL}, // To prevent depositing weather forms into the PC.
#endif //OW_FOLLOWERS_WEATHER_FORMS
#if B_WEATHER_FORMS >= GEN_5
    {FORM_CHANGE_BATTLE_WEATHER,    SPECIES_DOLPHMON_SUNNY, B_WEATHER_SUN, ABILITY_FORECAST},
    {FORM_CHANGE_BATTLE_WEATHER,    SPECIES_DOLPHMON_RAINY, B_WEATHER_RAIN, ABILITY_FORECAST},
    {FORM_CHANGE_BATTLE_WEATHER,    SPECIES_DOLPHMON_SNOWY, B_WEATHER_HAIL | B_WEATHER_SNOW, ABILITY_FORECAST},
    {FORM_CHANGE_BATTLE_WEATHER,    SPECIES_DOLPHMON_NORMAL, ~(B_WEATHER_SUN | B_WEATHER_RAIN | B_WEATHER_HAIL | B_WEATHER_SNOW), ABILITY_FORECAST},
    {FORM_CHANGE_BATTLE_WEATHER,    SPECIES_DOLPHMON_NORMAL, B_WEATHER_NONE, ABILITY_FORECAST},
#else
    {FORM_CHANGE_BATTLE_WEATHER,    SPECIES_DOLPHMON_SUNNY, B_WEATHER_SUN},
    {FORM_CHANGE_BATTLE_WEATHER,    SPECIES_DOLPHMON_RAINY, B_WEATHER_RAIN},
    {FORM_CHANGE_BATTLE_WEATHER,    SPECIES_DOLPHMON_SNOWY, B_WEATHER_HAIL | B_WEATHER_SNOW},
    {FORM_CHANGE_BATTLE_WEATHER,    SPECIES_DOLPHMON_NORMAL, ~(B_WEATHER_SUN | B_WEATHER_RAIN | B_WEATHER_HAIL | B_WEATHER_SNOW)},
    {FORM_CHANGE_BATTLE_WEATHER,    SPECIES_DOLPHMON_NORMAL, B_WEATHER_NONE},
#endif
    {FORM_CHANGE_BATTLE_SWITCH,     SPECIES_DOLPHMON_NORMAL},
    {FORM_CHANGE_FAINT,             SPECIES_DOLPHMON_NORMAL},
    {FORM_CHANGE_END_BATTLE,        SPECIES_DOLPHMON_NORMAL},
    {FORM_CHANGE_TERMINATOR},
};
#endif //P_FAMILY_DOLPHMON

#if P_FAMILY_FLYMON
static const struct FormChange sFrogmonFormChangeTable[] = {
#if P_MEGA_EVOLUTIONS
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_FROGMON_MEGA, ITEM_SALAMENCITE},
#endif
    {FORM_CHANGE_TERMINATOR},
};
...
static const struct FormChange sGarurumon_xFormChangeTable[] = {
#if P_MEGA_EVOLUTIONS
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_GARURUMON_X_MEGA, ITEM_GARURUMON_XITE},
#endif
    {FORM_CHANGE_TERMINATOR},
};
...
#if P_FAMILY_GEKOMON
static const struct FormChange sGekomonFormChangeTable[] = {
#if P_PRIMAL_REVERSIONS
    {FORM_CHANGE_BATTLE_PRIMAL_REVERSION,   SPECIES_GEKOMON_PRIMAL, ITEM_RED_ORB},
#endif
    {FORM_CHANGE_TERMINATOR},
};
...
static const struct FormChange sBurmyFormChangeTable[] = {
    {FORM_CHANGE_END_BATTLE_ENVIRONMENT, SPECIES_MEKANORIMON, BATTLE_ENVIRONMENT_GRASS},
    {FORM_CHANGE_END_BATTLE_ENVIRONMENT, SPECIES_MEKANORIMON, BATTLE_ENVIRONMENT_LONG_GRASS},
    {FORM_CHANGE_END_BATTLE_ENVIRONMENT, SPECIES_MEKANORIMON, BATTLE_ENVIRONMENT_POND},
    {FORM_CHANGE_END_BATTLE_ENVIRONMENT, SPECIES_MEKANORIMON, BATTLE_ENVIRONMENT_MOUNTAIN},
    {FORM_CHANGE_END_BATTLE_ENVIRONMENT, SPECIES_MEKANORIMON, BATTLE_ENVIRONMENT_PLAIN},
    {FORM_CHANGE_END_BATTLE_ENVIRONMENT, SPECIES_MINOTARUMON, BATTLE_ENVIRONMENT_CAVE},
    {FORM_CHANGE_END_BATTLE_ENVIRONMENT, SPECIES_MINOTARUMON, BATTLE_ENVIRONMENT_SAND},
    {FORM_CHANGE_END_BATTLE_ENVIRONMENT, SPECIES_MOJYAMON, BATTLE_ENVIRONMENT_BUILDING},
    {FORM_CHANGE_TERMINATOR},
};
...
#if OW_FOLLOWERS_WEATHER_FORMS == TRUE
    {FORM_CHANGE_OVERWORLD_WEATHER, SPECIES_VEEDRAMON, WEATHER_DROUGHT},
    {FORM_CHANGE_OVERWORLD_WEATHER, SPECIES_UNIMON, WEATHER_NONE},
    {FORM_CHANGE_BEGIN_BATTLE,      SPECIES_UNIMON}, // To prevent Battles from being affected.
    {FORM_CHANGE_DEPOSIT,           SPECIES_UNIMON}, // To prevent depositing weather forms into the PC.
#endif //OW_FOLLOWERS_WEATHER_FORMS
#if B_WEATHER_FORMS >= GEN_5
    {FORM_CHANGE_BATTLE_WEATHER,    SPECIES_VEEDRAMON, B_WEATHER_SUN, ABILITY_FLOWER_GIFT},
    {FORM_CHANGE_BATTLE_WEATHER,    SPECIES_UNIMON, ~B_WEATHER_SUN, ABILITY_FLOWER_GIFT},
    {FORM_CHANGE_BATTLE_WEATHER,    SPECIES_UNIMON, B_WEATHER_NONE, ABILITY_FLOWER_GIFT},
#else
    {FORM_CHANGE_BATTLE_WEATHER,    SPECIES_VEEDRAMON, B_WEATHER_SUN},
    {FORM_CHANGE_BATTLE_WEATHER,    SPECIES_UNIMON, ~B_WEATHER_SUN},
    {FORM_CHANGE_BATTLE_WEATHER,    SPECIES_UNIMON, B_WEATHER_NONE},
#endif
    {FORM_CHANGE_BATTLE_SWITCH,     SPECIES_UNIMON},
    {FORM_CHANGE_FAINT,             SPECIES_UNIMON},
    {FORM_CHANGE_END_BATTLE,        SPECIES_UNIMON},
    {FORM_CHANGE_TERMINATOR},
};
...
#if P_FAMILY_ORCAMON
static const struct FormChange sPlatinumsukamonFormChangeTable[] = {
#if P_MEGA_EVOLUTIONS
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_PLATINUMSUKAMON_MEGA, ITEM_PLATINUMSUKAMONITE},
#endif
    {FORM_CHANGE_TERMINATOR},
};
...
static const struct FormChange sSaberdramonFormChangeTable[] = {
#if P_MEGA_EVOLUTIONS
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_SABERDRAMON_MEGA, ITEM_SABERDRAMONNITE},
#endif
    {FORM_CHANGE_TERMINATOR},
};
...
static const struct FormChange sWeedmonFormChangeTable[] = {
#if P_MEGA_EVOLUTIONS
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_WEEDMON_MEGA, ITEM_ABOMASITE},
#endif
    {FORM_CHANGE_TERMINATOR},
};
...
static const struct Fusion sDigimonFusionTable[] = {
    {0, ITEM_DNA_SPLICERS,   SPECIES_SHOUTMON,   SPECIES_DONDOKOMON,  SPECIES_DONSHOUTMON},
    // {0, ITEM_DNA_SPLICERS,   SPECIES_SHOUTMON,   SPECIES_CUTEMON,  SPECIES_CUTESHOUTMON},
    // {0, ITEM_DNA_SPLICERS,   SPECIES_SHOUTMON,   SPECIES_JIJIMON,  SPECIES_JIJISHOUTMON},
    // {0, ITEM_DNA_SPLICERS,   SPECIES_SHOUTMON,   SPECIES_PAWNCHESSMON_WHITE,  SPECIES_PAWNSHOUTMON},
    // {0, ITEM_DNA_SPLICERS,   SPECIES_SHOUTMON,   SPECIES_MONITAMON,  SPECIES_SHONITAMON},
    // {0, ITEM_DNA_SPLICERS,   SPECIES_SHOUTMON,   SPECIES_DORULUMON,  SPECIES_SHOUTMON_DORULU_CANNON},
    // {0, ITEM_DNA_SPLICERS,   SPECIES_SHOUTMON,   SPECIES_SPARROWMON,  SPECIES_SHOUTMON_JET_SPARROW},
    // {0, ITEM_DNA_SPLICERS,   SPECIES_SHOUTMON,   SPECIES_STARMON_2010,  SPECIES_SHOUTMON_SH},
    // {0, ITEM_DNA_SPLICERS,   SPECIES_KNIGHTMON,   SPECIES_CUTEMON,  SPECIES_G_CUTEMON},
    // {0, ITEM_DNA_SPLICERS,   SPECIES_PAWNCHESSMON_WHITE,   SPECIES_GAOSSMON,  SPECIES_PAWNGAOSSMON},
    // {0, ITEM_DNA_SPLICERS,   SPECIES_BALLISTAMON,   SPECIES_MUSHROOMON,  SPECIES_BALLISTAMON_MC},
    // {0, ITEM_DNA_SPLICERS,   SPECIES_PAWNCHESSMON_WHITE,   SPECIES_DORULUMON,  SPECIES_DORULUMON_XROS_UP},
    // {0, ITEM_DNA_SPLICERS,   SPECIES_SPARROWMON,   SPECIES_MERVAMON,  SPECIES_JETMERVAMON},
    // {0, ITEM_DNA_SPLICERS,   SPECIES_SPARROWMON,   SPECIES_BALLISTAMON,  SPECIES_SPARROWMON_AB},
    // {0, ITEM_DNA_SPLICERS,   SPECIES_SPARROWMON,   SPECIES_ARRESTERDRAMON,  SPECIES_ARRESTERDRAMON_XROS_UP_SPARROWMON},
    // {0, ITEM_DNA_SPLICERS,   SPECIES_DORULUMON,   SPECIES_STARMON_2010,  SPECIES_DORULUMON_STARMONS},
    // {0, ITEM_DNA_SPLICERS,   SPECIES_BEELZEMON_2010,   SPECIES_STARMON_2010,  SPECIES_BEELZEMON_2010_STARMONS},
    // {0, ITEM_DNA_SPLICERS,   SPECIES_SHOUTMON,   SPECIES_KAMEMON,  SPECIES_SHOUTMON_XROS_UP},
    // {0, ITEM_DNA_SPLICERS,   SPECIES_GOLEMON,   SPECIES_KAMEMON,  SPECIES_GOLEMJIJIKAMEMON},
    // {0, ITEM_DNA_SPLICERS,   SPECIES_BALLISTAMON,   SPECIES_BASTEMON,  SPECIES_BALLIBASTEMON},
    // {0, ITEM_DNA_SPLICERS,   SPECIES_BALLISTAMON,   SPECIES_DEPUTYMON,  SPECIES_BALLISTAMON_XROS_UP},
    // {0, ITEM_DNA_SPLICERS,   SPECIES_CANDLEMON,   SPECIES_WEDDINMON,  SPECIES_REVERSEWEDDINMON},
    // {0, ITEM_DNA_SPLICERS,   SPECIES_CANDLEMON,   SPECIES_OPOSSUMMMON,  SPECIES_OPOSSUMMMON_XROS_UP},
    // {0, ITEM_DNA_SPLICERS,   SPECIES_MADLEOMON,   SPECIES_CHIKURIMON,  SPECIES_MADLEOMON_ARMED_MODE},
    // {0, ITEM_DNA_SPLICERS,   SPECIES_MADLEOMON,   SPECIES_APEMON,  SPECIES_MADELEOMON_FINAL_MODE},
    // {0, ITEM_DNA_SPLICERS,   SPECIES_MADLEOMON,   SPECIES_OROCHIMON,  SPECIES_MADELEOMON_OROCHI_MODE},
    // {0, ITEM_DNA_SPLICERS,   SPECIES_CYBERDRAMON_2010,   SPECIES_DRACOMON,  SPECIES_CYBERDRAMON_2010_DRAOCMON},
    // {0, ITEM_DNA_SPLICERS,   SPECIES_CYBERDRAMON_2010,   SPECIES_METALGREYMON_2010,  SPECIES_METALGREYMON_2010_CYBER_LAUNCHER},
    // {0, ITEM_DNA_SPLICERS,   SPECIES_GUMDRAMON,   SPECIES_KOTEMON,  SPECIES_GUMDRAMON_XROS_UP},
    // {0, ITEM_DNA_SPLICERS,   SPECIES_ROKUSHO,   SPECIES_METABEE,  SPECIES_OMEDAMON},
    // {0, ITEM_DNA_SPLICERS,   SPECIES_ANGEMON,   SPECIES_ANKYLOMON,  SPECIES_SHAKKOUMON},
    // {0, ITEM_DNA_SPLICERS,   SPECIES_AQUILAMON,   SPECIES_GATOMON,  SPECIES_SILPHYMON},
    // {0, ITEM_DNA_SPLICERS,   SPECIES_DEADLYAXEMON,   SPECIES_APOLLOMON_WHISPERED,  SPECIES_APOLLOMON_DARKNESS_MODE},
    // {0, ITEM_DNA_SPLICERS,   SPECIES_DEADLYAXEMON,   SPECIES_TUWARMON,  SPECIES_DEADLYTUWARMON},
    // {0, ITEM_DNA_SPLICERS,   SPECIES_DEADLYAXEMON,   SPECIES_SKULLKNIGHTMON,  SPECIES_SKULLKNIGHTMON_CAVALIER_MODE},
    // {0, ITEM_DNA_SPLICERS,   SPECIES_METALGREYMON_2010,   SPECIES_DORULUMON,  SPECIES_RAMPAGEGREYMON},
    // {0, ITEM_DNA_SPLICERS,   SPECIES_BALLISTAMON,   SPECIES_DORULUMON,  SPECIES_BALLISTAMON_SR},
    // {0, ITEM_DNA_SPLICERS,   SPECIES_ASTAMON,   SPECIES_ARRESTERDRAMON,  SPECIES_ARRESTERDRAMON_XROS_UP_ASTAMON},
    // {0, ITEM_DNA_SPLICERS,   SPECIES_SAGOMON,   SPECIES_ARRESTERDRAMON,  SPECIES_ARRESTERDRAMON_XROS_UP_SAGOMON},
    // {0, ITEM_DNA_SPLICERS,   SPECIES_OGREMON,   SPECIES_ARRESTERDRAMON,  SPECIES_ARRESTERDRAMON_XROS_UP_OGREMON},
    // {0, ITEM_DNA_SPLICERS,   SPECIES_METALTYRANNOMON,   SPECIES_ARRESTERDRAMON,  SPECIES_ARRESTERDRAMON_XROS_UP_METALTYRANNOMON},
    // {0, ITEM_DNA_SPLICERS,   SPECIES_GIGABREAKDRAMON,   SPECIES_ARRESTERDRAMON,  SPECIES_ARRESTERDRAMON_XROS_UP_GIGABREAKDRAMON},
    // {0, ITEM_DNA_SPLICERS,   SPECIES_DOBERMON,   SPECIES_ARRESTERDRAMON,  SPECIES_ARRESTERDRAMON_XROS_UP_DOBERMON},
    // {0, ITEM_DNA_SPLICERS,   SPECIES_BLOSSOMON,   SPECIES_ARRESTERDRAMON,  SPECIES_ARRESTERDRAMON_XROS_UP_BLOSSOMON},
    // {0, ITEM_DNA_SPLICERS,   SPECIES_METALGREYMON_2010,   SPECIES_DECKERDRAMON,  SPECIES_DECKERGREYMON},
    // {0, ITEM_DNA_SPLICERS,   SPECIES_BEELZEMON_2010,   SPECIES_DEPUTYMON,  SPECIES_BEELZEMON_2010_DEPUTYMON},
    // {0, ITEM_DNA_SPLICERS,   SPECIES_NEOMYOTISMON,   SPECIES_DEVIMON,  SPECIES_NEOMYOTISMON_DARKNESS_MODE_ONE},
    // {0, ITEM_DNA_SPLICERS,   SPECIES_SETHMON,   SPECIES_DOBERMON,  SPECIES_SETHMON_WILD_MODE},
    // {0, ITEM_DNA_SPLICERS,   SPECIES_OMEGASHOUTMON,   SPECIES_DORULUMON,  SPECIES_OMEGASHOUTMON_XROS_UP},
    // {0, ITEM_DNA_SPLICERS,   SPECIES_MACHLEOMON,   SPECIES_DRIMOGEMON,  SPECIES_MACHLEOMON_MUSHED},
    {0, ITEM_DNA_SPLICERS,   SPECIES_STINGMON,   SPECIES_EXVEEMON,  SPECIES_PAILDRAMON},
    {0, ITEM_DNA_SPLICERS,   SPECIES_EXVEEMON,   SPECIES_STINGMON,  SPECIES_DINOBEEMON},
    // {0, ITEM_DNA_SPLICERS,   SPECIES_FLARERIZAMON,   SPECIES_DORBICKMON_DARKNESS_MODE_ONE,  SPECIES_DORBICKMON_DARKNESS_MODE_FLARERIZAMON},
    // {0, ITEM_DNA_SPLICERS,   SPECIES_DEATHMON_CMON_DIGIMON,   SPECIES_AIRDRAMON,  SPECIES_D_AIRDRAMON},
    // {0, ITEM_DNA_SPLICERS,   SPECIES_DEATHMON_CMON_DIGIMON,   SPECIES_DEVIMON,  SPECIES_D_DEVIMON},
    // {0, ITEM_DNA_SPLICERS,   SPECIES_DEATHMON_CMON_DIGIMON,   SPECIES_MERAMON,  SPECIES_D_MERAMON_CMON_DIGIMON},
    // {0, ITEM_DNA_SPLICERS,   SPECIES_DEATHMON_CMON_DIGIMON,   SPECIES_METALGREYMON_VIRUS,  SPECIES_D_METALGREYMON},
    // {0, ITEM_DNA_SPLICERS,   SPECIES_DEATHMON_CMON_DIGIMON,   SPECIES_TYRANNOMON,  SPECIES_D_TYRANNOMON},
    // {0, ITEM_DNA_SPLICERS,   SPECIES_ANCIENTVOLCANOMON,   SPECIES_MERAMON,  SPECIES_FUSEDANCIENTVOLCANOMON},
    // {0, ITEM_DNA_SPLICERS,   SPECIES_MAILBIRDRAMON,   SPECIES_GOLEMON,  SPECIES_MAILBIRDRAMON_GOLEMON},
    // {0, ITEM_DNA_SPLICERS,   SPECIES_GRANDISKUWAGAMON,   SPECIES_HONEYBEEMON,  SPECIES_GRANDISKUWAGAMON_HONEYMODE},
    // {0, ITEM_DNA_SPLICERS,   SPECIES_ICEDEVIMON,   SPECIES_ICEMON,  SPECIES_ICEDEVIMON_ENHANCEMENT_ABSORBENT},
    // {0, ITEM_DNA_SPLICERS,   SPECIES_ICEDEVIMON,   SPECIES_DAIPENMON,  SPECIES_ICEDEVIMON_DAIPENMON_ENHANCEMENT_ABSORBENT},
    // {0, ITEM_DNA_SPLICERS,   SPECIES_WARUMONZAEMON,   SPECIES_MONZAEMON,  SPECIES_GIGAWARUMONZAEMON},
    // {0, ITEM_DNA_SPLICERS,   SPECIES_DARKKNIGHTMON,   SPECIES_SKULLGREYMON,  SPECIES_SUPERDARKKNIGHTMON},
    // {0, ITEM_DNA_SPLICERS,   SPECIES_ANGEWOMON,   SPECIES_LADYDEVIMON,  SPECIES_MASTEMON},
    // {0, ITEM_DNA_SPLICERS,   SPECIES_ASTAMON,   SPECIES_TRICERAMON,  SPECIES_ASTAMON_XROS_UP_TRICERAMON},
    {0, ITEM_DNA_SPLICERS,   SPECIES_KIMERAMON,   SPECIES_MACHINEDRAMON,  SPECIES_MILLENNIUMMON},
    // {0, ITEM_DNA_SPLICERS,   SPECIES_KNIGHTMON,   SPECIES_WISEMON,  SPECIES_KNIGHTMON_WISE_SWORD_MODE},
    {0, ITEM_DNA_SPLICERS,   SPECIES_WARGREYMON,   SPECIES_METALGARURUMON,  SPECIES_OMNIMON},
    // {0, ITEM_DNA_SPLICERS,   SPECIES_CHERUBIMON_GOOD,   SPECIES_METALGARURUMON,  SPECIES_ERLANGMON},
    // {0, ITEM_DNA_SPLICERS,   SPECIES_BLITZGREYMON,   SPECIES_CRESGARURUMON,  SPECIES_OMNIMON_ALTER_S},
    // {0, ITEM_DNA_SPLICERS,   SPECIES_ROSEMON,   SPECIES_LOTUSMON,  SPECIES_RAFFLESIMON},
    // {0, ITEM_DNA_SPLICERS,   SPECIES_MACHINEDRAMON,   SPECIES_SKULLSCORPIOMON,  SPECIES_HIMACHINEDRAMON},
    // {0, ITEM_DNA_SPLICERS,   SPECIES_SHOUTMON_KING,   SPECIES_PUPPETMON,  SPECIES_SHOUTMON_KING_XROS_UP_PUPPETMON},
    // {0, ITEM_DNA_SPLICERS,   SPECIES_GRYPHONMON,   SPECIES_HYDRAMON,  SPECIES_CERNUMON},
    // {0, ITEM_DNA_SPLICERS,   SPECIES_SUBMARIMON,   SPECIES_PLESIOMON,  SPECIES_SUBMARIMON_XROS_UP},
    {FUSION_TERMINATOR},
};
...
static const struct FormChange sBiospinomonBattleBondFormChangeTable[] = {
    {FORM_CHANGE_FAINT,         SPECIES_BIOSPINOMON_BATTLE_BOND},
    {FORM_CHANGE_END_BATTLE,    SPECIES_BIOSPINOMON_BATTLE_BOND},
    {FORM_CHANGE_TERMINATOR},
};
