...
static const struct FormChange sBurmyFormChangeTable[] = {
    {FORM_CHANGE_END_BATTLE_TERRAIN, SPECIES_MEKANORIMON, BATTLE_ENVIRONMENT_GRASS},
    {FORM_CHANGE_END_BATTLE_TERRAIN, SPECIES_MEKANORIMON, BATTLE_ENVIRONMENT_LONG_GRASS},
    {FORM_CHANGE_END_BATTLE_TERRAIN, SPECIES_MEKANORIMON, BATTLE_ENVIRONMENT_POND},
    {FORM_CHANGE_END_BATTLE_TERRAIN, SPECIES_MEKANORIMON, BATTLE_ENVIRONMENT_MOUNTAIN},
    {FORM_CHANGE_END_BATTLE_TERRAIN, SPECIES_MEKANORIMON, BATTLE_ENVIRONMENT_PLAIN},
    {FORM_CHANGE_END_BATTLE_TERRAIN, SPECIES_MINOTARUMON, BATTLE_ENVIRONMENT_CAVE},
    {FORM_CHANGE_END_BATTLE_TERRAIN, SPECIES_MINOTARUMON, BATTLE_ENVIRONMENT_SAND},
    {FORM_CHANGE_END_BATTLE_TERRAIN, SPECIES_MOJYAMON, BATTLE_ENVIRONMENT_BUILDING},
    {FORM_CHANGE_TERMINATOR},
};
