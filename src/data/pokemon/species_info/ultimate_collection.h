...
const struct SpeciesInfo gSpeciesInfoGen5[] =
{
    ...
    [SPECIES_D_TYRANNOMON] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 17, SPECIES_MAMEMON}),
    },
    ...
    [SPECIES_MAMEMON] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_ADAPTABILITY, ABILITY_AFTERMATH, ABILITY_HUGE_POWER }, // Blasting Fists
    ...
    [SPECIES_METALMAMEMON] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 17, SPECIES_MONZAEMON}),
    },
    ...
    [SPECIES_PUMPKINMON] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 25, SPECIES_PIXIMON}),
    },
