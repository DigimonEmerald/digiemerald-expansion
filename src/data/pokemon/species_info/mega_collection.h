...
const struct SpeciesInfo gSpeciesInfoGen6[] =
{
    ...
    [SPECIES_MAGNADRAMON] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_GREAT_PURGE, ABILITY_NONE, ABILITY_NONE },
    ...
    [SPECIES_APOCALYMON] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_DEATH_EVOLUTION, ABILITY_NONE, ABILITY_NONE },
        .bodyColor = BODY_COLOR_BLUE,
...
#define FLORGES_MISC_INFO(Form, iconPal)                                        \
    ...
    [SPECIES_CREEPYMON] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SIN_OF_WRATH, ABILITY_NONE, ABILITY_NONE },
        .bodyColor = BODY_COLOR_RED,
...
#define FURFROU_MISC_INFO(_form, _noFlip, frontWidth, frontYOffset, backWidth, backYOffset, _iconIdx)   \
    ...
    [SPECIES_GOLDRAMON] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SEALED_FISTS, ABILITY_NONE, ABILITY_NONE },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_GRYPHONMON] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_WIND_RIDER, ABILITY_SAND_VEIL, ABILITY_INTIMIDATE },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Gryphonmon"),
        .cryId = CRY_GOLDRAMON,
        .natDexNum = NATIONAL_DEX_MEOWSTIC,
        .categoryName = _("Griffon"),
        .height = 38,
        .weight = 936,
        .description = COMPOUND_STRING(
            "As its body is made up of various\n"
            "Digimon parts, it is incredibly hard\n"
            "for opponents to find a weakness\n"
            "in Gryphonmons defenses."),
        .pokemonScale = 422,
        .pokemonOffset = 12,
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_Gryphonmon,
        .frontPicSize = MON_COORDS_SIZE(48, 64),
        .frontPicYOffset = 3,
        .frontAnimFrames = sAnims_Meowstic,
        .frontAnimId = ANIM_GROW_VIBRATE,
        .backPic = gMonBackPic_Gryphonmon,
        .backPicSize = MON_COORDS_SIZE(64, 64),
        .backPicYOffset = 9,
        .backAnimId = BACK_ANIM_CONCAVE_ARC_LARGE,
        .palette = gMonPalette_Gryphonmon,
        .shinyPalette = gMonShinyPalette_Gryphonmon,
        .iconSprite = gMonIcon_Gryphonmon,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NORMAL,
        SHADOW(-2, 11, SHADOW_SIZE_S)
        FOOTPRINT(Meowstic)
        OVERWORLD(
            sPicTable_Gryphonmon,
            SIZE_32x32,
            SHADOW_SIZE_M,
            TRACKS_FOOT,
            sAnimTable_Following,
            gOverworldPalette_Gryphonmon,
            gShinyOverworldPalette_Gryphonmon
        )
        .levelUpLearnset = sGryphonmonLevelUpLearnset,
        .teachableLearnset = sGryphonmonTeachableLearnset,
...
#define AEGISLASH_MAIN_STAT (P_UPDATED_STATS >= GEN_8 ? 140 : 150)
    ...
    [SPECIES_KINGETEMON] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY),
        .abilities = { ABILITY_PRANKSTER, ABILITY_KINGS_PRIVILEGE, ABILITY_NONE }, 
        .bodyColor = BODY_COLOR_YELLOW,
