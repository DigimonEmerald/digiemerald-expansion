...
const struct SpeciesInfo gSpeciesInfoGen6[] =
{
    ...
    [SPECIES_BIOSUPINOMON_ASH] =
    {
        ...
        .trainerScale = 271,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_BiosupinomonAsh,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 0,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 8),
        ...
        .frontAnimId = ANIM_V_STRETCH,
        .backPic = gMonBackPic_BiosupinomonAsh,
        .backPicSize = MON_COORDS_SIZE(64, 48),
        .backPicYOffset = 11,
        .backAnimId = BACK_ANIM_SHAKE_GLOW_BLUE,
        .palette = gMonPalette_BiosupinomonAsh,
        .shinyPalette = gMonShinyPalette_BiosupinomonAsh,
        .iconSprite = gMonIcon_BiosupinomonAsh,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
