...
{
    HOENN_TO_NATIONAL(SUNARIZAMON),
    HOENN_TO_NATIONAL(SWIMMON),
    HOENN_TO_NATIONAL(SYAKOMON),
    HOENN_TO_NATIONAL(SYAKOMON_X),
    HOENN_TO_NATIONAL(TAPIRMON),
    HOENN_TO_NATIONAL(TENTOMON),
    HOENN_TO_NATIONAL(TERRIERMON),
    HOENN_TO_NATIONAL(TERRIERMON_ASSISTANT),
    HOENN_TO_NATIONAL(TERRIERMON_X),
    HOENN_TO_NATIONAL(TINKERMON),
    HOENN_TO_NATIONAL(TINPET),
    HOENN_TO_NATIONAL(TOYAGUMON),
    HOENN_TO_NATIONAL(TSUKAIMON),
    ...
    HOENN_TO_NATIONAL(ZENIMON),
    HOENN_TO_NATIONAL(ZUBAMON),
    HOENN_TO_NATIONAL(AEGIOMON),
    HOENN_TO_NATIONAL(AGUNIMON),
    HOENN_TO_NATIONAL(AIRDRAMON),
    HOENN_TO_NATIONAL(AKATORIMON),
    HOENN_TO_NATIONAL(ALLOMON),
    HOENN_TO_NATIONAL(ALLOMON_X),
    HOENN_TO_NATIONAL(ANGELAMON),
    HOENN_TO_NATIONAL(ANGEMON),
    HOENN_TO_NATIONAL(ANKYLOMON),
    HOENN_TO_NATIONAL(APEMON),
    HOENN_TO_NATIONAL(AQUILAMON),
    HOENN_TO_NATIONAL(ARCADIAMON_CHAMPION),
#if P_NEW_EVOS_IN_REGIONAL_DEX && P_GEN_4_CROSS_EVOS
    HOENN_TO_NATIONAL(GALLADE),
#endif
    HOENN_TO_NATIONAL(ARCHELOMON),
    HOENN_TO_NATIONAL(ARGOMON_CHAMPION),
    HOENN_TO_NATIONAL(ARRESTERDRAMON),
    HOENN_TO_NATIONAL(ATAMADEKACHIMON),
    HOENN_TO_NATIONAL(AURUMON),
    HOENN_TO_NATIONAL(DEADLYAXEMON),
    HOENN_TO_NATIONAL(BABOONGAMON),
    HOENN_TO_NATIONAL(HOPMON),
    HOENN_TO_NATIONAL(KAKKINMON),
    HOENN_TO_NATIONAL(KAPURIMON),
    HOENN_TO_NATIONAL(BAKEMON),
    HOENN_TO_NATIONAL(BALLISTAMON),
    HOENN_TO_NATIONAL(BALUCHIMON),
    HOENN_TO_NATIONAL(BAOHUCKMON),
    HOENN_TO_NATIONAL(BAROMON),
    HOENN_TO_NATIONAL(TRAILMON_BATTLE_ARMAMENT),
    HOENN_TO_NATIONAL(BETELGAMMAMON),
    HOENN_TO_NATIONAL(BIOQUETZALMON),
    HOENN_TO_NATIONAL(BLACKAGUMON_X),
    HOENN_TO_NATIONAL(BLACKGABUMON),
    HOENN_TO_NATIONAL(CLEARAGUMON),
    HOENN_TO_NATIONAL(COMMANDRAMON),
    HOENN_TO_NATIONAL(BIOSTEGOMON),
    HOENN_TO_NATIONAL(JAZAMON),
    HOENN_TO_NATIONAL(JELLYMON),
    HOENN_TO_NATIONAL(MONIMON),
    HOENN_TO_NATIONAL(MOONMON),
    HOENN_TO_NATIONAL(MOTIMON),
    HOENN_TO_NATIONAL(BIOTHUNDERBIRDMON),
#if P_NEW_EVOS_IN_REGIONAL_DEX && P_GEN_4_CROSS_EVOS
    HOENN_TO_NATIONAL(PROBOPASS),
#endif
    HOENN_TO_NATIONAL(BIRDRAMON),
    HOENN_TO_NATIONAL(BLACKGAOGAMON),
    HOENN_TO_NATIONAL(SNOWBOTAMON),
    HOENN_TO_NATIONAL(YURAMON),
    HOENN_TO_NATIONAL(GOTSUMON),
    HOENN_TO_NATIONAL(MINOMON),
    HOENN_TO_NATIONAL(MISSIMON),
    HOENN_TO_NATIONAL(BLACKGARGOMON),
    HOENN_TO_NATIONAL(GARURUMON_BLACK),
    HOENN_TO_NATIONAL(BLACKGATOMON),
    HOENN_TO_NATIONAL(BLACKGATOMON_UVER),
    HOENN_TO_NATIONAL(BLACKGROWLMON),
    HOENN_TO_NATIONAL(KOKOMON),
    HOENN_TO_NATIONAL(KOROMON),
    HOENN_TO_NATIONAL(KOZENIMON),
    HOENN_TO_NATIONAL(BLADEKUWAGAMON),
    HOENN_TO_NATIONAL(BLIMPMON),
    HOENN_TO_NATIONAL(BOARMON),
    HOENN_TO_NATIONAL(BOMBERNANIMON),
    HOENN_TO_NATIONAL(BOOGIEMON),
    HOENN_TO_NATIONAL(BUCCHIEMON_RED),
    HOENN_TO_NATIONAL(PICKMON_WHITE),
    HOENN_TO_NATIONAL(PICKMON_RED),
#if P_NEW_EVOS_IN_REGIONAL_DEX && P_GEN_4_CROSS_EVOS
    HOENN_TO_NATIONAL(MAGNEZONE),
#endif
    HOENN_TO_NATIONAL(XIAOMON),
    HOENN_TO_NATIONAL(YAAMON),
    HOENN_TO_NATIONAL(BUCCHIEMON_GREEN),
    HOENN_TO_NATIONAL(BULKMON),
    HOENN_TO_NATIONAL(ZERIMON),
    HOENN_TO_NATIONAL(ZURUMON),
    HOENN_TO_NATIONAL(ARCADIAMON_IT),
    HOENN_TO_NATIONAL(IMPMON_X),
    HOENN_TO_NATIONAL(POROMON),
    HOENN_TO_NATIONAL(PUROROMON),
#if P_NEW_EVOS_IN_REGIONAL_DEX && P_GEN_4_CROSS_EVOS
    HOENN_TO_NATIONAL(BUDEW),
    HOENN_TO_NATIONAL(BULLMON),
    HOENN_TO_NATIONAL(ROSERADE),
#else
    HOENN_TO_NATIONAL(BULLMON),
#endif
    HOENN_TO_NATIONAL(BURAIMON),
    HOENN_TO_NATIONAL(BURGERMON_CHAMPION),
    HOENN_TO_NATIONAL(BUTTERFLYMON),
    HOENN_TO_NATIONAL(CENTARUMON),
    HOENN_TO_NATIONAL(CHAMBLEMON),
    HOENN_TO_NATIONAL(CHAMELEMON),
    HOENN_TO_NATIONAL(CHRYSALIMON),
    HOENN_TO_NATIONAL(CITRAMON),
    HOENN_TO_NATIONAL(OTAMAMON_RED),
    HOENN_TO_NATIONAL(OTAMAMON_X),
    HOENN_TO_NATIONAL(CLOCKMON),
    HOENN_TO_NATIONAL(SAKUTTOMON),
    HOENN_TO_NATIONAL(SUNMON),
    HOENN_TO_NATIONAL(ARGOMON_ROOKIE),
    HOENN_TO_NATIONAL(ARMADILLOMON),
    HOENN_TO_NATIONAL(CLOCKMON_FUSION),
    ...
    HOENN_TO_NATIONAL(COREDRAMON_GREEN),
    HOENN_TO_NATIONAL(CYCLONEMON),
    HOENN_TO_NATIONAL(DAMEMON_FUSION),
    HOENN_TO_NATIONAL(DARCMON),
    HOENN_TO_NATIONAL(TRAILMON_DARK),
    HOENN_TO_NATIONAL(DARKLIZARDMON),
    HOENN_TO_NATIONAL(DARKMAILDRAMON),
    HOENN_TO_NATIONAL(DARKTYRANNOMON),
    HOENN_TO_NATIONAL(DARKTYRANNOMON_X),
    HOENN_TO_NATIONAL(DECKERDRAMON),
    HOENN_TO_NATIONAL(DELTAMON),
    HOENN_TO_NATIONAL(DEPTHMON),
    HOENN_TO_NATIONAL(DEPUTYMON),
    HOENN_TO_NATIONAL(DEVIDRAMON),
    HOENN_TO_NATIONAL(DEVIMON),
    HOENN_TO_NATIONAL(DEXDORUGAMON),
    HOENN_TO_NATIONAL(DIATRYMON),
    HOENN_TO_NATIONAL(DIGMON),
    HOENN_TO_NATIONAL(DINOHYUMON),
    HOENN_TO_NATIONAL(DOBERMON),
    HOENN_TO_NATIONAL(DOBERMON_X),
    HOENN_TO_NATIONAL(HACKMON),
    HOENN_TO_NATIONAL(SANDMON),
    HOENN_TO_NATIONAL(TSUBUMON),
    HOENN_TO_NATIONAL(DOGGYMON),
    HOENN_TO_NATIONAL(DOKUGUMON),
    HOENN_TO_NATIONAL(DOLPHMON),
    HOENN_TO_NATIONAL(BLACKGUILMON),
    HOENN_TO_NATIONAL(BOKOMON),
    HOENN_TO_NATIONAL(DONSHOUTMON),
    HOENN_TO_NATIONAL(DORUGAMON),
    HOENN_TO_NATIONAL(DORULUMON),
    HOENN_TO_NATIONAL(DRIMOGEMON),
    HOENN_TO_NATIONAL(EBIDRAMON),
#if P_NEW_EVOS_IN_REGIONAL_DEX && P_GEN_4_CROSS_EVOS
    HOENN_TO_NATIONAL(DUSKNOIR),
    HOENN_TO_NATIONAL(ELEPHANTMON),
    HOENN_TO_NATIONAL(CHINGLING),
#else
    HOENN_TO_NATIONAL(ELEPHANTMON),
#endif
    HOENN_TO_NATIONAL(EOSMON_CHAMPION),
    HOENN_TO_NATIONAL(EXERMON),
    HOENN_TO_NATIONAL(RELEMON),
    HOENN_TO_NATIONAL(SAKUMON),
    HOENN_TO_NATIONAL(GUILMON_X),
    HOENN_TO_NATIONAL(PETITMON),
    HOENN_TO_NATIONAL(PICHIMON),
    HOENN_TO_NATIONAL(CHICCHIMON),
    HOENN_TO_NATIONAL(DEMIMERAMON),
    HOENN_TO_NATIONAL(EXVEEMON),
    HOENN_TO_NATIONAL(LOPMONX),
    HOENN_TO_NATIONAL(HAWKMON),
    HOENN_TO_NATIONAL(HERISSMON),
    HOENN_TO_NATIONAL(LUCEMON),
#if P_NEW_EVOS_IN_REGIONAL_DEX && P_GEN_9_CROSS_EVOS
    HOENN_TO_NATIONAL(FARIGIRAF),
#endif
    HOENN_TO_NATIONAL(PULSEMON),
    HOENN_TO_NATIONAL(RENAMON),
    HOENN_TO_NATIONAL(CHUUCHUUMON),
    HOENN_TO_NATIONAL(MUCHOMON),
    HOENN_TO_NATIONAL(ARURAUMON),
    HOENN_TO_NATIONAL(BAKOMON),
#if P_NEW_EVOS_IN_REGIONAL_DEX && P_GEN_4_CROSS_EVOS
    HOENN_TO_NATIONAL(RHYPERIOR),
#endif
    HOENN_TO_NATIONAL(EXVEEMON_VIRUS),
    HOENN_TO_NATIONAL(EYESMON),
#if P_NEW_EVOS_IN_REGIONAL_DEX && P_GEN_4_CROSS_EVOS
    ...
    HOENN_TO_NATIONAL(FLAMEDRAMON),
    HOENN_TO_NATIONAL(FLAMEWIZARDMON),
    HOENN_TO_NATIONAL(FLARERIZAMON),
    HOENN_TO_NATIONAL(PATAMON),
#if P_NEW_EVOS_IN_REGIONAL_DEX && P_GALARIAN_FORMS
    HOENN_TO_NATIONAL(CURSOLA),
#endif
    HOENN_TO_NATIONAL(GOTSUMON_X),
    HOENN_TO_NATIONAL(GUILMON),
    HOENN_TO_NATIONAL(FLYBEEMON),
    HOENN_TO_NATIONAL(BIYOMON),
    HOENN_TO_NATIONAL(BLACKAGUMON),
    HOENN_TO_NATIONAL(PSYCHEMON),
    HOENN_TO_NATIONAL(FLYMON),
    HOENN_TO_NATIONAL(FRIGIMON),
    HOENN_TO_NATIONAL(FROGMON),
    HOENN_TO_NATIONAL(FUGAMON),
    HOENN_TO_NATIONAL(GANEMON),
    HOENN_TO_NATIONAL(GAOGAMON),
    HOENN_TO_NATIONAL(GARGOMON),
    HOENN_TO_NATIONAL(GARGOYLEMON),
...
{
    {.x = 16, .y =  7, .image = INCBIN_U16("graphics/pokemon/coredramon_blue/spots/spot_0.1bpp")},
    {.x = 40, .y =  8, .image = INCBIN_U16("graphics/pokemon/coredramon_blue/spots/spot_1.1bpp")},
    {.x = 22, .y = 25, .image = INCBIN_U16("graphics/pokemon/coredramon_blue/spots/spot_2.1bpp")},
    {.x = 34, .y = 26, .image = INCBIN_U16("graphics/pokemon/coredramon_blue/spots/spot_3.1bpp")}
};
...
static const s8 sFriendshipEventModifiers[][3] =
{
    ...
    [FRIENDSHIP_EVENT_EFFORT_BERRIES]  = {10, 5, 2},
};
...
static const struct SpeciesItem sAlteringCaveWildMonHeldItems[] =
{
    ...
    {SPECIES_LUDOMON,    ITEM_APICOT_BERRY},
    {SPECIES_PILLOMON,  ITEM_BIG_MUSHROOM},
    {SPECIES_NEEMON, ITEM_PETAYA_BERRY},
    {SPECIES_KOKABUTERIMON,     ITEM_BERRY_JUICE},
...
void CreateMonWithGenderNatureLetter(struct Pokemon *mon, u16 species, u8 level, u8 fixedIV, u8 gender, u8 nature, u8 lopmonLetter)
{
    u32 personality;

    if ((u8)(lopmonLetter - 1) < NUM_LOPMON_FORMS)
    {
        u16 actualLetter;
        ...
        {
            personality = Random32();
            actualLetter = GET_LOPMON_LETTER(personality);
        }
        while (nature != GetNatureFromPersonality(personality)
            || gender != GetGenderFromSpeciesAndPersonality(species, personality)
            || actualLetter != lopmonLetter - 1);
    }
    else
    {
        do
...
bool8 ShouldIgnoreGesomonForm(u8 caseId, u8 battler)
{
    switch (caseId)
    {
    case 0:
...
u32 GetLopmonSpeciesId(u32 personality)
{
    u16 lopmonLetter = GetLopmonLetterByPersonality(personality);

    if (lopmonLetter == 0)
        return SPECIES_LOPMON;
    return lopmonLetter + SPECIES_LOPMON_B - 1;
}
...
void PokemonToBattleMon(struct Pokemon *src, struct BattlePokemon *dst)
{
    ...
    dst->attribute = gSpeciesInfo[dst->species].attribute;
...
u32 GetEvolutionTargetSpecies(struct Pokemon *mon, enum EvolutionMode mode, u16 evolutionItem, struct Pokemon *tradePartner, bool32 *canStopEvo, enum EvoState evoState)
{
    ...
    // Petitmon, Calumon, Crabmon_x and Duraludon cannot evolve if they have the
...
/*
    The function below handles drawing the randomly-placed spots on Coredramon_blue's front sprite.
...
void DrawCoredramon_blueSpots(u32 personality, u8 *dest, bool32 isSecondFrame)
{
    ...
    {
        s32 row;
        u8 x = gCoredramon_blueSpotGraphics[i].x + (personality & 0x0F);
        u8 y = gCoredramon_blueSpotGraphics[i].y + ((personality & 0xF0) >> 4);
...
void HandleSetPokedexFlag(enum NationalDexOrder nationalNum, u8 caseId, u32 personality)
{
    ...
    if (!GetSetPokedexFlag(nationalNum, getFlagCaseId)) // don't set if it's already set
    {
        ...
        if (NationalPokedexNumToSpecies(nationalNum) == SPECIES_LOPMON)
            gSaveBlock2Ptr->pokedex.lopmonPersonality = personality;
