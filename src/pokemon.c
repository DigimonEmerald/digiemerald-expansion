...
static const enum NationalDexOrder sHoennToNationalOrder[HOENN_DEX_COUNT - 1] =
{
    ...
    HOENN_TO_NATIONAL(ARESDRAMON),
    HOENN_TO_NATIONAL(ATAMADEMON),
    HOENN_TO_NATIONAL(AURUMON),
    HOENN_TO_NATIONAL(AXEMON),
    HOENN_TO_NATIONAL(BABOONMON),
    ...
    HOENN_TO_NATIONAL(BETGAMAMON),
    HOENN_TO_NATIONAL(BIOQUETMON),
    HOENN_TO_NATIONAL(BLKAGUMON_X),
    HOENN_TO_NATIONAL(BLKGABUMON),
    HOENN_TO_NATIONAL(HAZYAGUMON),
    HOENN_TO_NATIONAL(COMMDRAMON),
    HOENN_TO_NATIONAL(BIOSTEGMON),
    ...
    HOENN_TO_NATIONAL(BIOTHUNMON),
#if P_NEW_EVOS_IN_REGIONAL_DEX && P_GEN_4_CROSS_EVOS
    HOENN_TO_NATIONAL(PROBOPASS),
#endif
    HOENN_TO_NATIONAL(BIRDRAMON),
    HOENN_TO_NATIONAL(BLGAOGAMON),
    HOENN_TO_NATIONAL(ICEBOTAMON),
    HOENN_TO_NATIONAL(YURAMON),
    HOENN_TO_NATIONAL(GOTSUMON),
    HOENN_TO_NATIONAL(MINOMON),
    HOENN_TO_NATIONAL(MISSIMON),
    HOENN_TO_NATIONAL(BLGARGOMON),
    HOENN_TO_NATIONAL(BLGARURMON),
    HOENN_TO_NATIONAL(BLKGATOMON),
    HOENN_TO_NATIONAL(BLKGATOMON_UVER),
    HOENN_TO_NATIONAL(BLGROWLMON),
    HOENN_TO_NATIONAL(KOKOMON),
    HOENN_TO_NATIONAL(KOROMON),
    HOENN_TO_NATIONAL(KOZENIMON),
    HOENN_TO_NATIONAL(SAWKUWAMON),
    HOENN_TO_NATIONAL(BLIMPMON),
    HOENN_TO_NATIONAL(BOARMON),
    HOENN_TO_NATIONAL(BOMNANIMON),
    ...
    HOENN_TO_NATIONAL(DARLIZAMON),
    HOENN_TO_NATIONAL(DARMAILMON),
    HOENN_TO_NATIONAL(DARKTYRMON),
    HOENN_TO_NATIONAL(DARKTYRMON_X),
    HOENN_TO_NATIONAL(DECKDRAMON),
    ...
    HOENN_TO_NATIONAL(BLKGUILMON),
    HOENN_TO_NATIONAL(BOKOMON),
    HOENN_TO_NATIONAL(DONSHOUMON),
    ...
    HOENN_TO_NATIONAL(FLADRAMON),
    HOENN_TO_NATIONAL(FLAWIZAMON),
    HOENN_TO_NATIONAL(FLARIZAMON),
