...
static const u8 sText_EVO_LEVEL_BALISTAMON[] = _("{LV}{UP_ARROW} to {STR_VAR_2}");
static const u8 sText_EVO_LEVEL_BALUCHIMON[] = _("{LV}{UP_ARROW} to {STR_VAR_2}, party<6, 1x POKéBALL");
...
static bool8 CalculateMoves(void)
{
    ...
    if (species >= SPECIES_BOMMON_MEGA && species <= SPECIES_GROUDON_PRIMAL)
...
static void HandleTargetSpeciesPrint(u8 taskId, u16 targetSpecies, u16 previousTargetSpecies, u8 base_x, u8 base_y, u8 base_y_offset, u8 base_i, bool8 isCrabmon_x)
{
    u8 iterations = 6;
...
static u8 PrintEvolutionTargetSpeciesAndMethod(u8 taskId, u16 species, u8 depth, u8 depth_i)
{
    ...
    for (i = 0; i < times; i++)
    {
        ...
        HandleTargetSpeciesPrint(taskId, targetSpecies, previousTargetSpecies, base_x + depth_x*depth, base_y, base_y_offset, base_i, isCrabmon_x); //evolution mon name
        ...
        case EVO_LEVEL_VEMMON:
            ConvertIntToDecimalStringN(gStringVar2, evolutions[i].param, STR_CONV_MODE_LEADING_ZEROS, EVO_SCREEN_LVL_DIGITS); //level
            StringExpandPlaceholders(gStringVar4, sText_EVO_LEVEL_VEMMON );
            break;
        case EVO_LEVEL_WORMMON:
            ConvertIntToDecimalStringN(gStringVar2, evolutions[i].param, STR_CONV_MODE_LEADING_ZEROS, EVO_SCREEN_LVL_DIGITS); //level
            StringExpandPlaceholders(gStringVar4, sText_EVO_LEVEL_WORMMON );
            break;
        case EVO_LEVEL_BALISTAMON:
            ConvertIntToDecimalStringN(gStringVar2, evolutions[i].param, STR_CONV_MODE_LEADING_ZEROS, EVO_SCREEN_LVL_DIGITS); //level
            StringExpandPlaceholders(gStringVar4, sText_EVO_LEVEL_BALISTAMON );
            break;
        case EVO_LEVEL_BALUCHIMON:
            ConvertIntToDecimalStringN(gStringVar2, evolutions[i].param, STR_CONV_MODE_LEADING_ZEROS, EVO_SCREEN_LVL_DIGITS); //level
            StringExpandPlaceholders(gStringVar4, sText_EVO_LEVEL_BALUCHIMON );
            break;
        case EVO_BEAUTY:
