...
const u8 gText_ExpandedPlaceholder_Gatomon_x[] = _("GATOMON_X");
const u8 gText_ExpandedPlaceholder_Gekomon[] = _("GEKOMON");
const u8 gText_ExpandedPlaceholder_Brendan[] = _("BRENDAN");
const u8 gText_ExpandedPlaceholder_May[] = _("MAY");
const u8 gText_EggNickname[] = _("EGG");
const u8 gText_Pokemon[] = _("DIGIMON");
...
const u8 gText_ThisIsAPokemon[] = _("This is what we call a “DIGIMON.”{PAUSE 96}\p");
const u8 gText_5MarksPokemon[] = _("????? DIGIMON");
...
const u8 gText_EmptyPkmnCategory[] = _("                       DIGIMON"); // Unused
...
const u8 gText_NoMatchingPkmnWereFound[] = _("No matching DIGIMON were found.");
const u8 gText_SearchForPkmnBasedOnParameters[] = _("Search for DIGIMON based on\nselected parameters.");
...
const u8 gText_DexSortNumericalDescription[] = _("DIGIMON are listed according to their\nnumber.");
const u8 gText_DexSortAtoZDescription[] = _("Spotted and owned DIGIMON are listed\nalphabetically.");
const u8 gText_DexSortHeaviestDescription[] = _("Owned DIGIMON are listed from the\nheaviest to the lightest.");
const u8 gText_DexSortLightestDescription[] = _("Owned DIGIMON are listed from the\nlightest to the heaviest.");
const u8 gText_DexSortTallestDescription[] = _("Owned DIGIMON are listed from the\ntallest to the smallest.");
const u8 gText_DexSortSmallestDescription[] = _("Owned DIGIMON are listed from the\nsmallest to the tallest.");
...
const u8 gText_HOFDexRating[] = _("Spotted DIGIMON: {STR_VAR_1}!\nOwned DIGIMON: {STR_VAR_2}!\pPROF. BIRCH's POKéDEX rating!\pPROF. BIRCH: Let's see…\p");
...
const u8 gText_BirchInTrouble[] = _("PROF. BIRCH is in trouble!\nRelease a DIGIMON and rescue him!");
const u8 gText_ConfirmStarterChoice[] = _("Do you choose this DIGIMON?");
const u8 gText_Pokemon4[] = _("DIGIMON"); // Unused
...
const u8 gText_UsedVar2WildLured[] = _("{PLAYER} used the\n{STR_VAR_2}.\pWild DIGIMON will be lured.{PAUSE_UNTIL_PRESS}");
const u8 gText_UsedVar2WildRepelled[] = _("{PLAYER} used the\n{STR_VAR_2}.\pWild DIGIMON will be repelled.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_ThePokemonList[] = _("the DIGIMON LIST");
...
const u8 gText_NoMoreThanVar1Pkmn[] = _("No more than {STR_VAR_1} DIGIMON\nmay enter.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_PkmnFriendlyBaseVar2Fell[] = _("{STR_VAR_1} is unhappy.\nThe base {STR_VAR_2} fell!{PAUSE_UNTIL_PRESS}");
...
const u8 gText_TeachWhichPokemon2[] = _("Teach which DIGIMON?"); // Unused
const u8 gText_ChoosePokemon[] = _("Choose a DIGIMON.");
const u8 gText_MoveToWhere[] = _("Move to where?");
const u8 gText_TeachWhichPokemon[] = _("Teach which DIGIMON?");
const u8 gText_UseOnWhichPokemon[] = _("Use on which DIGIMON?");
const u8 gText_GiveToWhichPokemon[] = _("Give to which DIGIMON?");
...
const u8 gText_NoPokemonForBattle[] = _("No DIGIMON for battle!");
const u8 gText_ChoosePokemon2[] = _("Choose a DIGIMON.");
const u8 gText_NotEnoughHp[] = _("Not enough HP…");
const u8 gText_PokemonAreNeeded[] = _("{STR_VAR_1} DIGIMON are needed.");
const u8 gText_PokemonCantBeSame[] = _("DIGIMON can't be the same.");
...
const u8 gText_ChoosePokemonCancel[] = _("Choose DIGIMON or CANCEL.");
const u8 gText_ChoosePokemonConfirm[] = _("Choose DIGIMON and confirm.");
...
const u8 gText_PkmnCantParticipate[] = _("That DIGIMON can't participate.{PAUSE_UNTIL_PRESS}");
...
ALIGNED(4) const u8 gText_PkmnCantBeTradedNow[] = _("That DIGIMON can't be traded\nnow.");
ALIGNED(4) const u8 gText_PkmnCantBeTraded[] = _("That DIGIMON can't be traded.");
ALIGNED(4) const u8 gText_EggCantBeTradedNow[] = _("An EGG can't be traded now.");
ALIGNED(4) const u8 gText_OtherTrainersPkmnCantBeTraded[] = _("The other TRAINER's DIGIMON\ncan't be traded now.");
...
ALIGNED(4) const u8 gText_NotPkmnOtherTrainerWants[] = _("That isn't the type of DIGIMON\nthat the other TRAINER wants.");
...
const u8 gText_RentalPkmn[] = _("RENTAL DIGIMON");
...
const u8 gText_PkmnInfo[] = _("DIGIMON INFO");
const u8 gText_PkmnSkills[] = _("DIGIMON SKILLS");
...
const u8 gText_OddEggFoundByCouple[] = _("An odd DIGIMON EGG found\nby the DAY CARE couple.");
const u8 gText_PeculiarEggNicePlace[] = _("A peculiar DIGIMON EGG\nobtained at the nice place.");
const u8 gText_PeculiarEggTrade[] = _("A peculiar DIGIMON EGG\nobtained in a trade.");
const u8 gText_EggFromHotSprings[] = _("A DIGIMON EGG obtained\nat the hot springs.");
const u8 gText_EggFromTraveler[] = _("An odd DIGIMON EGG\nobtained from a traveler.");
...
const u8 gText_SunarzamonDollAndPrice[] = _("SUNARZAMON DOLL 1,000 COINS");
const u8 gText_Syakomon_xDollAndPrice[] = _("SYAKOMON_X DOLL 1,000 COINS");
const u8 gText_TerriermonDollAndPrice[] = _("TERRIERMON DOLL   1,000 COINS");
...
const u8 gText_MenuOptionPokemon[] = _("DIGIMON");
...
const u8 gText_PokemonJump[] = _("DIGIMON JUMP");
const u8 gText_PuroromonBerryPicking[] = _("PUROROMON BERRY-PICKING");
...
const u8 gText_PokemonNature[] = _("DIGIMON NATURE");
const u8 gText_PokemonMoves[] = _("DIGIMON MOVES");
const u8 gText_Underpowered[] = _("UNDERPOWERED");
const u8 gText_WhenInDanger[] = _("WHEN IN DANGER");
const u8 gText_PyramidPokemon[] = _("PYRAMID: DIGIMON");
...
const u8 gText_PokemonOrder[] = _("DIGIMON ORDER");
const u8 gText_BattlePokemon[] = _("BATTLE DIGIMON");
...
const u8 gText_ReleaseThisPokemon[] = _("Release this DIGIMON?");
const u8 gText_PkmnWasReleased[] = _("{DYNAMIC 0} was released.");
const u8 gText_ByeByePkmn[] = _("Bye-bye, {DYNAMIC 0}!");
const u8 gText_MarkYourPkmn[] = _("Mark your DIGIMON.");
const u8 gText_ThatsYourLastPkmn[] = _("That's your last DIGIMON!");
const u8 gText_YourPartysFull[] = _("Your party's full!{PAUSE_UNTIL_PRESS}");
const u8 gText_YoureHoldingAPkmn[] = _("You're holding a DIGIMON!");
...
const u8 gText_GiveToAPkmn[] = _("GIVE to a DIGIMON?");
...
const u8 gText_WithdrawPokemon[] = _("WITHDRAW DIGIMON");
const u8 gText_DepositPokemon[] = _("DEPOSIT DIGIMON");
const u8 gText_MovePokemon[] = _("MOVE DIGIMON");
const u8 gText_MoveItems[] = _("MOVE ITEMS");
const u8 gText_SeeYa[] = _("SEE YA!");
const u8 gText_WithdrawMonDescription[] = _("Move DIGIMON stored in BOXES to\nyour party.");
const u8 gText_DepositMonDescription[] = _("Store DIGIMON in your party in BOXES.");
const u8 gText_MoveMonDescription[] = _("Organize the DIGIMON in BOXES and\nin your party.");
const u8 gText_MoveItemsDescription[] = _("Move items held by any DIGIMON\nin a BOX or your party.");
const u8 gText_SeeYaDescription[] = _("Return to the previous menu.");
const u8 gText_JustOnePkmn[] = _("There is just one DIGIMON with you.");
...
const u8 gText_CheckPokemonInDetail[] = _("Check DIGIMON in detail.");
...
const u8 gText_CheckPartyPokemonInDetail[] = _("Check party DIGIMON in detail.");
const u8 gText_CheckAllPokemonInDetail[] = _("Check all DIGIMON in detail.");
const u8 gText_ReturnToPokenavMenu[] = _("Return to the POKéNAV menu.");
const u8 gText_FindCoolPokemon[] = _("Find cool DIGIMON.");
const u8 gText_FindBeautifulPokemon[] = _("Find beautiful DIGIMON.");
const u8 gText_FindCutePokemon[] = _("Find cute DIGIMON.");
const u8 gText_FindSmartPokemon[] = _("Find smart DIGIMON.");
const u8 gText_FindToughPokemon[] = _("Find tough DIGIMON.");
...
const u8 gText_PokenavMatchCall_TrainerPokemon[] = _("TRAINER'S DIGIMON");
...
const u8 gText_StopGivingPkmnMail[] = _("Stop giving the DIGIMON MAIL?");
...
const u8 gText_StopGivingPkmnMail2[] = _("Stop giving the DIGIMON MAIL?"); // Unused
...
const u8 gText_PokemonLeague[] = _("DIGIMON LEAGUE");
const u8 gText_PokemonCenter[] = _("DIGIMON CENTER");
...
const u8 gText_SangomonDoll32BP[] = _("SANGOMON DOLL{CLEAR_TO 0x5E}32BP");
const u8 gText_HagurumonDoll48BP[] = _("HAGURUMON DOLL{CLEAR_TO 0x5E}48BP");
const u8 gText_CalumonDoll48BP[] = _("CALUMON DOLL{CLEAR_TO 0x5E}48BP");
const u8 gText_PuyomonDoll48BP[] = _("PUYOMON DOLL{CLEAR_TO 0x5E}48BP");
const u8 gText_CrabmonDoll48BP[] = _("CRABMON DOLL{CLEAR_TO 0x5E}48BP");
const u8 gText_FloramonDoll80BP[] = _("FLORAMON DOLL{CLEAR_TO 0x5E}80BP");
const u8 gText_Falcomon_06Doll80BP[] = _("FALCOMON_06 DOLL{CLEAR_TO 0x5E}80BP");
const u8 gText_GammamonDoll80BP[] = _("GAMMAMON DOLL{CLEAR_TO 0x5E}80BP");
const u8 gText_CoronamonDoll128BP[] = _("CORONAMON DOLL{CLEAR_TO 0x58}128BP");
const u8 gText_DracomonDoll128BP[] = _("DRACOMON DOLL{CLEAR_TO 0x58}128BP");
const u8 gText_BommonDoll256BP[] = _("BOMMON DOLL{CLEAR_TO 0x58}256BP");
const u8 gText_ChibomonDoll256BP[] = _("CHIBOMON DOLL{CLEAR_TO 0x58}256BP");
const u8 gText_CurimonDoll256BP[] = _("CURIMON DOLL{CLEAR_TO 0x58}256BP");
...
const u8 gText_PokemonTrades[] = _("DIGIMON TRADES");
...
const u8 gText_Pokemon2[] = _("DIGIMON");
...
const u8 gText_MatchCallSteven_Pokemon[] = _("Ultimate STEEL DIGIMON.");
...
const u8 gText_MatchCallBrendan_Pokemon[] = _("I will use various DIGIMON.");
const u8 gText_MatchCallBrendan_Intro1[] = _("I'll be a better DIGIMON");
...
const u8 gText_MatchCallMay_Pokemon[] = _("I'll use any DIGIMON!");
const u8 gText_MatchCallMay_Intro1[] = _("My DIGIMON and I help");
...
const u8 gText_BattlePalaceDesc[] = _("Watch your DIGIMON battle!\nYour spirit will be tested.");
const u8 gText_BattleArenaDesc[] = _("Win battles with teamed-up DIGIMON!\nYour guts will be tested.");
const u8 gText_BattleFactoryDesc[] = _("Aim for victory using rental DIGIMON!\nYour knowledge will be tested.");
...
const u8 gText_BerryPickingRecords[] = _("PUROROMON BERRY-PICKING RECORDS");
...
const u8 gText_PkmnJumpRecords[] = _("DIGIMON JUMP RECORDS");
...
const u8 gText_MenuPokemon[] = _("DIGIMON");
...
const u8 gText_PokemonOnHook[] = _("A DIGIMON's on the hook!{PAUSE_UNTIL_PRESS}");
...
const u8 gEasyChatGroupName_Pokemon[] = _("DIGIMON");
...
const u8 gEasyChatGroupName_Pokemon2[] = _("DIGIMON2");
...
const u8 gText_RentalPkmn2[] = _("RENTAL DIGIMON");
const u8 gText_SelectFirstPkmn[] = _("Select the first DIGIMON.");
const u8 gText_SelectSecondPkmn[] = _("Select the second DIGIMON.");
const u8 gText_SelectThirdPkmn[] = _("Select the third DIGIMON.");
...
const u8 gText_TheseThreePkmnOkay[] = _("Are these three DIGIMON OK?");
const u8 gText_Yes2[] = _("YES");
const u8 gText_No2[] = _("NO");
const u8 gText_CantSelectSamePkmn[] = _("Can't select same {PKMN}.");
const u8 gText_PkmnSwap[] = _("DIGIMON SWAP");
const u8 gText_SelectPkmnToSwap[] = _("Select DIGIMON to swap.");
const u8 gText_SelectPkmnToAccept[] = _("Select DIGIMON to accept.");
...
const u8 gText_AcceptThisPkmn[] = _("Accept this DIGIMON?");
