...
static const u16 sInitialRentalMonRanges[][2] =
{
    ...
    {FRONTIER_MON_BLACKGAOGAMON_1, FRONTIER_MON_TOKOMON_1}, // 162 - 266
    {FRONTIER_MON_BLACKGAOGAMON_2, FRONTIER_MON_TOKOMON_2}, // 267 - 371
    {FRONTIER_MON_BUKAMON_1,  FRONTIER_MON_BABOONGAMON_1},  // 372 - 467
    {FRONTIER_MON_BUKAMON_2,  FRONTIER_MON_BABOONGAMON_2},  // 468 - 563
    {FRONTIER_MON_BUKAMON_3,  FRONTIER_MON_BABOONGAMON_3},  // 564 - 659
    {FRONTIER_MON_BUKAMON_4,  FRONTIER_MON_BABOONGAMON_4},  // 660 - 755
...
static void GenerateOpponentMons(void)
{
    ...
    while (i != FRONTIER_PARTY_SIZE)
    {
        ...
        // Lopmon (FRONTIER_MON_LOPMON) is forbidden on opponent Factory teams.
