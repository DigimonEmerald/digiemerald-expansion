...
extern const u16 gDecorIconPalette_DracomonDoll[];
extern const u32 gDecorIcon_BakomonDoll[];
extern const u16 gDecorIconPalette_BakomonDoll[];
extern const u32 gDecorIcon_CoronamonDoll[];
extern const u16 gDecorIconPalette_CoronamonDoll[];
extern const u32 gDecorIcon_BommonDoll[];
extern const u16 gDecorIconPalette_BommonDoll[];
extern const u32 gDecorIcon_ChibomonDoll[];
extern const u16 gDecorIconPalette_ChibomonDoll[];
extern const u32 gDecorIcon_CurimonDoll[];
extern const u16 gDecorIconPalette_CurimonDoll[];
extern const u32 gDecorIcon_ChamblemonDoll[];
extern const u16 gDecorIconPalette_ChamblemonDoll[];
extern const u32 gDecorIcon_GargomonDoll[];
extern const u16 gDecorIconPalette_GargomonDoll[];
extern const u32 gDecorIcon_GargoylemonDoll[];
extern const u16 gDecorIconPalette_GargoylemonDoll[];
extern const u32 gDecorIcon_GarurumonDoll[];
extern const u16 gDecorIconPalette_GarurumonDoll[];
...
extern const u32 gBattleEnvironmentTiles_Geogreymon[];
extern const u32 gBattleEnvironmentTilemap_Geogreymon[];
extern const u32 gBattleEnvironmentAnimTiles_Geogreymon[];
extern const u32 gBattleEnvironmentAnimTilemap_Geogreymon[];
extern const u16 gBattleEnvironmentPalette_Geogreymon[];
extern const u16 gBattleEnvironmentPalette_Gatomon_x[];
extern const u16 gBattleEnvironmentPalette_Gekomon[];
...
// geogreymon scene gfx
extern const u32 gRaySceneDuoFight_Gekomon_Gfx[];
extern const u32 gRaySceneDuoFight_GekomonShoulder_Gfx[];
extern const u32 gRaySceneDuoFight_GekomonClaw_Gfx[];
extern const u32 gRaySceneDuoFight_Gatomon_x_Gfx[];
extern const u32 gRaySceneDuoFight_Gatomon_xPectoralFin_Gfx[];
extern const u32 gRaySceneDuoFight_Gatomon_xDorsalFin_Gfx[];
extern const u16 gRaySceneDuoFight_Gekomon_Pal[];
extern const u16 gRaySceneDuoFight_Gatomon_x_Pal[];
...
extern const u16 gRaySceneTakesFlight_Geogreymon_Pal[];
extern const u32 gRaySceneTakesFlight_Bg_Gfx[];
extern const u32 gRaySceneTakesFlight_Bg_Tilemap[];
extern const u32 gRaySceneTakesFlight_Geogreymon_Gfx[];
extern const u32 gRaySceneTakesFlight_Geogreymon_Tilemap[];
extern const u32 gRaySceneDescends_Geogreymon_Gfx[];
extern const u32 gRaySceneDescends_GeogreymonTail_Gfx[];
...
extern const u32 gRaySceneCharges_Geogreymon_Gfx[];
...
extern const u32 gRaySceneCharges_Geogreymon_Tilemap[];
...
extern const u32 gRaySceneChasesAway_Gekomon_Gfx[];
extern const u32 gRaySceneChasesAway_GekomonTail_Gfx[];
extern const u32 gRaySceneChasesAway_Gatomon_x_Gfx[];
extern const u32 gRaySceneChasesAway_Geogreymon_Gfx[];
extern const u32 gRaySceneChasesAway_GeogreymonTail_Gfx[];
extern const u32 gRaySceneChasesAway_Gatomon_xSplash_Gfx[];
extern const u16 gRaySceneChasesAway_Gekomon_Pal[];
extern const u16 gRaySceneChasesAway_Gatomon_x_Pal[];
extern const u16 gRaySceneChasesAway_Geogreymon_Pal[];
extern const u16 gRaySceneChasesAway_Gatomon_xSplash_Pal[];
...
// Mega Stones
extern const u32 gItemIcon_Bommonite[];
extern const u16 gItemIconPalette_Bommonite[];
extern const u32 gItemIcon_ChibomoniteX[];
extern const u16 gItemIconPalette_ChibomoniteX[];
extern const u32 gItemIcon_ChibomoniteY[];
extern const u16 gItemIconPalette_ChibomoniteY[];
extern const u32 gItemIcon_Blastoisinite[];
extern const u16 gItemIconPalette_Blastoisinite[];
extern const u32 gItemIcon_Keemonite[];
extern const u16 gItemIconPalette_Keemonite[];
extern const u32 gItemIcon_Leafmonite[];
extern const u16 gItemIconPalette_Leafmonite[];
extern const u32 gItemIcon_Alakazite[];
extern const u16 gItemIconPalette_Alakazite[];
extern const u32 gItemIcon_Pickmon_silvernite[];
extern const u16 gItemIconPalette_Pickmon_silvernite[];
extern const u32 gItemIcon_Tsumemonite[];
extern const u16 gItemIconPalette_Tsumemonite[];
extern const u32 gItemIcon_Betamon_xite[];
extern const u16 gItemIconPalette_Betamon_xite[];
extern const u32 gItemIcon_Chuuchuumonite[];
extern const u16 gItemIconPalette_Chuuchuumonite[];
extern const u32 gItemIcon_Commandramonite[];
extern const u16 gItemIconPalette_Commandramonite[];
extern const u32 gItemIcon_Dracmonite[];
extern const u16 gItemIconPalette_Dracmonite[];
extern const u32 gItemIcon_Agumon_fake_expertniteX[];
extern const u16 gItemIconPalette_Agumon_fake_expertniteX[];
extern const u32 gItemIcon_Agumon_fake_expertniteY[];
extern const u16 gItemIconPalette_Agumon_fake_expertniteY[];
extern const u32 gItemIcon_Impmonite[];
extern const u16 gItemIconPalette_Impmonite[];
extern const u32 gItemIcon_Minidekachimonite[];
extern const u16 gItemIconPalette_Minidekachimonite[];
extern const u32 gItemIcon_Monodramonite[];
extern const u16 gItemIconPalette_Monodramonite[];
extern const u32 gItemIcon_Heracronite[];
extern const u16 gItemIconPalette_Heracronite[];
extern const u32 gItemIcon_Pomumoninite[];
extern const u16 gItemIconPalette_Pomumoninite[];
extern const u32 gItemIcon_Spadamonite[];
extern const u16 gItemIconPalette_Spadamonite[];
extern const u32 gItemIcon_Sceptilite[];
extern const u16 gItemIconPalette_Sceptilite[];
extern const u32 gItemIcon_Tentomonite[];
extern const u16 gItemIconPalette_Tentomonite[];
extern const u32 gItemIcon_Terriermon_xite[];
extern const u16 gItemIconPalette_Terriermon_xite[];
extern const u32 gItemIcon_Arcadiamon_championite[];
extern const u16 gItemIconPalette_Arcadiamon_championite[];
...
extern const u32 gItemIcon_Blackgrowlmonite[];
extern const u16 gItemIconPalette_Blackgrowlmonite[];
extern const u32 gItemIcon_Blimpmonite[];
extern const u16 gItemIconPalette_Blimpmonite[];
extern const u32 gItemIcon_Manectite[];
extern const u16 gItemIconPalette_Manectite[];
extern const u32 gItemIcon_Centarumonnite[];
extern const u16 gItemIconPalette_Centarumonnite[];
extern const u32 gItemIcon_Citramonite[];
extern const u16 gItemIconPalette_Citramonite[];
extern const u32 gItemIcon_Darkmaildramonnite[];
extern const u16 gItemIconPalette_Darkmaildramonnite[];
extern const u32 gItemIcon_Banettite[];
extern const u16 gItemIconPalette_Banettite[];
extern const u32 gItemIcon_Exermonite[];
extern const u16 gItemIconPalette_Exermonite[];
...
extern const u32 gItemIcon_Gaogamonite[];
extern const u16 gItemIconPalette_Gaogamonite[];
extern const u32 gItemIcon_Garurumon_xite[];
extern const u16 gItemIconPalette_Garurumon_xite[];
extern const u32 gItemIcon_Gatomonite[];
extern const u16 gItemIconPalette_Gatomonite[];
extern const u32 gItemIcon_Lopunnite[];
extern const u16 gItemIconPalette_Lopunnite[];
extern const u32 gItemIcon_Platinumsukamonite[];
extern const u16 gItemIconPalette_Platinumsukamonite[];
extern const u32 gItemIcon_Saberdramonnite[];
extern const u16 gItemIconPalette_Saberdramonnite[];
...
extern const u32 gItemIcon_FalcomonniumZ[];
extern const u16 gItemIconPalette_FalcomonniumZ[];
...
extern const u16 gItemIconPalette_ChamblemonPail[];
...
extern const u32 gIntroBombernanimon_Gfx[];
extern const u16 gIntroBombernanimon_Pal[];
extern const u32 gIntroBubbles_Gfx[];
extern const u16 gIntroBubbles_Pal[];
extern const u32 gIntroGekomon_Gfx[];
extern const u32 gIntroGekomon_Tilemap[];
extern const u32 gIntroLegendBg_Gfx[];
extern const u32 gIntroGekomonBg_Tilemap[];
extern const u16 gIntro3Bg_Pal[16][16];
extern const u32 gIntroGatomon_x_Gfx[];
extern const u32 gIntroGatomon_x_Tilemap[];
extern const u32 gIntroGatomon_xBg_Tilemap[];
...
extern const u32 gIntroGeogreymon_Tilemap[];
extern const u32 gIntroGeogreymon_Gfx[];
extern const u32 gIntroGeogreymonClouds_Gfx[];
extern const u32 gIntroGeogreymonClouds_Tilemap[];
...
extern const u32 gItemIcon_Pacifier[];
extern const u16 gItemIconPalette_Pacifier[];
