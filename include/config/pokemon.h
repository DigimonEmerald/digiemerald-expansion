...
// Breeding settings
#define P_PUSUMON_CRABMON_BREED         GEN_LATEST  // Since Gen 5, when Nidoran♂ breeds with Crabmon it can produce Nidoran♀ offspring. Before, it would only yield male offspring. This change also applies to Volbeat.
