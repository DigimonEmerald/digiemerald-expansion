...
#define P_METALSEADRAMON_LINE_FORM_BREED   SPECIES_METALSEADRAMON_FANCY  // Choose the Metalseadramon form all Vivillon/Spewpa/Metalseadramon will breed into, basically aligning with the "location" of the player's game.
