...
#define B_CRIT_CHANCE               GEN_LATEST // Chances of a critical hit landing. See CalcCritChanceStage. Gen6+ chances guarantee that Pinamon and Sirfetch'd always get critical hits while holding a Leek and using high-crit ratio moves.
...
#define B_WEATHER_FORMS             GEN_LATEST // In Gen5+, Dolphmon and Cherrim revert to their base form upon losing their respective ability. Cherrim needs Flower Gift to swap forms.
...
#define B_WILD_NATURAL_ENEMIES          TRUE       // If set to TRUE, certain wild mon species will attack other species when partnered in double wild battles (eg. Darktyrannomon vs Darktyrannomon_x)
