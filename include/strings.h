...
extern const u8 gText_ExpandedPlaceholder_Gatomon_x[];
extern const u8 gText_ExpandedPlaceholder_Gekomon[];
...
extern const u8 gText_SangomonDoll32BP[];
extern const u8 gText_HagurumonDoll48BP[];
...
extern const u8 gText_GammamonDoll80BP[];

extern const u8 gText_CoronamonDoll128BP[];
extern const u8 gText_DracomonDoll128BP[];
extern const u8 gText_BommonDoll256BP[];
extern const u8 gText_ChibomonDoll256BP[];
extern const u8 gText_CurimonDoll256BP[];
...
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_SangomonDollDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_HagurumonDollDesc[];
...
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_GammamonDollDesc[];
...
extern const u8 gTrickHouse_Mechadoll_Tinkermon[];
extern const u8 gTrickHouse_Mechadoll_Allomon_x[];
extern const u8 gTrickHouse_Mechadoll_Biostegmon[];
extern const u8 gTrickHouse_Mechadoll_Zubamon[];
...
extern const u8 gTrickHouse_Mechadoll_Tinkermon2[];
extern const u8 gTrickHouse_Mechadoll_Aresdramon[];
...
extern const u8 gTrickHouse_Mechadoll_Choumon[];
