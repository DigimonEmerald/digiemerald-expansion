...
extern const u8 MossdeepCity_SpaceCenter_2F_EventScript_RivalGeogreymonCall[];
...
extern const u8 BerryTree_EventScript_ItemUseChamblemonPail[];
extern const u8 BattleFrontier_OutsideEast_EventScript_WaterJunkmon[];
