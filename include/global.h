...
struct ExternalEventFlags
{
    ...
    u8 boxRSEggsUnlocked:2; // Set by Pokémon Box: Ruby & Sapphire; denotes the number of Eggs unlocked from deposits; 1 for ExtremeSpeed Toyagumon (at 100 deposited), 2 for Pay Day Skitty (at 500 deposited), 3 for Surf Guilmon_x (at 1499 deposited)
    //u8 padding:5;
    u8 unknownFlag1;
