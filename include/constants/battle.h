...
#define MOVE_EFFECT_CONVERTED           8
#define PRIMARY_STATUS_MOVE_EFFECT      MOVE_EFFECT_CONVERTED // All above move effects apply primary status
...
#define MOVE_EFFECT_REMOVE_ARG_TYPE     30
...
#define MOVE_EFFECT_RAPID_SPIN          37
