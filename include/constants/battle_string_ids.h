...
enum StringID
{
    ...
    STRINGID_FULLMOON,
    STRINGID_FULLMOONSTOPPED,
    STRINGID_FULLMOONCONTINUES,
    STRINGID_PKMNCUTSSTATSWITH,
    STRINGID_SINOFPRIDEHPUP,
    STRINGID_HOLYAURAENTERS,
    STRINGID_DEATHAURAENTERS,
    STRINGID_PKMNALREADYCONVERTED,
    STRINGID_COUNT
};
...
enum SwitchInAbilityStringID
{
    ...
    B_MSG_SWITCHIN_HOLYAURA,
    B_MSG_SWITCHIN_DEATHAURA,
};
