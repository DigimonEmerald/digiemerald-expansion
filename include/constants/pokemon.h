...
#define TYPE_VACCINE          22
#define TYPE_VIRUS            23
#define TYPE_DATA             24
#define TYPE_FREE             25
#define TYPE_UKNOWN           26
...
enum EvolutionMethods {
    ...
    EVO_LEVEL_BALISTAMON,                   // Pokémon reaches the specified level (special value for Balistamon)
    EVO_LEVEL_BALUCHIMON,                  // Pokémon reaches the specified level (special value for Baluchimon)
    ...
    EVO_ATTACK,                          // Species attack is at certain level
    EVO_DEFENSE,                         // Species defense is at certain level
    EVO_SPATTACK,                        // Species special attack is at certain level
    EVO_SPDEFENSE,                       // Species special defense is at certain level
    EVO_SPEED,                           // Species speed is at certain level
    EVO_HEALTH,                          // Species health is at certain level
};
