...
enum NationalDexOrder
{
    ...
    NATIONAL_DEX_KODOKUGUMON,
    NATIONAL_DEX_KOKABUTERIMON,
    ...
    NATIONAL_DEX_MINIDEKACHIMON,
    NATIONAL_DEX_MODOKIBETAMON,
    ...
    NATIONAL_DEX_PAWNCHESSMON_BLACK,
    NATIONAL_DEX_PAWNCHESSMON_WHITE,
    ...
    NATIONAL_DEX_ARRESTERDRAMON,
    NATIONAL_DEX_ATAMADEKACHIMON,
    NATIONAL_DEX_AURUMON,
    NATIONAL_DEX_DEADLYAXEMON,
    NATIONAL_DEX_BABOONGAMON,
    NATIONAL_DEX_BAKEMON,
    NATIONAL_DEX_BALLISTAMON,
    NATIONAL_DEX_BALUCHIMON,
    NATIONAL_DEX_BAOHUCKMON,
    NATIONAL_DEX_BAROMON,
    NATIONAL_DEX_TRAILMON_BATTLE_ARMAMENT,
    NATIONAL_DEX_BETELGAMMAMON,
    NATIONAL_DEX_BIOQUETZALMON,
    NATIONAL_DEX_BIOSTEGOMON,
    NATIONAL_DEX_BIOTHUNDERBIRDMON,
    NATIONAL_DEX_BIRDRAMON,
    NATIONAL_DEX_BLACKGAOGAMON,
    NATIONAL_DEX_BLACKGARGOMON,
    NATIONAL_DEX_GARURUMON_BLACK,
    NATIONAL_DEX_BLACKGATOMON,
    NATIONAL_DEX_BLACKGATOMON_UVER,
    NATIONAL_DEX_BLACKGROWLMON,
    NATIONAL_DEX_BLADEKUWAGAMON,
    NATIONAL_DEX_BLIMPMON,
    NATIONAL_DEX_BOARMON,
    NATIONAL_DEX_BOMBERNANIMON,
    ...
    NATIONAL_DEX_DARKLIZARDMON,
    NATIONAL_DEX_DARKMAILDRAMON,
    NATIONAL_DEX_DARKTYRANNOMON,
    NATIONAL_DEX_DARKTYRANNOMON_X,
    NATIONAL_DEX_DECKERDRAMON,
    NATIONAL_DEX_DELTAMON,
    NATIONAL_DEX_DEPTHMON,
    NATIONAL_DEX_DEPUTYMON,
    NATIONAL_DEX_DEVIDRAMON,
    NATIONAL_DEX_DEVIMON,
    NATIONAL_DEX_DEXDORUGAMON,
    ...
    NATIONAL_DEX_FLAMEDRAMON,
    NATIONAL_DEX_FLAMEWIZARDMON,
    NATIONAL_DEX_FLARERIZAMON,
    ...
    NATIONAL_DEX_GUARDROMON,
    NATIONAL_DEX_HONEYBEEMON,
    NATIONAL_DEX_HYOGAMON,
    NATIONAL_DEX_ICEDEVIMON,
    NATIONAL_DEX_MISMAGIUS,
    NATIONAL_DEX_HONCHKROW,
    NATIONAL_DEX_ICEMON,
    NATIONAL_DEX_NINJAMON,
    NATIONAL_DEX_CHINGLING,
    NATIONAL_DEX_JUNGLEMOJYAMON,
    NATIONAL_DEX_SHELLNUMEMON,
    NATIONAL_DEX_KIWIMON,
    NATIONAL_DEX_MORISHELLMON,
    NATIONAL_DEX_BONSLY,
    NATIONAL_DEX_MIME_JR,
    NATIONAL_DEX_HAPPINY,
    NATIONAL_DEX_MUSYAMON,
    NATIONAL_DEX_NISEDRIMOGEMON,
    NATIONAL_DEX_ORCAMON,
    NATIONAL_DEX_PIDMON,
    NATIONAL_DEX_PLATINUMSUKAMON,
    NATIONAL_DEX_MUNCHLAX,
    NATIONAL_DEX_REDVEGIEMON,
    NATIONAL_DEX_SABERDRAMON,
    NATIONAL_DEX_SANDYANMAMON,
    NATIONAL_DEX_SHIMAUNIMON,
    NATIONAL_DEX_SNIMON,
    NATIONAL_DEX_SOULMON,
    NATIONAL_DEX_TANKMON,
    NATIONAL_DEX_THUNDERBALLMON,
    NATIONAL_DEX_MUDFRIGIMON,
    NATIONAL_DEX_WIZARDMON,
    NATIONAL_DEX_WOODMON,
    NATIONAL_DEX_MANTYKE,
    NATIONAL_DEX_YANMAMON,
    NATIONAL_DEX_WEEDMON,
    ...
    NATIONAL_DEX_KIMERAMON,
    NATIONAL_DEX_CYBERDRAMON,
    NATIONAL_DEX_SKULLMERAMON,
    NATIONAL_DEX_DERAMON,
    NATIONAL_DEX_PHANTOMON,
    NATIONAL_DEX_GARUDAMON,
    NATIONAL_DEX_GIGADRAMON,
    NATIONAL_DEX_KINGSUKAMON,
    NATIONAL_DEX_DIVERMON,
    NATIONAL_DEX_METEORMON,
    NATIONAL_DEX_CHERRYMON,
    NATIONAL_DEX_DARMANITAN,
    NATIONAL_DEX_KNIGHTMON,
    NATIONAL_DEX_MUMMYMON,
    NATIONAL_DEX_OROCHIMON,
    NATIONAL_DEX_ICELEOMON,
    NATIONAL_DEX_PARROTMON,
    NATIONAL_DEX_SKULLSATAMON,
    NATIONAL_DEX_TEKKAMON,
    NATIONAL_DEX_MYOTISMON,
    NATIONAL_DEX_WARUMONZAEMON,
    NATIONAL_DEX_WARUSEADRAMON,
    NATIONAL_DEX_ETEMON_CHAOS,
    ...
    NATIONAL_DEX_CREEPYMON,
    NATIONAL_DEX_DEVITAMAMON,
    NATIONAL_DEX_DIABOROMON,
    NATIONAL_DEX_FURFROU,
    NATIONAL_DEX_GOLDRAMON,
    NATIONAL_DEX_MEOWSTIC,
    NATIONAL_DEX_PHOENIXMON,
    NATIONAL_DEX_JIJIMON,
    NATIONAL_DEX_AEGISLASH,
    NATIONAL_DEX_KINGETEMON,
    NATIONAL_DEX_MILLENNIUMMON,
    NATIONAL_DEX_MACHINEDRAMON,
    NATIONAL_DEX_PIEDMON,
    NATIONAL_DEX_PUPPETMON,
    NATIONAL_DEX_PLESIOMON,
    NATIONAL_DEX_SKULLMAMMOTHMON,
    NATIONAL_DEX_VENOMMYOTISMON,
    NATIONAL_DEX_ZANBAMON,
    NATIONAL_DEX_CTHYLLAMON,
...
enum HoennDexOrder
{
    ...
    HOENN_DEX_ARRESTERDRAMON,
    HOENN_DEX_ATAMADEKACHIMON,
    HOENN_DEX_AURUMON,
    HOENN_DEX_DEADLYAXEMON,
    HOENN_DEX_BABOONGAMON,
    HOENN_DEX_HOPMON,
    HOENN_DEX_KAKKINMON,
    HOENN_DEX_KAPURIMON,
    HOENN_DEX_BAKEMON,
    HOENN_DEX_BALLISTAMON,
    HOENN_DEX_BALUCHIMON,
    HOENN_DEX_BAOHUCKMON,
    HOENN_DEX_BAROMON,
    HOENN_DEX_TRAILMON_BATTLE_ARMAMENT,
    HOENN_DEX_BETELGAMMAMON,
    HOENN_DEX_BIOQUETZALMON,
    HOENN_DEX_BLACKAGUMON_X,
    HOENN_DEX_BLACKGABUMON,
    HOENN_DEX_CLEARAGUMON,
    HOENN_DEX_COMMANDRAMON,
    HOENN_DEX_BIOSTEGOMON,
    HOENN_DEX_JAZAMON,
    HOENN_DEX_JELLYMON,
    HOENN_DEX_MONIMON,
    HOENN_DEX_MOONMON,
    HOENN_DEX_MOTIMON,
    HOENN_DEX_BIOTHUNDERBIRDMON,
#if P_NEW_EVOS_IN_REGIONAL_DEX && P_GEN_4_CROSS_EVOS
    HOENN_DEX_PROBOPASS,
#endif
    HOENN_DEX_BIRDRAMON,
    HOENN_DEX_BLACKGAOGAMON,
    HOENN_DEX_SNOWBOTAMON,
    HOENN_DEX_YURAMON,
    HOENN_DEX_GOTSUMON,
    HOENN_DEX_MINOMON,
    HOENN_DEX_MISSIMON,
    HOENN_DEX_BLACKGARGOMON,
    HOENN_DEX_GARURUMON_BLACK,
    HOENN_DEX_BLACKGATOMON,
    HOENN_DEX_BLACKGATOMON_UVER,
    HOENN_DEX_BLACKGROWLMON,
    HOENN_DEX_KOKOMON,
    HOENN_DEX_KOROMON,
    HOENN_DEX_KOZENIMON,
    HOENN_DEX_BLADEKUWAGAMON,
    HOENN_DEX_BLIMPMON,
    HOENN_DEX_BOARMON,
    HOENN_DEX_BOMBERNANIMON,
    HOENN_DEX_BOOGIEMON,
    ...
    HOENN_DEX_DARKLIZARDMON,
    HOENN_DEX_DARKMAILDRAMON,
    HOENN_DEX_DARKTYRANNOMON,
    HOENN_DEX_DARKTYRANNOMON_X,
    HOENN_DEX_DECKERDRAMON,
    HOENN_DEX_DELTAMON,
    HOENN_DEX_DEPTHMON,
    HOENN_DEX_DEPUTYMON,
    HOENN_DEX_DEVIDRAMON,
    HOENN_DEX_DEVIMON,
    HOENN_DEX_DEXDORUGAMON,
    HOENN_DEX_DIATRYMON,
    HOENN_DEX_DIGMON,
    ...
    HOENN_DEX_DOKUGUMON,
    HOENN_DEX_DOLPHMON,
    HOENN_DEX_BLACKGUILMON,
    HOENN_DEX_BOKOMON,
    HOENN_DEX_DONSHOUTMON,
    HOENN_DEX_DORUGAMON,
    HOENN_DEX_DORULUMON,
    ...
    HOENN_DEX_FILMON,
    HOENN_DEX_FIRAMON,
    HOENN_DEX_FLAMEDRAMON,
    HOENN_DEX_FLAMEWIZARDMON,
    HOENN_DEX_FLARERIZAMON,
    HOENN_DEX_PATAMON,
#if P_NEW_EVOS_IN_REGIONAL_DEX && P_GALARIAN_FORMS
    HOENN_DEX_CURSOLA,
#endif
