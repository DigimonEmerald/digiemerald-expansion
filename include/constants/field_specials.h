...
// Return values for DoGesomonRockInteraction
#define GESOMON_ROCK_FAILED     0
#define GESOMON_ROCK_PROGRESSED 1
#define GESOMON_ROCK_SOLVED     2
#define GESOMON_ROCK_COMPLETE   3
