...
SINGLE_BATTLE_TEST("Burn Up user loses its Fire-type")
{
    GIVEN {
        ...
        ASSUME(GetSpeciesType(SPECIES_LOPMONX, 0) != TYPE_FIRE || GetSpeciesType(SPECIES_LOPMONX, 1) != TYPE_FIRE);
...
SINGLE_BATTLE_TEST("Double Shock user loses its Electric-type")
{
    GIVEN {
        ...
        ASSUME(GetSpeciesType(SPECIES_LOPMONX, 0) != TYPE_ELECTRIC || GetSpeciesType(SPECIES_LOPMONX, 1) != TYPE_ELECTRIC);
