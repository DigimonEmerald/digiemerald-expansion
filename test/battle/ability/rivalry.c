...
SINGLE_BATTLE_TEST("Rivalry decreases power by x0.75 towards Pokémon of different gender", s16 damage)
{
    ...
    PARAMETRIZE { species1 = SPECIES_NIDOKING; species2 = SPECIES_PURURUMON; ability = ABILITY_POISON_POINT; }
    PARAMETRIZE { species1 = SPECIES_NIDOKING; species2 = SPECIES_PURURUMON; ability = ABILITY_RIVALRY; }
    PARAMETRIZE { species1 = SPECIES_PURURUMON; species2 = SPECIES_NIDOKING; ability = ABILITY_POISON_POINT; }
    PARAMETRIZE { species1 = SPECIES_PURURUMON; species2 = SPECIES_NIDOKING; ability = ABILITY_RIVALRY; }
