...
AI_DOUBLE_BATTLE_TEST("AI uses Final Gambit")
{
    ...
    GIVEN {
        ...
        PLAYER(SPECIES_LOPMONX);
        PLAYER(SPECIES_LOPMONX);
        OPPONENT(SPECIES_LOPMONX) { Moves(MOVE_SPLASH, MOVE_FINAL_GAMBIT); }
...
AI_DOUBLE_BATTLE_TEST("AI uses Guillotine")
{
    ...
    GIVEN {
        ...
        PLAYER(SPECIES_LOPMONX);
        PLAYER(SPECIES_LOPMONX);
        OPPONENT(SPECIES_LOPMONX) { Moves(MOVE_SPLASH, MOVE_GUILLOTINE); }
        OPPONENT(SPECIES_LOPMONX);
        OPPONENT(SPECIES_LOPMONX);
        OPPONENT(SPECIES_LOPMONX);
    } WHEN {
...
AI_DOUBLE_BATTLE_TEST("AI uses Sheer Cold")
{
    ...
    GIVEN {
        ...
        PLAYER(SPECIES_LOPMONX);
        PLAYER(SPECIES_LOPMONX);
        OPPONENT(SPECIES_LOPMONX) { Moves(MOVE_SPLASH, MOVE_SHEER_COLD); }
        OPPONENT(SPECIES_LOPMONX);
        OPPONENT(SPECIES_LOPMONX);
        OPPONENT(SPECIES_LOPMONX);
    } WHEN {
...
AI_DOUBLE_BATTLE_TEST("AI can use all moves, 1-100")
{
    ...
    GIVEN {
        ...
        PLAYER(SPECIES_LOPMONX);
        PLAYER(SPECIES_LOPMONX);
        OPPONENT(SPECIES_LOPMONX) { Moves(MOVE_SPLASH, move); Status1(STATUS1_BURN); Item(ITEM_STARF_BERRY); }
        OPPONENT(SPECIES_LOPMONX) { Moves(MOVE_POUND, move); Item(ITEM_STARF_BERRY); }
